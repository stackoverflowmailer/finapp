...
Ext
		.extend(
				...
				Ext.util.Observable,
				{
					...
					init : function() {
						admin
								.getContourAppContext( {
									callback :this.populateContext
											.createDelegate(this),
									async :false
								});
					},
					...
					getDayMonthYearFormat : function() {
						return this
								.getPropertyValue("jama.system.format.dayMonthYear")
								|| "m/d/Y";
					},
					getDatetimeFormat : function() {
						return this
								.getPropertyValue("jama.system.format.datetime")
								|| "m/d/Y h:i a";
					},
					getUseLdap : function() {
						return this.ldapProperties ? this.ldapProperties.enableLdap
								: false;
					},
					...
					getMask : function() {
						return (this.licenseType != "R" && this.isOrgAdmin()) ? jx.AclPermission.ORGADMIN
								: 0;
					},
					...
					getProject : function(id, _8) {
						if (_8 || !this.projectList[id]) {
							var _9 = this;
							project.getProjectDto(id, {
								callback : function(_a) {
									_9.tempProject = _a;
								},
								async :false
							});
							this.projectList[id] = new jx.Project(
									this.tempProject);
						}
...
Ext.extend(jx.ItemData, Ext.util.Observable, {
	appContext : {},
	itemType :null,
	item :null,
	group :null,
...
jx.Project.prototype = {
	appContext : {},
	canAdmin : function(_13) {
		return (this.appContext.licenseType != "R")
				&& jx.AclPermission.canAdmin(this.mask);
	},
	canWrite : function(_14) {
		return (this.appContext.licenseType != "R")
				&& jx.AclPermission.canWrite(this.mask);
	},
	canRead : function(_15) {
		return jx.AclPermission.canRead(this.mask);
	},
	getMask : function() {
		return this.appContext.licenseType == "R" ? jx.AclPermission.READ
				: this.mask;
	},
		...
		.extend(
				...
				Ext.Viewport,
				{
					...
					initApp : function() {
						...
						_1e.on("showModalMessage", this.displayModalMessage,
								this);
					},
					initDwr : function() {
						DWREngine.setTextHtmlHandler(this.dwrTextHtmlHandler
								.createDelegate(this));
					},
					...
					onExit : function() {
						if (!this.getAppContext().fireEvent("checkForUnsaved",
								true)) {
					...
					displayModalMessage : function(_27, _28) {
						...
						if (!_29) {
							_29 = Ext.DomHelper.insertFirst(document.body, {
								id :"msg-div"
							}, true);
						...
						var s = String.format.apply(String,
								Array.prototype.slice.call(arguments, 1));
						var m = Ext.DomHelper.append(_29, {
							html :this.createCloseBox(_27, s)
						}, true);
						m.slideIn("t");
					},
					hideModalMessage : function() {
						this.modalMsgCt.slideOut("t", {
							remove :true
						});
					},
					...
					createCloseBox : function(t, s) {
						return [
								...
								"</h3>",
								s,
								"</br><a href=\"javascript:void(0);\">[close]</a></div></div></div>",
								"<div class=\"x-box-bl\"><div class=\"x-box-br\"><div class=\"x-box-bc\"></div></div></div>",
								"</div>" ].join("");
					},
					getOrganization : function() {
...
Ext.override(Ext.Panel, {
	setTabTitleAndIcon : function(_3d, _3e) {
	...
	setTabTitleAndImage : function(_42, _43) {
		...
		if (el) {
			...
			var _47 = String
					.format("background-image: url(img/tree/{0});", _43);
			_46.removeClass(_44);
			_46.applyStyles(_47);
			_46.update(_42);
		}
...
Ext.extend(jx.PagingToolbar, Ext.PagingToolbar, {
	showSize :true,
	autoHide :false,
	maxPageSize :null,
	...
	if (!_94) {
		...
		if (!_95) {
			...
			if ((i = _9b.indexOf(_9c)) != -1) {
				_9a = [ [ DIFF_INSERT, _9b.substring(0, i) ],
						[ DIFF_EQUAL, _9c ],
						[ DIFF_INSERT, _9b.substring(i + _9c.length) ] ];
...
function diff_lines2chars(_ab, _ac) {
	...
	function diff_lines2chars_munge(_af) {
		...
		while (_af) {
			...
			if (_ae.hasOwnProperty ? _ae.hasOwnProperty(line)
					: (_ae[line] !== undefined)) {
...
function diff_map(_b9, _ba) {
	...
	for ( var d = 0; d < max; d++) {
		...
		for ( var k = -d; k <= d; k += 2) {
			...
			while (!_c5 && x < _b9.length && y < _ba.length
					&& _b9.charAt(x) == _ba.charAt(y)) {
				x++;
				y++;
				_c3 = x + "," + y;
				if (_c7
			...
			if (_c5) {
				...
				var a = diff_path1(_be, _b9.substring(0, x), _ba
						.substring(0, y));
				return a.concat(diff_path2(_bf, _b9.substring(x), _ba
						.substring(y)));
			}
		}
		_bf[d] = new Object();
		for ( var k = -d; k <= d; k += 2) {
			...
			while (!_c5
					&& x < _b9.length
					&& y < _ba.length
					&& _b9.charAt(_b9.length - x - 1) == _ba.charAt(_ba.length
							- y - 1)) {
				x++;
				y++;
				_c3 = (_b9.length - x) + "," + (_ba.length - y);
			...
			if (_c5) {
				...
				var a = diff_path1(_be, _b9.substring(0, _b9.length - x), _ba
						.substring(0, _ba.length - y));
				return a.concat(diff_path2(_bf, _b9.substring(_b9.length - x),
						_ba.substring(_ba.length - y)));
			}
		}
	}
	return null;
...
function diff_path1(_cb, _cc, _cd) {
	...
	for ( var d = _cb.length - 2; d >= 0; d--) {
		while (1) {
			if (_cb[d].hasOwnProperty ? _cb[d]
					.hasOwnProperty((x - 1) + "," + y) : (_cb[d][(x - 1) + ","
					+ y] !== undefined)) {
				x--;
				if (_d1 === DIFF_DELETE) {
				...
				if (_cb[d].hasOwnProperty ? _cb[d].hasOwnProperty(x + ","
						+ (y - 1)) : (_cb[d][x + "," + (y - 1)] !== undefined)) {
					y--;
					if (_d1 === DIFF_INSERT) {
...
function diff_path2(_d3, _d4, _d5) {
	...
	for ( var d = _d3.length - 2; d >= 0; d--) {
		while (1) {
			if (_d3[d].hasOwnProperty ? _d3[d]
					.hasOwnProperty((x - 1) + "," + y) : (_d3[d][(x - 1) + ","
					+ y] !== undefined)) {
				x--;
				if (_d9 === DIFF_DELETE) {
				...
				if (_d3[d].hasOwnProperty ? _d3[d].hasOwnProperty(x + ","
						+ (y - 1)) : (_d3[d][x + "," + (y - 1)] !== undefined)) {
					y--;
					if (_d9 === DIFF_INSERT) {
						_d6[_d6.length - 1][1] += _d5
								.charAt(_d5.length - y - 1);
					} else {
						_d6
								.push( [ DIFF_INSERT,
										_d5.charAt(_d5.length - y - 1) ]);
					}
					_d9 = DIFF_INSERT;
					break;
				} else {
					...
					y--;
					if (_d9 === DIFF_EQUAL) {
						_d6[_d6.length - 1][1] += _d4
								.charAt(_d4.length - x - 1);
					} else {
						_d6
								.push( [ DIFF_EQUAL,
										_d4.charAt(_d4.length - x - 1) ]);
					}
					_d9 = DIFF_EQUAL;
				}
			}
...
function diff_halfmatch(_e7, _e8) {
	...
	function diff_halfmatch_i(_eb, _ec, i) {
		...
		if (_f0.length >= _eb.length / 2) {
			return [ _f1, best_longtext_b, best_shorttext_a, best_shorttext_b,
					_f0 ];
		} else {
			return null;
		}
...
function diff_cleanup_efficiency(diff) {
	...
	while (_107 < diff.length) {
		if (diff[_107][0] == DIFF_EQUAL) {
			...
			if (_106
					&& ((_108 && _109 && _10a && _10b) || ((_106.length < DIFF_EDIT_COST / 2) && (_108
							+ _109 + _10a + _10b) == 3))) {
			...
			if (diff[_10d][0] == DIFF_DELETE) {
				...
				if (_10e != 0 || _10f != 0) {
					if (_10e != 0 && _10f != 0) {
						...
						if (_113[2] != "") {
							if ((_10d - _10e - _10f) > 0
									&& diff[_10d - _10e - _10f - 1][0] == DIFF_EQUAL) {
					...
					if (_10e == 0) {
						diff.splice(_10d - _10e - _10f, _10e + _10f, [
								DIFF_INSERT, _111 ]);
					} else {
						if (_10f == 0) {
							diff.splice(_10d - _10e - _10f, _10e + _10f, [
							...
							diff.splice(_10d - _10e - _10f, _10e + _10f, [
									DIFF_DELETE, _110 ], [ DIFF_INSERT, _111 ]);
						}
					}
					_10d = _10d - _10e - _10f + (_10e ? 1 : 0) + (_10f ? 1 : 0)
							+ 1;
				} else {
...
function diff_prettyhtml(diff) {
	...
	for ( var x = 0; x < diff.length; x++) {
		...
		t = t.replace(/\n/g, "<BR>");
		if (m == DIFF_DELETE) {
			html += "<DEL STYLE='background:#FFE6E6;' TITLE='i=" + i + "'>" + t
					+ "</DEL>";
		} else {
			if (m == DIFF_INSERT) {
				html += "<INS STYLE='background:#E6FFE6;' TITLE='i=" + i + "'>"
						+ t + "</INS>";
			} else {
...
function match_bitap(text, _132, loc) {
	...
	function match_bitap_score(e, x) {
		...
		return (e / _132.length / MATCH_BALANCE)
				+ (d / _135 / (1 - MATCH_BALANCE));
	}
...
function patch_addcontext(_150, text) {
	...
	var _153 = 0;
	while (text.indexOf(_152) != text.lastIndexOf(_152)
			&& _152.length < MATCH_MAXBITS - PATCH_MARGIN - PATCH_MARGIN) {
		_153 += PATCH_MARGIN;
		_152 = text.substring(_150.start2 - _153, _150.start2 + _150.length1
				+ _153);
	}
	_153 += PATCH_MARGIN;
	...
	var _155 = text.substring(_150.start2 + _150.length1, _150.start2
			+ _150.length1 + _153);
	if (_155 != "") {
	...
	for ( var x = 0; x < diff.length; x++) {
		...
		if (_161 == DIFF_INSERT) {
			...
			if (_161 == DIFF_DELETE) {
				...
				_15a.diffs.push(diff[x]);
				_15f = _15f.substring(0, _15c)
						+ _15f.substring(_15c + _162.length);
			} else {
				if (_161 == DIFF_EQUAL && _162.length <= 2 * PATCH_MARGIN
						&& _15a.diffs.length != 0 && diff.length != x + 1) {
					_15a.diffs.push(diff[x]);
					_15a.length1 += _162.length;
					_15a.length2 += _162.length;
				}
...
function patch_apply(_163, text) {
	...
	for ( var x = 0; x < _163.length; x++) {
		...
		if (start_loc == null) {
			...
			if (_168 == text2) {
				text = text.substring(0, start_loc) + _163[x].text2()
						+ text.substring(start_loc + _168.length);
			} else {
				...
				while (_16d.diffs.length != 0
					...
					if (diff_type == DIFF_INSERT) {
						...
						if (diff_text == _16d.diffs[0][1]) {
							...
							_16d.diffs[0][1] = _16d.diffs[0][1]
									.substring(diff_text.length);
						}
					}
				}
				precontext = patch.text2();
				precontext = precontext.substring(precontext.length
						- PATCH_MARGIN);
...
Ext.ux.Portal.DropZone = function(_175, cfg) {
	...
	Ext.ux.Portal.DropZone.superclass.constructor.call(this, _175.bwrap.dom,
			cfg);
				...
				Ext.dd.DropTarget,
				{
					...
					notifyOver : function(dd, e, data) {
						...
						var p, match = false, pos = 0, c = portal.items
								.itemAt(col), items = c.items.items;
						...
						var _186 = this.createEvent(dd, e, data, col, c, match
								&& p ? pos : c.items.getCount());
						if (portal.fireEvent("validatedrop", _186) !== false
								&& portal.fireEvent("beforedragover", _186) !== false) {
					...
					notifyDrop : function(dd, e, data) {
						...
						var _18b = this.createEvent(dd, e, data, col, c,
								pos !== false ? pos : c.items.getCount());
						if (this.portal.fireEvent("validatedrop", _18b) !== false
								&& this.portal.fireEvent("beforedrop", _18b) !== false) {
...
Ext.extend(Ext.data.DWRProxy, Ext.data.DataProxy, {
	load : function(_192, _193, _194, _195, arg) {
		if (this.fireEvent("beforeload", this, _192) !== false) {
			...
			var _198 = this.loadResponse.createDelegate(this, [ _193, _194,
					_195, arg ], 1);
			var _199 = new Array();
			if (arg.arg) {
				_199 = arg.arg.slice();
					...
					read : function(o) {
						...
						for ( var i = 0; i < c; i++) {
							...
							for ( var j = 0; j < fields.length; j++) {
								f = fields.items[j];
								var v = this.ef[j](n);
								_1b3[f.name] = f.convert((v !== undefined) ? v
										: f.defaultValue);
							}
...
jx.data.DwrStore = function(_1b7) {
	...
	if (_1b7.paging) {
		...
		_1b8 = new Ext.data.ListRangeReader( {
			id :_1b7.id,
			totalProperty :_1ba,
			root :_1bb
		}, _1b9);
	...
	jx.data.DwrStore.superclass.constructor.call(this, {
		reader :_1b8,
		proxy :new Ext.data.DWRProxy(_1b7.dwrCall, _1b7.paging),
		baseParams : {
			dwrArgs :_1b7.dwrArgs ? _1b7.dwrArgs : []
		},
		remoteSort :_1b7.remoteSort,
		sortInfo :_1b7.sortInfo
	});
};
Ext.extend(jx.data.DwrStore, Ext.data.Store, {
	load : function(_1bc) {
		if (_1bc && _1bc.arg) {
...
Ext.extend(jx.data.DwrStoreWithContourFields, jx.data.DwrStore, {
...
jx.data.StoreFactory = function() {
	var _1c4 = null;
	return {
		buildOrganizationStore : function(_1c5) {
			if (_1c5 && _1c4) {
				return _1c4;
			}
			var _1c6 = [ {
			...
			var _1c7 = new jx.data.DwrStore( {
				fields :_1c6,
				dwrCall :admin.getOrganizationList,
				remoteSort :false,
				paging :false
			});
			_1c4 = _1c7;
		...
		buildReportStore : function(_1c8) {
			...
			var _1ca = new jx.data.DwrStore( {
				fields :_1c9,
				dwrCall :report.getReportList,
				remoteSort :false,
				paging :false
			});
			return _1ca;
		...
		buildProjectReportStore : function(_1cb) {
			...
			var _1cd = new jx.data.DwrStore( {
				fields :_1cc,
				dwrCall :report.getVisibleReportList,
				remoteSort :false,
				paging :false
			});
			return _1cd;
		...
		buildProjectStore : function() {
			...
			var _1cf = new jx.data.DwrStore( {
				id :"id",
				fields :_1ce,
				rootProperty :"results",
				dwrCall :project.getExtProjectResults,
				remoteSort :false,
				paging :false
			});
			return _1cf;
		...
		buildDocumentGroupStore : function() {
			...
			var _1d1 = new jx.data.DwrStore( {
				fields :_1d0,
				dwrCall :documentManager.getDocumentGroupList,
				remoteSort :false,
				paging :false
			});
			return _1d1;
		...
		buildDocumentTypeStore : function() {
			...
			var _1d3 = new jx.data.DwrStore( {
				fields :_1d2,
				dwrCall :documentTypeSvc.getDocumentTypeList,
				remoteSort :false,
				paging :false
			});
			return _1d3;
		...
		buildBaselineStore : function() {
			...
			var _1d5 = new jx.data.DwrStore( {
				fields :_1d4,
				dwrCall :baseLine.getBaseLineListForProject,
				remoteSort :false,
				paging :false
			});
			return _1d5;
		...
		buildDocumentTypeFieldStore : function() {
			...
			var _1d7 = new jx.data.DwrStore( {
				fields :_1d6,
				dwrCall :documentTypeSvc.getDocumentTypeFieldList,
				remoteSort :false,
				paging :false
			});
			return _1d7;
		...
		buildProjectTagStore : function() {
			...
			var _1d9 = new jx.data.DwrStore( {
				id :"id",
				fields :_1d8,
				dwrCall :tagSvc.getAllTagsByProjectId,
				remoteSort :false,
				paging :false
			});
			return _1d9;
		...
		buildDocumentTagStore : function() {
			...
			var _1db = new jx.data.DwrStore( {
				id :"id",
				fields :_1da,
				dwrCall :tagSvc.getAllTagsByDocumentId,
				remoteSort :false,
				paging :false
			});
			return _1db;
		...
		buildEventStore : function(_1dc) {
			...
			var _1de = new jx.data.DwrStore( {
				fields :_1dd,
				dwrCall :eventLogSvc.getEventLogListPaging,
				dwrArgs :_1dc,
				remoteSort :false,
				paging :true
			});
		...
		buildLookupStore : function() {
			...
			var _1e0 = new jx.data.DwrStore( {
				fields :_1df,
				dwrCall :lookup.getLookupList,
				remoteSort :false,
				paging :false
			});
			return _1e0;
		...
		buildLookupByTypeCategoryStore : function() {
			...
			var _1e2 = new jx.data.DwrStore( {
				id :"id",
				fields :_1e1,
				dwrCall :lookup.getLookupListByTypeCategory,
				remoteSort :false,
				paging :false
			});
			return _1e2;
		...
		buildLookupTypeStore : function() {
			...
			var _1e4 = new jx.data.DwrStore( {
				fields :_1e3,
				dwrCall :lookup.getLookupTypeList,
				remoteSort :false,
				paging :false
			});
			return _1e4;
		...
		buildCommentStore : function() {
			...
			var _1e6 = new jx.data.DwrStore( {
				id :"id",
				fields :_1e5,
				dwrCall :comments.getComments,
				remoteSort :false,
				paging :false
			});
			return _1e6;
		...
		buildVersionStore : function() {
			...
			var _1e8 = new jx.data.DwrStore( {
				id :"versionId",
				fields :_1e7,
				dwrCall :version.getVersions,
				remoteSort :false,
				paging :false,
				sortInfo : {
					field :"createdBy",
		...
		buildArtifactAttachmentStore : function() {
			...
			var _1ea = new jx.data.DwrStore( {
				id :"id",
				fields :_1e9,
				dwrCall :documentManager.getDocumentAttachmentList,
				remoteSort :false,
				paging :false
			});
			return _1ea;
		...
		buildProjectAttachmentStore : function() {
			...
			var _1ec = new jx.data.DwrStore( {
				id :"id",
				fields :_1eb,
				dwrCall :attachment.getFileAttachmentListForProject,
				remoteSort :false,
				paging :false
			});
			return _1ec;
		...
		buildLdapUserInfoStore : function() {
			...
			var _1ee = new jx.data.DwrStore( {
				id :"userName",
				fields :_1ed,
				dwrCall :ldapSvc.getUserList,
				remoteSort :false,
				paging :false
			});
			return _1ee;
		...
		buildUserStore : function() {
			...
			var _1f0 = new jx.data.DwrStore( {
				id :"id",
				fields :_1ef,
				dwrCall :user.getUserListByOrgId,
				remoteSort :false,
				paging :false
			});
		...
		buildRoleStore : function() {
			...
			var _1f2 = new jx.data.DwrStore( {
				id :"id",
				fields :_1f1,
				dwrCall :user.getRoleListByOrgId,
				remoteSort :false,
				paging :false
			});
			return _1f2;
		...
		buildSubscriptionNotificationStore : function() {
			...
			var _1f4 = new jx.data.DwrStore( {
				id :"id",
				fields :_1f3,
				dwrCall :subscriptionSvc.getSubscriptionListForUser,
				remoteSort :false,
				paging :false
			});
			return _1f4;
		...
		buildRelationshipStore : function() {
			...
			var _1f6 = new jx.data.DwrStore( {
				id :"traceId",
				fields :_1f5,
				rootProperty :"results",
				dwrCall :relationshipSvc.getExtRelationshipsForDocument,
				remoteSort :false,
				paging :false
			});
			return _1f6;
		...
		buildOneDirectionRelationshipStore : function() {
			...
			var _1f8 = new jx.data.DwrStore(
					{
						id :"traceId",
						fields :_1f7,
						dwrCall :relationshipSvc.getDocumentTracesForDocumentByDirection,
						remoteSort :false,
						paging :false
					});
			return _1f8;
		...
		buildFilterStore : function() {
			...
			var _1fa = new jx.data.DwrStore( {
				id :"id",
				fields :_1f9,
				dwrCall :filterSvc.getFilterListByScope,
				remoteSort :false,
				paging :false
			});
			return _1fa;
		...
		buildReleaseStore : function() {
			...
			var _1fc = new jx.data.DwrStore( {
				id :"id",
				fields :_1fb,
				dwrCall :releaseSvc.getProjectReleaseList,
				remoteSort :false,
				paging :false
			});
			return _1fc;
		...
		buildDistributionGroupStore : function() {
			...
			var _1fe = new jx.data.DwrStore( {
				id :"id",
				fields :_1fd,
				dwrCall :distributionGroup.getDistributionGroupListForProject,
				remoteSort :false,
				paging :false
			});
			return _1fe;
		...
		buildPermissionStore : function() {
			...
			var _200 = new jx.data.DwrStore( {
				id :"id",
				fields :_1ff,
				dwrCall :acl.getAclPermissionListByIdentity,
				remoteSort :false,
				paging :false
			});
			return _200;
		...
		buildItemTestResultsStore : function() {
			...
			var _204 = new jx.data.DwrStore( {
				id :"id",
				fields :_203,
				dwrCall :documentManager.getTestResultsList,
				remoteSort :false,
				paging :false
			});
			return _204;
		...
		buildAuthProviderConfigStore : function() {
			...
			var _206 = new jx.data.DwrStore( {
				fields :_205,
				dwrCall :ldapSvc.getAuthProviderConfigList,
				remoteSort :false,
				paging :false
			});
			return _206;
...
jx.data.SimpleListStore = function(_207) {
	jx.data.SimpleListStore.superclass.constructor.call(this, {
		reader :new Ext.data.JsonReader( {
			id :_207.id
		}, Ext.data.Record.create(_207.fields)),
		proxy :new Ext.data.MemoryProxy(_207.data)
	});
	this.load();
};
...
jx.grid.ContourGrid = function(_208) {
	...
	if (!_208.cm) {
		if (_208.fieldDefinitions) {
			...
			_208.cm = new Ext.grid.ColumnModel( [ {
				header :""
			} ]);
		}
	}
		...
		.extend(
				...
				Ext.grid.GridPanel,
				{
					...
					createPagingToolbar : function(_20e, _20f) {
						this.pagingTb = new jx.PagingToolbar( {
							store :_20f.ds,
							pageSize :_20e,
					...
					buildColumnModel : function(meta) {
						...
						for ( var i = 0; i < meta.length; i++) {
							...
							if (!_215 && _213.dataType) {
								...
								case "action":
									_215 = this
											.createActionRenderer(_213.actions);
									break;
								}
							}
							if (_215) {
					...
					loadData : function(_225) {
						if (this.pagingTb) {
							var _226 = (this.pagingTb.cursor) ? this.pagingTb.cursor
									: 0;
							this.getStore().load( {
								arg :_225,
								params : {
				...
				jx.grid.ContourGrid,
				{
					...
					loadFilterGrid : function(_231, _232, _233) {
						...
						if (_233.meta) {
							...
							if (_233.filterMeta) {
								...
								if (_233.typeId) {
									documentTypeSvc.getDocumentTypeMetaData(
											_233.typeId, _232, true, {
												callback :this.setTypeMeta
														.createDelegate(this),
												async :false
											});
								} else {
					...
					getReleaseFilter : function(_23d, _23e) {
						var _23f = [ {
							...
							type :"Lookup",
							field :"project",
							paramValues : [ "currentProject" ]
						}, {
							type :"boolean",
							field :"documentGroup.displayInReleaseTree",
							paramValues : [ "T" ]
						} ];
						var _240 = {
							name :"defaultFilter",
					...
					setTypeMeta : function(meta) {
						meta.fieldList = this.getDefaultColumns().concat(
								meta.fieldList);
						this.setMeta(meta);
					},
						...
						if (!this.defaultColumns) {
							this.defaultColumns = [
									...
									},
									{
										...
										tooltip :"Folder",
										width :32,
										label :"<img src=\"img/silk/folder_page_white.png\"/>",
										dataType :"boolean",
										renderer : function(_243, p, _245) {
											return _243 ? "<img src=\"img/tree/folderClosed.gif\" title=\"Folder\"/>"
													: "<img src=\"img/silk/page_white_text.png\" title=\"Artifact\"/>";
										}
									} ];
						}
						...
						if (!this.searchMeta) {
							this.searchMeta = {
								fieldList : [
										...
										{
											field :"documentGroupImage",
											tooltip :"Item set",
											label :"<img src=\"img/silk/package.png\" title=\"Folder\"/>",
											width :32,
											renderer : function(_246, p, _248) {
												return "<img src=\""
														+ "img/tree/"
														+ _246
														+ "\""
										...
										},
										{
											...
											label :"<img src=\"img/silk/folder_page_white.png\"/>",
											dataType :"boolean",
											renderer : function(_249, p, _24b) {
												return _249 ? "<img src=\"img/tree/folderClosed.gif\" title=\"Folder\"/>"
														: "<img src=\"img/silk/page_white_text.png\" title=\"Artifact\"/>";
											}
										}, {
											field :"documentKey",
							...
							this.tagMeta = {
								fieldList : [
										...
										},
										{
											...
											label :"<img src=\"img/silk/folder_page_white.png\"/>",
											dataType :"boolean",
											renderer : function(_24c, p, _24e) {
												return _24c ? "<img src=\"img/tree/folderClosed.gif\" title=\"Folder\"/>"
														: "<img src=\"img/silk/page_white_text.png\" title=\"Artifact\"/>";
											},
											hidden :true
										}, {
					...
					getGroupFilter : function(_24f, _250, _251, _252) {
						var _253 = (_24f) ? "FullFolderSearch::documentGroup::"
								+ _250 : "";
						var _254 = [ {
							type :"parent",
							field :"parent",
						...
						var _255 = {
							name :"defaultFilter",
							typeId :_252 ? _252 : null,
							parameters :_254,
							currentProjectId :_251
						};
						return _255;
					},
					getFolderFilter : function(_256, _257, _258, _259) {
						...
						var _25c = {
							name :"defaultFilter",
							typeId :_259 ? _259 : null,
							parameters :_25b,
							currentProjectId :_258
						};
						return _25c;
					}
				});
jx.grid.SimpleGrid = function(_25d) {
	_25d = Ext.applyIf(_25d, {
		emptyText :"No Data",
		defaultDateFormat :this.getAppContext().getDayMonthYearFormat()
	});
				...
				Ext.Panel,
				{
					...
					afterRefresh : function() {
						...
						if (this.sortInfo && this.sortInfo.index != -1) {
							...
							if (tr && _25e.index < tr.cells.length) {
								...
								cell.className = (_25e.direction == 0) ? this.headerDownClass
										: this.headerUpClass;
							}
						}
					},
					...
					getFieldValue : function(_273, _274, _275) {
						...
						if (_273.renderer) {
							...
							case "lookup":
								...
								break;
							case "date":
								_276 = _274 ? _274.format(_273.format
					...
					createActionHtml : function(_27d) {
						...
						if (this.editable) {
							for ( var j = 0; j < _27d.length; j++) {
								...
								var link = String
										.format(
												"<a href=\"javascript:void(0);\" class=\"{0}\">{1}</a>",
												"j-action-" + _280.name,
												_280.display);
								html += link;
							}
					...
					sortDataStore : function() {
						...
						if (_282 >= 0) {
							...
							this.dataStore.sort(_283.field,
									this.sortInfo.direction == 0 ? "ASC"
											: "DESC");
						}
					},
					...
					onSort : function(view, e) {
						...
						cell.className = (_299.direction == 0) ? this.headerDownClass
								: this.headerUpClass;
						this.sortInfo = _299;
						this.sortDataStore();
						return true;
					...
					onRender : function(ct, _2a2) {
						jx.grid.SimpleGrid.superclass.onRender.call(this, ct,
								_2a2);
						if (this.fields) {
							...
							this.doLayout();
							this.view.store
									.on("datachanged", this.unmask, this);
							this.onRenderOther();
						}
					},
					onBeforeDestroy : function() {
						jx.grid.SimpleGrid.superclass.onBeforeDestroy
								.call(this);
					}
				});
...
Ext.extend(jx.grid.SimpleGridDetail, jx.grid.SimpleGrid, {
	form :null,
	dialog :null,
	dialogWidth :500,
	dialogHeight :300,
	...
	deleteItem : function(_2aa) {
		...
		if (_2aa) {
			Ext.MessageBox.confirm("Confirm", _2ab, this.deleteItemConfirm
	...
	deleteSelectedItems : function() {
		...
		if (this.selectedItems.length != 0) {
			Ext.MessageBox
					.confirm("Confirm", _2ac, this.deleteSelectedItemsConfirm
	...
	deleteSelectedItemsConfirm : function(_2af) {
		if (_2af == "yes") {
			this.onDeleteSelectedItems(this.selectedItems, {
				callback :this.updateItemCallback.createDelegate(this),
				exceptionHandler :this.handleDeleteException
						.createDelegate(this)
			});
		}
	...
	saveItem : function() {
		...
		this.onSaveItem(item, {
			callback :this.updateItemCallback.createDelegate(this),
			exceptionHandler :this.handleSaveException.createDelegate(this)
		});
	},
	handleDeleteException : function(msg, ex) {
		Ext.MessageBox.alert("Warning",
				"This item can't be deleted. Other items may link to it.");
	},
	...
	beforeDestroy : function() {
		...
		jx.grid.SimpleGridDetail.superclass.beforeDestroy
...
jx.grid.OrganizationGrid = function(_2ca) {
	Ext.applyIf(_2ca, {
		...
		dialogTitle :"Add/Edit Organization",
...
Ext.extend(jx.grid.OrganizationGrid, jx.grid.SimpleGridDetail, {
	filter :null,
	createForm : function() {
		return new jx.form.OrganizationForm( {
			formType :"editOnly",
			showButtons :false
		});
	},
...
jx.grid.LookupGrid = function(_2d2) {
	Ext.applyIf(_2d2, {
		listTitle :"Pick List Items",
		dialogTitle :"Add/Edit Item",
		addItemLabel :"Add Item",
		formClass :"jamaForm",
		dialogWidth :400,
		dialogHeight :150,
...
Ext.extend(jx.grid.LookupGrid, jx.grid.SimpleGridDetail, {
	scope :null,
	refId :null,
	loadType :false,
	createForm : function() {
		return new jx.form.JamaForm( {
			formType :"editOnly",
			showButtons :false,
			showTitle :false,
			title :"Test Jama Form",
			alternateRows :false,
			labelClass :"label",
	...
	loadTypeList : function() {
		this.lookupTypeStore.load( {
			arg : [ this.scope, this.refId ]
		});
	},
	createCombo : function() {
		this.lookupTypeStore = jx.data.StoreFactory.buildLookupTypeStore();
		var _2dc = new Ext.form.ComboBox( {
			store :this.lookupTypeStore,
			displayField :"name",
			valueField :"id",
			mode :"local",
			triggerAction :"all",
...
jx.grid.LookupTypeGrid = function(_2dd) {
	Ext.applyIf(_2dd, {
		listTitle :"Pick Lists",
		dialogTitle :"Add/Edit Pick List",
		addItemLabel :"Add Pick List",
		dialogWidth :400,
		dialogHeight :150,
		fieldDefinitions :this.getListDefinitions()
	});
...
Ext.extend(jx.grid.LookupTypeGrid, jx.grid.SimpleGridDetail, {
	createForm : function() {
		return new jx.form.JamaForm( {
			formType :"editOnly",
			showButtons :false,
...
jx.grid.PermissionGrid = function(_2eb) {
	Ext.applyIf(_2eb, {
		listTitle :i18n.g("j.l.permTableTitle"),
		dialogTitle :i18n.g("j.l.permAddGroupTitle"),
		addItemLabel :i18n.g("j.b.permAddGroup"),
		formClass :"jamaForm",
		dialogWidth :400,
		dialogHeight :200,
		sortable :false,
...
Ext.extend(jx.grid.PermissionGrid, jx.grid.SimpleGridDetail, {
	loadProject :false,
	projectStore :null,
	data :null,
	checkImg :"<img src=\"img/mini/check.gif\" align=\"absmiddle\" />",
	NOTHING :0,
	ADMINISTRATION :1,
	READ :2,
	WRITE :4,
	...
	getFormDefinitions : function() {
		return ( [ {
			...
			field :"mask",
			label :i18n.g("j.l.permPermissions"),
			dataType :"multiCheckboxes",
			returnIds :true,
			options :this.getPermissionOptions(),
			mapping :this.covertMaskIntoArray.createDelegate(this)
		} ]);
	},
	loadRoleOptions : function() {
		var self = this;
		var org = this.getAppContext().getOrganization();
		user.getRoleListByOrgId(org.id, {
	...
	getListDefinitions : function() {
		return ( [ {
			...
			label :i18n.g("j.l.permGroup"),
			width :"20%",
			renderer : function(_2f1, _2f2, _2f3) {
				return _2f1.display;
			}
		}, {
			field :"admin",
			label :i18n.g("j.l.permAdmin"),
			width :"20%",
			renderer :this.getAdmin.createDelegate(this)
		}, {
			field :"write",
			label :i18n.g("j.l.permWrite"),
			width :"20%",
			renderer :this.getWrite.createDelegate(this)
		}, {
			field :"read",
			label :i18n.g("j.l.permRead"),
			width :"20%",
			renderer :this.getRead.createDelegate(this)
		}, {
			field :"action",
			columnOnly :true,
			dataType :"action",
			label :i18n.g("j.l.permAction"),
			actions : [ {
				name :"edit",
				display :i18n.g("j.l.permEdit")
			}, {
				name :"delete",
				display :i18n.g("j.l.permDelete")
			} ]
		} ]);
	},
	...
	onSaveItem : function(item, _308) {
		if (!item.id) {
			item.aclObject = {
				identity :this.getProjectIdentity()
			};
		}
		var v = 0;
		var mask = item.mask;
	...
	onRenderOther : function() {
		...
		tb.addFill();
		this.addButton = tb.addButton( {
			tooltip :i18n.g("j.tt.permAddGroup"),
			text :this.addItemLabel,
			icon :"img/silk/add.png",
			cls :"x-btn-text-icon",
			handler :this.addItem.createDelegate(this)
	...
	createCombo : function() {
		...
		var _313 = new Ext.form.ComboBox( {
			store :this.projectStore,
			displayField :"name",
			valueField :"id",
			mode :"local",
			triggerAction :"all",
			emptyText :i18n.g("j.l.permSelectProject"),
			selectOnFocus :true,
			width :200,
			editable :false
		});
...
Ext.extend(jx.grid.UserGroupGrid, jx.grid.SimpleGridDetail, {
	filter :null,
	createForm : function() {
		return new jx.form.JamaForm( {
			formType :"editOnly",
	...
	validate : function(item, form) {
		var self = this;
		validation.validateRole(item, {
			callback : function(_31f) {
				self.errors = _31f;
			},
			async :false
		});
...
jx.grid.UserGrid = function(_320) {
	Ext.applyIf(_320, {
		...
		editItemLabel :"Edit User",
		deleteItemLabel :"Delete User",
		formClass :"jamaForm",
		autoScroll :true,
		dialogWidth :600,
		dialogHeight :550,
...
Ext.extend(jx.grid.UserGrid, jx.grid.SimpleGridDetail, {
	orgId :null,
	loadOrg :false,
	useLdap :false,
	createForm : function() {
		return new jx.form.UserForm( {
			orgId :this.orgId
		});
	},
	getListDefinitions : function() {
		...
		return ( [ {
			...
			label :"Active",
			width :"5%",
			renderer : function(_322, _323, _324) {
			...
			label :"Action",
			sortable :false,
			renderer :this.actionRenderer.createDelegate(this)
		} ]);
	},
	...
	deactivateItem : function(_32f) {
		user.deactivateUser( {
			...
			callback :this.loadList.createDelegate(this),
			errorHandler :this.handleDeactivateException.createDelegate(this)
		});
	},
	...
	handleDeactivateException : function(msg, ex) {
		Ext.MessageBox.alert("Warning", "This item can't be deleted. Cause: "
				+ msg);
	},
	...
	updatePassword : function() {
		...
		if (this.validatePassword(item, this.passwordForm)) {
			...
			user.updateUserPassword(item, this.updatePasswordCallback
					.createDelegate(this));
		}
	},
	...
	validate : function(item, form) {
		var self = this;
		validation.validateUser(item, {
			callback : function(_33c) {
				self.errors = _33c;
			},
			async :false
		});
	...
	createPasswordDialog : function() {
		this.passwordDialog = new Ext.Window( {
			title :"Edit Password",
			modal :true,
			closable :true,
			closeAction :"hide",
			...
			items : {
				margins :"3 3 3 0",
				autoScroll :true,
				items :this.createPasswordForm()
			},
			buttons : [ {
				text :"Cancel",
				handler :this.closePasswordDialog,
				scope :this
			}, {
				text :"Update",
	...
	createPasswordForm : function() {
		...
		this.passwordForm = new jx.form.JamaForm( {
			formType :"editOnly",
			showButtons :false,
			showTitle :false,
			title :"Test Jama Form",
	...
	createCombo : function() {
		...
		var _345 = new Ext.form.ComboBox( {
			store :this.orgStore,
			displayField :"name",
			valueField :"id",
			mode :"local",
...
jx.grid.ItemTypeGrid = function(_349) {
	Ext.applyIf(_349, {
		listTitle :"Item Types",
		dialogTitle :"Add/Edit Type",
...
Ext
		.extend(
				jx.grid.ItemTypeGrid,
				jx.grid.SimpleGridDetail,
				{
					createForm : function() {
						return new jx.form.JamaForm( {
							formType :"editOnly",
					...
					handleDeleteException : function(msg, ex) {
						Ext.MessageBox
								.alert(
										"Warning",
										"This item can't be deleted. Possible reason is that a project is using this type. Remove the project or the groups in the project. More details regarding this error have been appended to the server logs.");
					},
...
jx.grid.ItemTypeFieldGrid = function(_35b) {
	Ext.applyIf(_35b, {
		listTitle :"Item Type Fields",
		dialogTitle :"Add/Edit Field",
		addItemLabel :"Add Field",
		formClass :"jamaForm",
		dialogWidth :400,
		dialogHeight :350
	});
		...
		.extend(
				...
				jx.grid.SimpleGridDetail,
				{
					...
					getFormDefinitions : function(item) {
						var self = this;
						lookup.getLookupTypeList(2, this.orgId, {
							callback : function(_35e) {
						...
						var _35f = [ {
							...
							field :"documentField.dataTypeId",
							label :"Field Type",
							readOnly :true,
							dataType :"Integer",
							options :this.fieldDataTypeOptions
						}, {
							field :"description",
							label :"Description"
						}, {
						...
						if (item && item.documentField.dataTypeId == 3) {
							_35f.push( {
								...
								label :"Control",
								dataType :"Integer",
								options :this.fieldControlOptions
							});
						}
						if (item && item.documentField.dataTypeId == 4) {
							_35f.push( {
								...
								label :"Pick List",
								dataType :"lookup",
								options :this.lookupTypeOptions
							});
						}
						return _35f;
					},
					getListDefinitions : function() {
						...
						return ( [
								...
								{
									field :"documentField1",
									label :"Field",
									renderer : function(_361, _362, _363) {
								...
								},
								{
									...
									label :"Field Type",
									dataType :"lookup",
									renderer :this.fieldTypeRenderer
											.createDelegate(this)
								},
								{
									field :"controlTypeId",
									label :"Control",
									dataType :"lookup",
									renderer :this.lookupTypeRenderer
											.createDelegate(this)
								},
								{
									field :"lookupTypeId",
					...
					fieldTypeRenderer : function(_364, _365, _366) {
						...
						var _368 = this
								.getLookup(this.fieldDataTypeOptions, id);
					...
					actionRenderer : function(_36e, _36f, _370) {
						...
						return "<a href=\"javascript:void(0)\" class=\"j-action-edit\">Edit</a>&nbsp;"
								+ (item.sortOrder > 1 ? "|&nbsp;<a href=\"javascript:void(0)\" class=\"j-action-moveUp\">Up</a>&nbsp;"
										: "")
								+ (item.sortOrder < _372 ? "|&nbsp;<a href=\"javascript:void(0)\" class=\"j-action-moveDown\">Down</a>&nbsp;"
										: "")
								+ "|&nbsp;<a href=\"javascript:void(0)\" class=\"j-action-delete\">Remove</a>";
					},
					...
					onRenderOther : function() {
						...
						this.titleItem = tb.addText(this.listTitle);
						tb.addFill();
						this.fieldOptionsNode = document
					...
					beforeRender : function() {
						var self = this;
						documentTypeSvc.getDocumentFieldList( {
							callback : function(_376) {
								self.fieldOptions = _376;
							},
							async :false
						});
						documentTypeSvc.getFieldControlList( {
							callback : function(_377) {
								self.fieldControlOptions = _377;
							},
							async :false
						});
						lookup.getLookupTypeList(2, this.orgId, {
							callback : function(_378) {
								self.lookupTypeOptions = _378;
							},
							async :false
						});
						documentTypeSvc.getFieldDataTypeList( {
							callback : function(_379) {
					...
					onSwitchSortOrders : function(_383, _384) {
						documentTypeSvc.switchSortOrders(_383, _384,
								this.loadList.createDelegate(this));
					},
					fillForm : function(data) {
						if (!data.id) {
							var _386 = this.getLookup(this.fieldOptions,
									this.fieldOptionsNode.value);
							data = {
								sortOrder :this.getFieldCount() + 1,
								label :_386 ? _386.name : "",
								documentField :_386
							};
						}
						this.form.setFieldDefinitions(this
								.getFormDefinitions(data));
						this.form.setItem(data);
						this.showDialog();
					},
					fillFieldOptions : function(view, _388) {
						var _389 = this.getAvalaibleFields(_388,
								this.fieldOptions);
						dwr.util.removeAllOptions(this.fieldOptionsNode);
						dwr.util.addOptions(this.fieldOptionsNode, _389, "id",
								"name");
...
jx.grid.ReleaseGrid = function(_398) {
	Ext.applyIf(_398, {
		...
		dialogTitle :"Add/Edit Release",
		addItemLabel :"Add Release",
		formClass :"jamaForm",
		dialogWidth :400,
		dialogHeight :200,
		fieldDefinitions :this.getListDefinitions()
...
Ext.extend(jx.grid.ReleaseGrid, jx.grid.SimpleGridDetail, {
	data :null,
	createForm : function() {
		return new jx.form.JamaForm( {
			formType :"editOnly",
	...
	getFormDefinitions : function() {
		return ( [ {
			...
			dataType :"date",
			required :true,
			format :this.getAppContext().getDayMonthYearFormat()
		} ]);
	},
	getListDefinitions : function() {
		return ( [ {
	...
	validate : function(item, form) {
		var self = this;
		validation.validateRelease(item, {
			callback : function(_3a0) {
				self.errors = _3a0;
			},
			async :false
		});
	...
	handleDeleteException : function(msg, ex) {
		Ext.MessageBox.alert("Warning",
				"This release can't be deleted. Other items may link to it.");
	}
});
Ext.reg("jx.grid.ReleaseGrid", jx.grid.ReleaseGrid);
jx.grid.EmailGroupGrid = function(_3a5) {
	Ext.applyIf(_3a5, {
		listTitle :"Email Groups",
		dialogTitle :"Add/Edit Email Group",
		addItemLabel :"Add Email Group",
		formClass :"jamaForm",
		dialogWidth :400,
		dialogHeight :300,
		fieldDefinitions :this.getListDefinitions()
...
Ext.extend(jx.grid.EmailGroupGrid, jx.grid.SimpleGridDetail, {
	loadType :false,
	data :null,
	createForm : function() {
		return new jx.form.JamaForm( {
	...
	loadUserOptions : function() {
		var self = this;
		user.getVisibleUserInfoDtoList( {
			callback : function(list) {
				self.userList = list;
			},
			async :false
...
jx.grid.BaselineGrid = function(_3b0) {
	Ext.applyIf(_3b0, {
		listTitle :"Baseline Lists",
		dialogTitle :"Add/Edit Baseline",
		addItemLabel :"Add Baseline",
		dialogWidth :400,
		dialogHeight :150,
		fieldDefinitions :this.getListDefinitions()
	});
...
Ext.extend(jx.grid.BaselineGrid, jx.grid.SimpleGridDetail, {
	data :null,
	project :null,
	createForm : function() {
		return new jx.form.JamaForm( {
...
Ext.extend(jx.grid.ProjectAttachmentGrid, jx.grid.SimpleGridDetail, {
	baseUrl :"",
	uploadUrl :"fileUpload.req",
	dlg :null,
	loadedId :null,
	data :null,
	refresh : function(_3ba) {
	...
	fillForm : function(data) {
		if (!this.dlg) {
			this.dlg = new jx.window.ProjectAttachmentWindow( {
				data :this.data
			});
			this.dlg.getForm().on( {
				afterUpload :this.afterSaveAttachment,
				afterUpdateDescription :this.afterSaveAttachment,
				scope :this
			});
		}
		this.dlg.show(this.getEl());
		if (data.id) {
			this.dlg.loadAttachment( {
				fileName :"",
				attachment_description :data.description,
	...
	onDeleteItem : function(id, _3c0) {
		attachment.deleteFileAttachment( {
			id :id
		}, _3c0);
	},
	onLoadList : function() {
	...
	getListDefinitions : function() {
		return ( [ {
			...
			label :"Name",
			width :300,
			renderer :this.fileNameRenderer.createDelegate(this)
		}, {
			field :"description",
			label :"Description",
			width :300
	...
	fileNameRenderer : function(_3c4, p, _3c6) {
		return "<a href=\"" + this.baseUrl + "attachment/" + _3c6.id + "/"
				+ _3c4 + "\" target=\"_blank\">" + _3c4 + "</a>";
	},
	onRenderOther : function() {
	},
	render : function() {
		...
		this.buttonList.push(tb.addButton( {
			...
			text :"Add Attachment",
			iconCls :"j-attachment-add-icon",
			handler :this.addItem.createDelegate(this),
			mask :jx.AclPermission.WRITEADMIN
		}));
	},
	changeLabel : function(_3c8, _3c9) {
		var _3ca = Ext.DomQuery.select(String
				.format("label[for=\"{0}\"]", _3c8));
		if (_3ca) {
	...
	beforeDestroy : function() {
		...
		jx.grid.ProjectAttachmentGrid.superclass.beforeDestroy.apply(this,
				arguments);
	}
});
...
jx.grid.VersionGrid = function(_3cb) {
	Ext.applyIf(_3cb, {
		title :i18n.g("j-l-history"),
		fieldDefinitions :this.getListDefinitions(),
		dataStore :jx.data.StoreFactory.buildVersionStore(),
		tbar : [ "->", {
			text :i18n.g("j-b-compare"),
			tooltip :i18n.g("j-tt-compare"),
			iconCls :"j-item-compare-icon",
			handler :this.showCompare,
			scope :this
		} ]
	});
...
Ext
		.extend(
				...
				jx.grid.SimpleGrid,
				{
					...
					render : function() {
						jx.grid.VersionGrid.superclass.render.apply(this,
								arguments);
						if (this.data) {
						}
						this.refresh();
						...
						return ( [
								{
									...
									label :"From",
									width :"0%",
									renderer :this.renderFromVersion
											.createDelegate(this)
								},
								{
									field :"versionId2",
					...
					renderFromVersion : function(_3ce, p, _3d0) {
						return String
								.format(
										"<input type=\"radio\" name=\"{0}\" class=\"{1}\" value=\"{2}\"/>",
										this.getId() + "-version-from",
										"j-version-from", _3d0.data.versionId);
					},
					renderToVersion : function(_3d1, p, _3d3) {
						return String
								.format(
										"<input type=\"radio\" name=\"{0}\" class=\"{1}\" value=\"{2}\"/>",
										this.getId() + "-version-to",
										"j-version-to", _3d3.data.versionId);
					},
					...
					showCompare : function() {
						...
						if (_3da == null || _3db == null) {
							Ext.Msg
									.alert("Validation",
											"Please select a compare 'to' and a compare 'from'.");
						} else {
							version
									.getDocumentVersionDTOPair(_3da, _3db,
					...
					showCompareDialog : function(pair) {
						if (!this.formDialog) {
							this.formDialog = new jx.window.VersionCompareFormWindow(
									{
										closeAction :"hide",
										cancelAction :"hide"
									});
					...
					beforeDestroy : function() {
						...
						jx.grid.VersionGrid.superclass.beforeDestroy.apply(
								this, arguments);
					}
				});
...
Ext.extend(jx.grid.ProjectAttachmentGrid, jx.grid.SimpleGridDetail, {
	...
	fileNameRenderer : function(_3ea, p, _3ec) {
		return "<a href=\"" + this.baseUrl + "attachment/" + _3ec.id + "/"
				+ _3ea + "\" target=\"_blank\">" + _3ea + "</a>";
	},
	onRenderOther : function() {
	},
	render : function() {
	...
	changeLabel : function(_3ee, _3ef) {
		var _3f0 = Ext.DomQuery.select(String
				.format("label[for=\"{0}\"]", _3ee));
		if (_3f0) {
...
Ext
		.extend(
				...
				jx.grid.SimpleGridDetail,
				{
					...
					impactWidget :null,
					initComponent : function() {
						jx.grid.ItemRelationshipGrid.superclass.initComponent
								.call(this);
					},
					createForm : function() {
						return new jx.form.JamaForm( {
						...
						return ( [
								{
									...
									label :"Item ID",
									width :"10%",
									renderer : function(_3f2, _3f3, _3f4) {
								...
								},
								{
									...
									label :"Direction",
									width :"5%",
									renderer : function(_3f5, _3f6, _3f7) {
										return _3f7.data.forward ? "<img src='img/silk/arrow_right.png'></img>"
												: "<img src='img/silk/arrow_left.png'></img>";
									}
								},
								{
									field :"projectName",
								...
								},
								{
									field :"traceType",
									label :"Relationship",
									renderer : function(_3f8, _3f9, _3fa) {
					...
					getFormDefinitions : function() {
						var that = this;
						lookup.getLookupListByTypeCategory(1024, 2, this
								.getAppContext().organization.id, {
							callback : function(list) {
						...
						var _3fd = [ {
							id :true,
							name :"<img src='img/silk/arrow_right.png'></img>"
						}, {
							id :false,
							name :"<img src='img/silk/arrow_left.png'></img>"
						} ];
						return ( [ {
							field :"forward",
							label :"Direction",
							dataType :"multiRadioBox",
							options :_3fd,
							cls :" "
						}, {
							field :"traceType",
							...
							dataType :"lookup",
							options :this.relationshipType
						} ]);
					},
					actionRenderer : function(_3fe, _3ff, _400) {
						var _401 = [];
						if (_400.data.projectAuthorized
								&& (this.data.project.getMask() & jx.AclPermission.WRITEADMIN)) {
							_401.push( {
								name :"edit",
								display :"Edit"
							});
					...
					onSelectItem : function(view, _403, _404, e, _406, _407) {
						if (_407 == 0) {
							if (_404.data.projectAuthorized) {
								var _408 = this.getAppContext().getProject(
										_404.data.projectId, false);
								var data = new jx.ItemData( {
									item : {
										id :_404.data.documentId,
										name :_404.data.documentName
									},
									project :_408
								});
								this.getAppContext().fireEvent("showItem", {
									data :data,
									newTab :true,
									source :this,
									sourceType :"grid"
					...
					docLinkRenderer : function(_40a, p, _40c) {
						if (_40c.data.projectAuthorized) {
							return "<a href=\"javascript:void(0)\">" + _40a
									+ "</a>";
						} else {
							return _40a;
						}
					...
					onDeleteItem : function(_40d) {
						...
						Ext.MessageBox.confirm("Confirm", _40e,
								this.onDeleteConfirm.createDelegate(this,
										[ _40d ], 0));
					},
					onDeleteConfirm : function(_40f, _410) {
						if (_410 == "yes") {
							relationshipSvc.deleteRelationship( {
								id :_40f.id
							}, this.onSuccessDelete.createDelegate(this));
						}
					},
					onLoadItem : function(id, _412) {
						relationshipSvc.getDocumentTrace(id, this.data
								.getItemId(), _412);
					},
					onSaveItem : function(item, _414) {
						...
						if (item.forward == "true") {
							...
							relationshipSvc.saveTrace( {
								fromDocumentId :_416,
								toDocumentId :_415,
								associationType : {
									id :item.traceType.id
								}
							}, {
								async :false
							});
					...
					onClearSuspectLink : function(_417) {
						...
						relationshipSvc.clearSuspectRelationship(dtod,
								this.onSuccessClear.createDelegate(this));
					},
					onSuccessClear : function() {
						this.loadList();
						this.fireEvent("showSuccessMessage", "Success",
								"Suspect link has been cleared");
					},
...
jx.grid.ItemAttachmentGrid = function(_41b) {
	Ext.applyIf(_41b, {
		title :i18n.g("j.l.itemAttachmentTabTitle"),
		listTitle :"",
		addItemLabel :i18n.g("j.b.itemAttachmentAdd"),
		fieldDefinitions :this.getListDefinitions()
	});
...
Ext.extend(jx.grid.ItemAttachmentGrid, jx.grid.SimpleGridDetail, {
	baseUrl :"",
	data :null,
	urlWindow :null,
	uploadWindow :null,
	loadedId :null,
	refresh : function(_41c) {
	...
	beforeDestroy : function() {
		...
		jx.grid.ItemAttachmentGrid.superclass.beforeDestroy.apply(this,
				arguments);
	},
		...
		if (att.id) {
			if (att.url) {
				...
				att = {
					...
					fileName :"",
					existingFileName :att.attachment.fileName,
					attachment_description :att.attachment.description,
					attachment_id :att.attachment.id,
					attachment_note :att.note
				};
	...
	fileNameRenderer : function(_423, p, _425) {
		if (_425.data.url) {
			...
			if (_425.data.attachment) {
				...
				return "<a href=\"" + this.baseUrl + "attachment/" + _426.id
						+ "/" + _426.fileName + "\" target=\"_blank\">"
						+ _426.fileName + "</a>";
			}
		}
	},
	getUrlWindow : function() {
		if (!this.urlWindow) {
			this.urlWindow = new jx.window.ItemUrlWindow( {
				data :this.data,
				listeners : {
					afterSaveUrl : {
						fn :this.refresh,
	...
	getUploadWindow : function() {
		if (!this.uploadWindow) {
			this.uploadWindow = new jx.window.ItemAttachmentWindow( {
				data :this.data,
				listeners : {
					afterSaveItemAttachment : {
						fn :this.refresh,
						scope :this
					}
				}
	...
	onDeleteItem : function(id, _42a) {
		documentManager.deleteDocumentAttachment( {
			id :id
		}, _42a);
	},
	onLoadList : function() {
	...
	onRenderOther : function() {
		...
		tb.addFill();
		tb.addButton( {
			tooltip :i18n.g("j.tt.itemAttachmentAdd"),
			text :this.addItemLabel,
			iconCls :"j-attachment-add-icon",
			cls :"x-btn-text-icon",
		...
		tb.addButton( {
			tooltip :i18n.g("j.tt.itemAttachmentURL"),
			text :i18n.g("j.b.itemAttachmentURL"),
			iconCls :"j-attachment-add-icon",
			cls :"x-btn-text-icon",
			handler :this.addUrl,
			scope :this,
...
jx.grid.ServerAttachmentGrid = function(_42e) {
	Ext.applyIf(_42e, {
		fieldDefinitions :this.getListDefinitions(),
		singleSelect :false,
		dataStore :jx.data.StoreFactory.buildProjectAttachmentStore()
	});
	jx.grid.ServerAttachmentGrid.superclass.constructor.call(this, _42e);
};
Ext.extend(jx.grid.ServerAttachmentGrid, jx.grid.SimpleGrid, {
	data :null,
	baseUrl :null,
	refresh : function() {
		if (this.rendered) {
	...
	getListDefinitions : function() {
		return ( [ {
			...
			label :"Size",
			width :"25%",
			renderer : function(_436, p, _438) {
				return _436 < 1024 ? _436 : (Math.ceil(_436 / 1024) + "K");
			}
		} ]);
	},
	radioRenderer : function(_439, p, _43b) {
		return String.format("<input type=\"radio\" name=\"{0}\">", [ this
				.getEl().id
				+ "-" + "-radio" ]);
	},
	checkboxRenderer : function(_43c, p, _43e) {
		return String
				.format("<input type=\"checkbox\" value=\"{0}\">", _43e.id);
	},
	fileNameRenderer : function(_43f, p, _441) {
		return "<a href=\"" + this.baseUrl + "attachment/" + _441.id + "/"
				+ _43f + "\" target=\"_blank\">" + _43f + "</a>";
	},
		...
		.extend(
				...
				jx.grid.ContourGrid,
				{
					...
					setMetaByOrg : function() {
						...
						projectTypeSvc.getProjectTypeMetaDataByOrg(this.orgId,
								{
									callback :this.setTypeMeta
											.createDelegate(this),
									async :false
						...
						if (!this.defaultColumns) {
							this.defaultColumns = [
									...
									},
									{
										...
										label :"<img src=\"img/silk/folder_page_white.png\"/>",
										dataType :"boolean",
										renderer : function(_44c, p, _44e) {
											return _44c ? "<img src=\"img/tree/folderClosed.gif\" title=\"Folder\"/>"
													: "<img src=\"img/silk/page_white_text.png\" title=\"Artifact\"/>";
										}
									} ];
						}
...
jx.grid.ItemTestResultsGrid = function(_44f) {
	Ext.applyIf(_44f, {
		listTitle :"",
		singleSelect :false,
		executeTestLabel :i18n.g("j.l.executeItemTest"),
		dialogWidth :700,
		dialogHeight :500,
		showToolbar :true,
		maximizable :true,
		minimizable :false,
		dialogTitle :i18n.g("j.l.executeTestWindow"),
		fieldDefinitions :this.getListDefinitions()
	});
...
Ext
		.extend(
				...
				jx.grid.SimpleGridDetail,
				{
					...
					initComponent : function() {
						jx.grid.ItemTestResultsGrid.superclass.initComponent
								.call(this);
					},
					refresh : function() {
						if (this.form) {
					...
					getListDefinitions : function() {
						return ( [ {
							...
							width :"25%",
							dataType :"date",
							format :this.getAppContext().getDatetimeFormat()
						}, {
							field :"createdBy",
							label :"Tester",
							width :"10%",
					...
					statusRenderer : function(_454, _455, _456) {
						var _454 = (_456.data.passStatus) ? i18n
								.g("j.l.testPass") : i18n.g("j.l.testFail");
						return _454;
					},
					...
					render : function() {
						jx.grid.ItemTestResultsGrid.superclass.render.apply(
								this, arguments);
						this.form = this.createForm();
						this.createDialog();
						this.refresh();
					...
					onRenderOther : function() {
						...
						tb.addFill();
						this.buttonList.push(tb.addButton( {
							tooltip :i18n.g("j.tt.itemTestExecute"),
							text :this.executeTestLabel,
							iconCls :"j-item-execute-test-icon",
							cls :"x-btn-text-icon",
							handler :this.executeTest,
							scope :this,
							mask :wa
						}));
					},
					...
					executeTest : function() {
						var self = this;
						documentManager.getDocumentDto(this.data.getItemId(), {
						...
						this.fillForm( {
							testCaseDetails :self.testScript
						});
					},
					onSaveItem : function(item, _463) {
						item.testConfiguration = {
							id :item.testConfiguration.id
						};
						item.passStatus = (item.passStatus == "Pass") ? true
								: false;
						item.testCase = {
							id :this.data.getItemId()
						};
						documentManager.saveTestResult(item, this.afterSaveTest
								.createDelegate(this));
					},
					...
					getFormDefinitions : function() {
						...
						return ( [ {
							...
							labelAlign :"left",
							width :"100%",
							options :this.configurationList
						}, {
							field :"passStatus",
							label :"Pass/Fail",
							dataType :"multiRadioBox",
					...
					loadConfigurationList : function() {
						var self = this;
						lookup.getLookupListByTypeCategory(1023, 3, this.data
								.getProjectId(), {
							callback : function(list) {
...
jx.grid.LdapConfigGrid = function(_468) {
	Ext.applyIf(_468, {
		listTitle :"Ldap Provider Lists",
		dialogTitle :"Add/Edit Provider",
		dialogWidth :500,
		dialogHeight :500,
		fieldDefinitions :this.getListDefinitions()
	});
...
Ext.extend(jx.grid.LdapConfigGrid, jx.grid.SimpleGridDetail, {
	createForm : function() {
		return new jx.form.JamaForm( {
			formType :"editOnly",
			showButtons :false,
	...
	getFormDefinitions : function() {
		return ( [ {
			...
			field :"sampleUserPassword",
			label :"Sample User Password",
			required :false,
			inputType :"password"
		} ]);
	},
	...
	onRenderOther : function() {
		...
		tb.addFill();
		tb.add( {
			tooltip :"Add Active Directory Provider",
			text :"Add AD Provider",
			icon :"img/silk/add.png",
			cls :"x-btn-text-icon",
			handler :this.addADItem,
			scope :this
		});
		tb.add("-");
		tb.add( {
			tooltip :"Add LDAP Provider",
			text :"Add LDAP Provider",
			icon :"img/silk/add.png",
			cls :"x-btn-text-icon",
			handler :this.addItem,
			scope :this
	...
	testItem : function() {
		var item = this.form.getUpdatedItem();
		ldapSvc.testLdapConfig(item, item.sampleUser, item.sampleUserPassword,
				{
					callback : function(_46d) {
						Ext.MessageBox.alert(_46d ? "Success" : "Test Failed",
								_46d ? "Test is successful"
	...
	addItem : function() {
		this.fillForm( {
			...
			baseDn :"dc=jamasoftware,dc=com",
			bindDn :"cn=Admin,ou=users,dc=jamasoftware,dc=com",
	...
	onDeleteItem : function(id, _473) {
		ldapSvc.deleteAuthProviderConfig( {
			id :id
		}, _473);
	},
	onLoadList : function() {
...
jx.grid.LdapUserGrid = function(_474) {
	Ext.applyIf(_474, {
		listTitle :"Ldap User List",
		dialogTitle :"Add User",
		addItemLabel :"Add Drop Down",
...
Ext.extend(jx.grid.LdapUserGrid, jx.grid.SimpleGridDetail, {
	orgId :null,
	searchString :null,
	providerId :null,
	createForm : function() {
	...
	onLoadItem : function(id, _476) {
		...
		var user = {
			userName :_477.data.userName,
			firstName :_477.data.firstName,
			lastName :_477.data.lastName,
			email :_477.data.email,
			theme :"contour",
			licenseType :"R"
		};
		_476(user);
	...
	onRenderOther : function() {
		...
		tb.add( {
			...
			tooktip :"Go back to user list",
			handler :this.backToUserList,
			scope :this
		});
		tb.add("-");
		...
		tb.add(this.createCombo());
		tb.addFill();
		this.searchField = new Ext.form.Field( {
			align :"right",
			diabled :true,
			listeners : {
				specialkey :this.handleReturn,
				scope :this
			}
		});
		tb.add(this.searchField);
		this.searchButton = tb.addButton( {
			text :"Search",
			iconCls :"j-header-search-icon",
			tooltip :"LDAP Search",
			disabled :true,
			handler :this.search,
			scope :this
	...
	createCombo : function() {
		...
		var _481 = new Ext.form.ComboBox( {
...
jx.grid.ReportGrid = function(_486) {
	Ext.applyIf(_486, {
		listTitle :i18n.g("j.l.reportTitle"),
		addItemLabel :i18n.g("j.l.reportAdd"),
		fieldDefinitions :this.getListDefinitions(),
		autoScroll :true
	});
...
Ext.extend(jx.grid.ReportGrid, jx.grid.SimpleGridDetail, {
	baseUrl :"",
	uploadWindow :null,
	refresh : function() {
		this.loadList();
	...
	getListDefinitions : function() {
		return ( [ {
			field :"name",
			label :i18n.g("j.l.reportName"),
			width :"25%",
			sortable :true
		}, {
			field :"fileName",
			label :i18n.g("j.l.reportFileName"),
			width :"25%",
			sortable :false,
			renderer :this.reportNameRenderer.createDelegate(this)
		}, {
			field :"description",
			label :i18n.g("j.l.reportDescription"),
			width :"30%",
			sortable :true
		}, {
			field :"action",
	...
	getReportWindow : function() {
		if (!this.reportWindow) {
			this.reportWindow = new jx.window.ReportWindow( {
				data :this.data,
				listeners : {
					afterSaveReport : {
						fn :this.refresh,
...
Ext.extend(Ext.ux.TagCloud, Ext.Component, {
	...
	refresh : function() {
		...
		for ( var i = 0; i < _496.length; i++) {
			...
			var _499 = this.list.createChild( {
				tag :"li",
				cls :this.showAsList ? "x-cloud-list-item" : "x-cloud-item "
						+ this.getWeightClassification(_498),
				html :"<a href=\"#\">" + _496[i].data[this.displayField]
						+ (this.displayWeight ? " (" + _498 + ")" : "")
						+ "</a>"
			});
	...
	onSelect : function(e, t) {
		...
		this.fireEvent("tagselect", this, this.getDataSource().getAt(_49d),
				_49d);
...
Ext.extend(jx.view.TableView, Ext.DataView, {
	feilds :null,
	refresh : function() {
		var t = this.tpl;
		...
		if (_4aa.length < 1) {
			if (this.emptyText) {
				var html = String.format(
						"<tr><td colspan=\"{0}\">{1}</td></tr>",
						this.fields ? this.fields.length : 1, this.emptyText);
...
jx.view.WhatsNewView = function(_4b7) {
	...
	_4b7 = Ext.applyIf(_4b7, {
		store :_4b8,
		tpl :this.getTemplate(),
		overClass :"j-whatsnew-over",
		autoWidth :true,
		emptyText :i18n.g("j.m.noEvents"),
		itemSelector :"div.whatsNewBox"
	});
	jx.view.WhatsNewView.superclass.constructor.call(this, _4b7);
};
Ext
		.extend(
				jx.view.WhatsNewView,
				Ext.DataView,
				{
					loadMask :true,
					data :null,
					userId :null,
					render : function() {
						jx.view.WhatsNewView.superclass.render.apply(this,
								arguments);
					},
					getTemplate : function() {
						var _4b9 = new Ext.XTemplate(
								"<tpl for=\".\">",
								"<div class=\"whatsNewBox\">",
								"<table width=\"100%\"><tr><td width=\"5%\" style=\"vertical-align: middle\">",
								"<div class=\"j-icon {action:this.actionIcon}\"></div>",
								"</td>",
								"<td width=\"70%\">",
								"<span class=\"j-text-label j-whatsnew-text\">{documentKey} - {itemName}</span>",
								"<br/>{action} {whenAgo} in {projectName}",
								"</td>",
								"<td width=\"25%\">by {userName}</td>",
								"</tr></table>", "</div>", "</tpl>");
...
Ext
		.extend(
				jx.view.FilterListView,
				Ext.Component,
				{
					project :null,
					sharedFilterView :null,
					myFilterView :null,
					editable :true,
					template :null,
					actions :null,
					getTemplate : function() {
						return new Ext.XTemplate(
								"<tpl for=\".\">",
								"<div class=\"j-filter-view\"><a class=\"j-action-view\" href=\"javascript:void(0)\">{name}</a><br/>",
								"{actions}", "</div>", "</tpl>");
					},
					getActions : function() {
						return "";
					...
					load : function(_4be) {
						...
						if (this.project && this.project.id) {
							this.myFilterStore.load( {
								arg : [ this.project.id, 6 ]
							});
							this.sharedFilterStore.load( {
								arg : [ this.project.id, 2 ]
							});
						}
					},
					selectItem : function(view, _4c0, node, e) {
						...
						if (_4c4 == "delete") {
							...
							if (_4c4 == "edit") {
								...
								this.fireEvent("viewFilterResults", this, _4c8,
										e);
							}
						}
					},
					deleteFilter : function(view, _4ca, e) {
						var _4cc = String
								.format(
										"This will permanently remove \"{0}\" filter."
												+ "<br>If this filter is shared it will be removed for everyone."
												+ "<br>"
												+ "<br>Are you sure you want to delete?",
										[ _4ca.name ]);
						Ext.MessageBox.confirm("Confirm", _4cc,
								this.deleteFilterConfirm.createDelegate(this,
										[ _4ca ], 0));
					},
					deleteFilterConfirm : function(_4cd, _4ce) {
						if (_4ce == "yes") {
							filterSvc.deleteFilter(_4cd.id, this.load
									.createDelegate(this));
						}
					},
					...
					onRender : function(ct, _4d5) {
						...
						this.myFilterTitleNode = this.el.createChild( {
							tag :"div",
							cls :"j-filter-header",
							style :"margin-bottom:5px;"
						});
						this.myFilterTitleNode.dom.innerHTML = "My Filters";
						var _4d7 = this.el.createChild( {
							tag :"div",
							id :Ext.id()
						});
						this.sharedFilterTitleNode = this.el.createChild( {
							tag :"div",
							cls :"j-filter-header",
							style :"margin-bottom:5px;"
						});
						this.sharedFilterTitleNode.dom.innerHTML = "Shared Filters";
						var _4d8 = this.el.createChild( {
							tag :"div",
							id :Ext.id()
						});
						this.myFilterView = new Ext.DataView( {
							el :_4d7,
							tpl :this.template,
							multiSelect :true,
							selectedClass :"j-tag-selected",
							store :this.myFilterStore,
							itemSelector :"div",
						...
						this.sharedFilterView = new Ext.DataView( {
							el :_4d8,
							tpl :this.template,
							multiSelect :true,
							itemSelector :"div",
							selectedClass :"j-tag-selected",
							store :this.sharedFilterStore,
							prepareData :this.prepareData.createDelegate(this),
							listeners : {
								click : {
									fn :this.selectItem,
...
jx.view.CommentView = function(_4d9) {
	...
	_4d9 = Ext.applyIf(_4d9, {
		store :_4da,
		emptyText :"There are no comments for this item",
		tpl :this.getTemplate(),
		selectedClass :"j-comment-selected",
		store :_4da,
		itemSelector :"div.j-comment-box",
		dateTimeFormat :this.getAppContext().getDatetimeFormat()
	});
		...
		.extend(
				...
				Ext.DataView,
				{
					...
					getTemplate : function() {
						return new Ext.XTemplate(
								"<tpl for=\".\">",
								"<div class=\"j-comment-box\"><div class=\"j-comment-author-text\">",
								"<img border=\"0\" src=\"img/silk/comment.png\" align=\"absmiddle\">",
								"{createdDate} by {userName} </div>",
								"<div class=\"j-text-box j-comment-text\">{commentText}</div>",
								"<div class=\"j-comment-action-bar\" style=\"{display}\">",
								"<img border=\"0\" src=\"img/silk/comment_edit.png\" align=\"absmiddle\">&nbsp;",
								"<a href=\"javascript:void(0)\" class=\"j-action-edit\">Edit</a>&nbsp;&nbsp;",
								"<img border=\"0\" src=\"img/silk/comment_delete.png\" align=\"absmiddle\">&nbsp;",
								"<a href=\"javascript:void(0)\" class=\"j-action-delete\">Delete</a></div>",
								"</div>", "</tpl>");
					},
					prepareData : function(data) {
						...
						return {
							...
							display :_4dc.canAdmin() || _4dc.canWrite()
									|| this.userId == data.createdBy ? ""
									: "display:none"
						};
					},
					destroy : function() {
...
jx.view.ItemRelationshipView = function(_4dd) {
	...
	_4dd = Ext.applyIf(_4dd, {
		store :_4de,
		tpl :this.getTemplate(_4dd.direction),
		overClass :"j-view-over",
		emptyText :_4dd.direction ? i18n.g("j.m.noRelationshipsForw") : i18n
				.g("j.m.noRelationshipsBack"),
		selectedClass :"j-comment-selected",
		itemSelector :"div.relationshipBox"
	});
	jx.view.ItemRelationshipView.superclass.constructor.call(this, _4dd);
};
Ext
		.extend(
				jx.view.ItemRelationshipView,
				Ext.DataView,
				{
					project :null,
					removable :true,
					...
					direction :true,
					render : function() {
						jx.view.ItemRelationshipView.superclass.render.apply(
								this, arguments);
						this.on("click", this.onClickRelate, this);
						this.store
								.on("load", this.afterLoadRelationships, this);
					},
					...
					refreshView : function() {
						this.store.load( {
							arg : [ this.data.getItemId(), this.direction ]
						});
					},
					getTemplate : function(_4e2) {
						...
						if (this.removable) {
							_4e3 = ""
									+ "<div class=\"j-comment-action-bar\" style=\"margin-top: 10px; text-align:right;{display}\">"
									+ "<img border=\"0\" src=\"img/silk/{directionImage}\" align=\"absmiddle\">&nbsp;"
									+ "<a href=\"javascript:void(0)\" class=\"j-action-switch\">Switch Direction</a>&nbsp;&nbsp;"
									+ "<img border=\"0\" src=\"img/silk/link_edit.png\" align=\"absmiddle\">&nbsp;"
									+ "<a href=\"javascript:void(0)\" class=\"j-action-edit\">Edit</a>&nbsp;&nbsp;"
									+ "<img border=\"0\" src=\"img/silk/link_break.png\" align=\"absmiddle\">&nbsp;"
									+ "<a href=\"javascript:void(0)\" class=\"j-action-delete\">Remove</a>"
									+ "</div>";
						}
						var _4e4 = new Ext.XTemplate(
								"<div class=\"j-relate-visual-title\">{[this.textDirection("
										+ _4e2 + ")]}</div>",
								"<tpl for=\".\">",
								"<div class=\"relationshipBox\">",
								"<div class=\"j-relate-visual-container\">",
								"<div class=\"j-relate-visual-box\" id=\"{itemId}\">",
								"<span class=\"j-text-label\">Item:</span> ",
								"<span class=\"j-relate-visual-item\">{documentKey} - {name}</span>",
								"<br/><span class=\"j-text-label\">Project:</span> ",
								"{projectName}",
								_4e3,
								"</div>",
								"</div>",
								...
								"</tpl>",
								{
									textDirection : function(_4e5) {
										var text = (_4e5) ? "<img align=\"top\" style=\"padding-right: 10px;\" src=\"img/silk/arrow_right.png\"/>"
												+ i18n.g("j.l.relateforward")
												: i18n.g("j.l.relateback")
														+ "<img align=\"top\" style=\"padding-left: 10px;\" src=\"img/silk/arrow_right.png\"/>";
										return text;
									}
								});
						return _4e4;
					...
					prepareData : function(data) {
						return {
							...
							traceTypeName :(data.traceType) ? data.traceType.name
									: "",
							directionImage :data.forward ? "arrow_redo.png"
									: "arrow_undo.png",
							display :""
						};
					},
					...
					onSelectItem : function(view, _4f2, _4f3, e, _4f5) {
						switch (_4f5) {
						case "switch":
							relationshipSvc.switchTraceDirection(_4f3.id,
									this.onSuccessAction.createDelegate(this));
							break;
						case "edit":
							this.editItem(_4f3);
							break;
						case "delete":
							var _4f6 = (_4f3.data.forward) ? {
								fromDocumentId :this.data.getItemId(),
								toDocumentId :_4f3.data.documentId
							} : {
								toDocumentId :this.data.getItemId(),
								fromDocumentId :_4f3.data.documentId
							};
							relationshipSvc.deleteTrace(_4f6,
									this.onSuccessAction.createDelegate(this));
							break;
						}
					},
...
Ext
		.extend(
				...
				Ext.Component,
				{
					...
					listenToFck : function() {
						if (!this.fckOn) {
							this.fckOn = true;
							jx.appContext.on("fckComplete", this.onFckComplete,
									this);
						}
					},
					...
					setFieldDefinitions : function(_4fb) {
						delete this.fields;
						this.fields = [];
					...
					createRow : function(meta, item) {
						...
						var _50c = meta.required && !this.readOnly ? "*"
								+ meta.label : meta.label;
						if (meta.labelAlign != "top") {
							var row1 = _505.append(_509, {
								labelCls :this.labelClass,
								labelValue :_50c,
								separator :_50a,
								align :meta.labelAlign || this.labelAlign,
								style :"width:"
										+ (meta.labelWidth || this.labelWidth)
										+ ";"
							});
						...
						if (meta.sortType == "__markup__") {
							...
							if (meta.getType() == Date
								...
								if (meta.getType() == "Lookup"
									...
									if ("Number number int Integer float Float"
											.indexOf(meta.getType()) > -1) {
										if (val.length == 0) {
											val = "0";
										}
										var n = parseFloat(val, 10) + "";
										if (n.indexOf(".") > -1) {
											n = Math.round(parseFloat(val, 10),
													2);
										}
										cell.innerHTML = n;
									} else {
										if (meta.getType() == "boolean") {
											cell.appendChild(document
													.createTextNode(val ? "Yes"
															: "No"));
										} else {
											if (meta.getType() == "text") {
												if (meta.controlTypeId == 2) {
													cell.innerHTML = this
															.encodeTextForDisplay(val);
												} else {
													val = "<div class=\"j-text-box\">"
															+ val + "</div>";
													cell.innerHTML = val;
												}
											} else {
					...
					fillCellWithControl : function(cell, meta, val) {
						if (meta.sortType == "__markup__") {
							...
							if (meta.getType() == Date
									|| meta.getType() == "date") {
								if (!isNaN(val)) {
									var _51e = meta.format
											|| this.defaultDateFormat;
									this
											.createDatePicker(cell, meta, _51e,
													val);
								} else {
									cell.innerHTML = "";
								}
								...
								if (meta.getType() == "Lookup"
									...
									if ("Number number int Integer float Float"
										...
										if (meta.getType() == "boolean") {
											this
													.createCheckBox(cell, meta,
															val);
										} else {
											if (meta.getType() == "multiCheckboxes") {
												this.createMultiCheckboxes(
														cell, meta, val);
											} else {
												if (meta.getType() == "multiRadioBox") {
													this.createMultiRadioBox(
															cell, meta, val);
												} else {
													if (meta.getType() == "text") {
														val = val ? val : "";
					...
					createDropDown : function(cell, meta, val) {
						...
						if (val) {
							...
							var _529 = this.getLookupByDisplay(meta,
									"Select One");
					...
					createMultiCheckboxes : function(cell, meta, val) {
						...
						if (!this.checkboxTpl) {
							this.checkTpl = new Ext.Template(
					...
					createHtmlEditor : function(cell, meta, val) {
						...
						var _545 = new Ext.form.HtmlEditor( {
							name :meta.field,
					...
					createFckRichText : function(cell, meta, val) {
						this.listenToFck();
						var _549 = meta.height ? meta.height
						...
						var _54c = Ext.DomHelper.append(div, {
							tag :"textarea",
							id :id,
							name :id
						});
						var _54d = new Ext.Resizable(div, {
							handles :"s e",
							minWidth :100,
							minHeight :100,
							maxWidth :1024,
						...
						_54e.Config["CustomConfigurationsPath"] = this.baseUrl
								+ "js/FCKconfigs/contourFCKEditor.js";
					...
					createDatePicker : function(cell, meta, _555, val) {
						...
						var _558 = new Ext.form.DateField( {
							format :_555,
							allowBlank :true
						});
						_558.render(_557);
					...
					createMultiRadioBox : function(cell, meta, val) {
						...
						var div = Ext.DomHelper.append(cell, {
							tag :"div",
							cls :(meta.cls != null) ? meta.cls
									: "j-form-scroll-box",
							id :id + "_" + meta.field
						}, true);
						if (!this.radioTpl) {
							this.radioTpl = new Ext.Template(
							...
							if (meta.control) {
								...
								if (meta.dataType == Date
									...
									if (meta.dataType == "lookup"
											|| meta.dataType == "Lookup") {
										_58d = this.getLookup(meta,
												meta.control.value);
										if (_58d) {
											_58d = {
												id :_58d.id,
												name :_58d.name,
												firstName :_58d.firstName,
												lastName :_58d.lastName
											};
										}
									} else {
										if (meta.dataType == "multiCheckboxes") {
											_58d = this
													.getMultiCheckboxesValues(meta);
										} else {
											if (meta.dataType == "multiRadioBox") {
												_58d = this
														.getMultiRadioBoxValue(meta);
											} else {
												if (meta.dataType == "boolean") {
													...
													if (meta.dataType == "text") {
														if (meta.control.controlType == "fck") {
															var _58e = FCKeditorAPI
																	.GetInstance(meta.control.instanceName);
															if (_58e.IsDirty()) {
																_58d = _58e
																		.GetXHTML();
															} else {
					...
					onFckComplete : function(_592) {
						...
						for ( var i in this.fields) {
							var meta = this.fields[i];
							if (meta.control
									&& meta.control.controlType == "fck") {
								_593++;
							}
							if (meta.control
									&& meta.control.controlType == "fck"
									&& meta.control.instanceName == _592) {
								var _596 = FCKeditorAPI.GetInstance(_592);
								var _597 = this.project ? this.project.id : "";
								_596.Config.ImageBrowserURL = _596.Config.BasePath
										+ "filemanager/browser/default/browser.html?"
										+ "Type=Image&Connector="
										+ escape("../../../../../../fck.req?projectId="
												+ _597);
								_596.Config.LinkBrowserURL = _596.Config.BasePath
										+ "filemanager/browser/default/browser.html?"
										+ "Type=Link&Connector="
										+ escape("../../../../../../fck.req?projectId="
												+ _597);
								_596.Config.ImageUploadURL = "../../../../fck.req?Type=Image&Command=FileUpload&projectId="
										+ _597;
								_596.Config.LinkUploadURL = "../../../../fck.req?Type=Link&Command=FileUpload&projectId="
										+ _597;
					...
					renderRows : function(body, item) {
						for ( var j = 0; j < this.fields.length; j++) {
							var meta = this.fields[j];
							if (!meta.hidden
									&& !(this.readOnly && meta.hideReadOnly)) {
					...
					initTemplates : function() {
						if (!this.templates) {
							if (!jx.form.JamaBasicForm.tpls) {
								...
								tpls.rowTpl1 = new Ext.Template(
										"<tr><td class=\"{labelCls}\" align=\"{align}\" style=\"{style}\">{labelValue}{separator}</td><td></td></tr>");
								tpls.rowTpl2 = new Ext.Template(
										"<tr><td class=\"{labelCls}\" colspan=\"2\">{labelValue}{separator}</td></tr>");
								tpls.rowTpl3 = new Ext.Template(
					...
					onRender : function(ct, _5b2) {
						ct = Ext.get(ct);
						this.headerPanel = Ext.DomHelper
								.append(
										ct,
										"<div class=\"x-grid-topbar contourComponentTop\"></div>",
										true);
					...
					beforeDestroy : function() {
						this.destroyWidgetControls();
						jx.form.JamaBasicForm.superclass.beforeDestroy.apply(
								this, arguments);
					}
				});
		...
		.extend(
				...
				jx.form.JamaBasicForm,
				{
					...
					createButtonPanel : function() {
						...
						this.editButton = this.createButton(_5b5, "edit",
								this.editButtonLabel);
						this.saveButton = this.createButton(_5b5, "save",
								this.saveButtonLabel);
						this.cancelButton = this.createButton(_5b5, "cancel",
					...
					createButton : function(_5be, _5bf, _5c0) {
						var _5c1 = Ext.DomHelper.append(_5be, {
							tag :"input",
							type :"button",
							value :_5c0,
							name :this.widgetId + "_" + _5bf,
					...
					dwrSave : function(_5c9, item) {
						_5c9(item, {
							...
							errorHandler :this.handleException
									.createDelegate(this)
						});
					},
					saveCallback : function(item) {
						...
						this.onCancel();
						this.fireEvent("afterSave", this, item ? item
								: this.item);
					},
					...
					onRender : function(ct, _5d4) {
						jx.form.JamaForm.superclass.onRender.call(this, ct,
								_5d4);
...
Ext.extend(jx.form.DwrJamaForm, jx.form.JamaForm, {
	dwrArgs :null,
	dwrLoadCall :null,
	dwrSaveCall :null,
	load : function() {
...
Ext.extend(jx.form.UserForm, jx.form.JamaForm, {
	mode :"ldap",
	orgId :null,
	...
	getFormDefinitions : function() {
		var that = this;
		lookup.getLookupListByTypeCategory(1, 1, 0, {
			callback : function(list) {
				that.themeList = list;
			},
			async :false
		});
		lookup.getLookupListByTypeCategory(2, 1, 0, {
			callback : function(list) {
				that.languageList = list;
			},
			async :false
		});
		user.getAllRoleListByOrgId(this.orgId, {
			callback : function(list) {
				that.roleList = list;
			},
			async :false
	...
	getLicenseList : function() {
		if (this.orgId) {
			var self = this;
			licenseSvc.getSystemLicenseDto(this.orgId, {
		...
		var _5e9 = (_5e8.numberNamed >= 0)
				&& (_5e8.numberNamed <= _5e8.numberUsersNamed);
	...
	render : function() {
		...
		user.getUserWithRoles(this.getAppContext().user.id,
				this.getUserCallback.createDelegate(this));
	},
...
Ext.extend(jx.form.OrganizationForm, jx.form.JamaForm, {
	org :null,
	getFormDefinitions : function() {
		return ( [ {
			field :"name",
	...
	validate : function(item) {
		var self = this;
		validation.validateOrganization(item, {
			callback : function(_5f4) {
				self.errors = _5f4;
			},
			async :false
		});
...
jx.window.ProjectFormWindow = function(_5f6) {
	_5f6 = Ext.applyIf(_5f6, {
		title :_5f6.project.isFolder ? "Add Project Folder" : i18n
				.g("j.l.projectFormTitle"),
		width :"90%",
		height :500,
		modal :true,
		closable :true,
		...
		minimizable :false,
		buttons : [ {
			text :i18n.g("j.b.projectSave"),
			handler :this.saveProject,
			scope :this
		}, {
			text :i18n.g("j.b.projectCancel"),
...
Ext.extend(jx.window.ProjectFormWindow, Ext.Window, {
	project :null,
	event :null,
	initComponent : function() {
		jx.window.ProjectFormWindow.superclass.initComponent.call(this);
		this.getAppContext().on("afterSaveProject", this.onAfterSaveProject,
				this);
	},
	onEvent : function(e) {
	...
	createProjectForm : function() {
		var _5f8 = new jx.form.ProjectForm( {
			formType :"editOnly"
		});
		var _5f9 = new Ext.Panel( {
			items : [ _5f8 ],
			autoScroll :true
		});
...
jx.window.ProjectCopyWindow = function(_607) {
	_607 = Ext.applyIf(_607, {
		title :i18n.g("j.l.projectCopyTitle"),
		height :300,
		width :700,
		modal :true,
		closable :true,
		...
		minimizable :false,
		layout :"fit",
		items : [ this.createCopyForm() ],
		buttons : [ {
			text :i18n.g("j.b.projectCopySave"),
			handler :this.copyProject,
			id :"p-copy-save-button",
			scope :this
		}, {
			text :i18n.g("j.b.projectCopyCancel"),
			handler :this.onCancel,
			id :"p-copy-cancel-button",
			scope :this
		} ]
	});
...
Ext
		.extend(
				...
				Ext.Window,
				{
					...
					copyRelateFieldList : [],
					initComponent : function() {
						jx.window.ProjectCopyWindow.superclass.initComponent
								.call(this);
					},
					createCopyForm : function() {
						...
						var _60a = new jx.data.SimpleListStore( {
							fields : [ {
								name :"id",
								type :"int"
							}, {
							...
							data :this.relationshipType
						});
						var _60b = new Ext.form.Checkbox( {
							name :"cppCreateRelationships",
							style :"align: left",
							fieldLabel :i18n
									.g("j.l.projectCopyCreateRelationships"),
							id :"p-copy-form-chkbox-createrelate"
						});
						var _60c = new Ext.form.ComboBox( {
							fieldLabel :i18n
									.g("j.l.projectCopyRelationshipType"),
							store :_60a,
							displayField :"name",
							valueField :"id",
							mode :"local",
							id :"p-copy-form-combo-relatetype",
							triggerAction :"all",
							selectOnFocus :true,
							disabled :true,
							editable :false,
						...
						var _60d = new Ext.form.Radio( {
							fieldLabel :i18n
									.g("j.l.projectCopyTraceToOriginal"),
							checked :true,
							disabled :true,
							name :"relationshipDirection",
							inputType :"radio",
							id :"p-copy-form-radio-forward",
							inputValue :"forward"
						});
						this.copyRelateFieldList.push(_60d);
						var _60e = new Ext.form.Radio( {
							fieldLabel :i18n.g("j.l.projectCopyTraceToCopy"),
							checked :false,
							disabled :true,
							name :"relationshipDirection",
							inputType :"radio",
							id :"p-copy-form-radio-backward",
							inputValue :"backward"
						});
									...
									items : [
											{
												xtype :"textfield",
												fieldLabel :i18n
														.g("j.l.projectCopyNewProjectName"),
												id :"p-copy-form-txtfield-projectname",
												name :"cppProjectName",
												width :300
											},
											{
												...
												items : [
														{
															...
															xtype :"fieldset",
															title :i18n
																	.g("j.l.projectCopyIncludedItems"),
															layout :"form",
															items : [
																	{
																		xtype :"checkbox",
																		fieldLabel :i18n
																				.g("j.l.projectCopyProjectSettings"),
																		id :"p-copy-form-chkbox-projectsettings",
																		name :"cppProjectSettings"
																	},
																	{
																		xtype :"checkbox",
																		fieldLabel :i18n
																				.g("j.l.projectCopyEmailGroups"),
																		name :"cppEmailGroups",
																		id :"p-copy-form-chkbox-emailgroups"
																	},
																	{
																		xtype :"checkbox",
																		fieldLabel :i18n
																				.g("j.l.projectCopyProjectPermissions"),
																		name :"cppProjectPermissions",
																		id :"p-copy-form-chkbox-projectpermissions"
																	},
																	{
																		xtype :"checkbox",
																		fieldLabel :i18n
																				.g("j.l.projectCopyExistingRelationships"),
																		name :"cppExistingRelationships",
																		id :"p-copy-form-chkbox-existingrelate"
																	},
																	{
																		xtype :"checkbox",
																		fieldLabel :i18n
																				.g("j.l.projectCopySharedFilters"),
																		name :"cppSharedFilters",
																		id :"p-copy-form-chkbox-filters"
																	},
																	{
																		xtype :"checkbox",
																		fieldLabel :i18n
																				.g("j.l.projectCopyTags"),
																		name :"cppTags",
																		id :"p-copy-form-chkbox-tags"
																	},
																	{
																		xtype :"checkbox",
																		fieldLabel :i18n
																				.g("j.l.projectCopyReleases"),
																		name :"cppReleases",
																		id :"p-copy-form-chkbox-releases"
																	} ]
														},
														{
															columnWidth :0.6,
															...
															title :i18n
																	.g("j.l.projectCopyCreateRelationshipsSection"),
															layout :"form",
															items : [ _60b,
																	_60d, _60e,
																	_60c ]
					...
					copyProject : function() {
						...
						project
								.copyProject(
										...
										map,
										{
											callback :this.onSuccessCopyProject
													.createDelegate(this),
											exceptionHandler :this.onExceptionCopyProject
													.createDelegate(this)
										});
					},
					...
					onSuccessCopyProject : function(_61a) {
						...
						this.onCancel();
						this.getAppContext().fireEvent("showMessage",
								"Success", "The project has been copied");
					...
					onExceptionCopyProject : function(_61b, _61c) {
						...
						Ext.MessageBox
								.alert("Error",
										"The copy project did not complete successfully. Nothing has been changed.");
					}
				});
jx.form.ProjectForm = function(_61d) {
	_61d = Ext.applyIf(_61d, {
		formType :"readOnly",
		showButtons :false
	});
	jx.form.ProjectForm.superclass.constructor.call(this, _61d);
};
Ext.extend(jx.form.ProjectForm, jx.form.JamaForm, {
	orgId :null,
	projectId :null,
	parentId :null,
	isFolder :false,
	loadProject : function(_61e) {
		if (_61e != null && _61e.id != null) {
			this.loadProjectCallback(_61e);
		} else {
			var _61f = this.loadNewProjectCallback.createDelegate(this);
			projectTypeSvc.getProjectTypeMetaDataByOrg(
					this.getAppContext().organization.id, {
						callback :_61f
					});
		}
	},
		...
		.extend(
				...
				jx.form.JamaBasicForm,
				{
					...
					loadOrg : function(org) {
						admin.getOrganization(org.orgId, this.populateLicense
								.createDelegate(this));
					},
					...
					getFormDefinitions : function() {
						return ( [
								{
									field :"clientName",
									label :i18n.g("j.l.licenseClientName"),
									dataType :"string"
								},
								{
									field :"clientOrganization",
									label :i18n.g("j.l.licenseClientOrg"),
									dataType :"string"
								},
								{
									field :"productName",
									label :i18n.g("j.l.licenseProductName"),
									dataType :"string"
								},
								{
									field :"productEdition",
									label :i18n.g("j.l.licenseProductEdition"),
									dataType :"string"
								},
								{
									field :"licenseType",
									label :i18n.g("j.l.licenseType"),
									dataType :"string"
								},
								{
									field :"userNumber",
									mapping : function(item) {
										return item.numberNamed
												&& item.numberNamed < 0 ? "unlimited"
												: item.numberNamed;
									},
									label :i18n.g("j.l.licenseNamedUsers"),
									dataType :"string"
								},
								{
									field :"curUserNumber",
									mapping : function(item) {
										return item.numberConcurrent
												&& item.numberConcurrent < 0 ? "unlimited"
												: item.numberConcurrent;
									},
									label :i18n.g("j.l.licenseFloatingUsers"),
									dataType :"integer"
								},
								{
									field :"readOnlyUserNumber",
									mapping : function(item) {
										return item.numberReadOnly
												&& item.numberReadOnly < 0 ? "unlimited"
												: item.numberReadOnly;
									},
									label :i18n.g("j.l.licenseReadOnlyUsers"),
									dataType :"integer"
								}, {
									field :"creationDate",
									label :i18n.g("j.l.licenseCreationDate"),
									dataType :"date"
								}, {
									field :"expirationDate",
									label :i18n.g("j.l.licenseExpirationDate"),
									dataType :"date"
								} ]);
					},
					validate : function(item) {
					...
					render : function() {
						jx.form.LicenseForm.superclass.render.apply(this,
								arguments);
						this.setItem(this.org);
					}
				});
...
jx.form.ProjectPropertyForm = function(_641) {
	...
	this.fieldDefinitions = [ {
		field :"jama.project.shouldVersion",
		label :"Version Items?",
		dataType :"boolean"
	}, {
		field :"jama.project.showIdInTree",
		label :"Display IDs in Project Explorer?",
		dataType :"boolean"
	}, {
		field :"jama.project.keyEditable",
		label :"Item ID Editable?",
		dataType :"boolean"
	}, {
		field :"jama.project.maxTreeNodes",
		label :"Max items displayed in explorer tree",
		dataType :"integer"
	}, {
		field :"jama.project.maxPageSize",
		label :"Max items displayed in grid views",
		dataType :"integer"
	} ];
...
Ext.extend(jx.form.ProjectPropertyForm, jx.form.DwrJamaForm, {
	data :null,
	getField : function(obj, meta) {
...
Ext.extend(jx.form.SimpleItemForm, jx.form.JamaForm, {
	project :null,
	groupList :null,
	loadArtifact : function(_64c, _64d) {
		this.setMask();
		var _64e = this.loadArtifactCallback.createDelegate(this);
		documentManager.getDocumentDto(_64c, {
			callback :_64e,
			errorHandler :this.handleException.createDelegate(this)
		});
	},
...
Ext
		.extend(
				...
				jx.form.JamaForm,
				{
					...
					item :null,
					selected :null,
					editItem : function(item, _65b, _65c) {
						this.item = item;
						this.selected = _65c;
					...
					loadItem : function(item, _65e) {
						...
						documentManager.getDocumentDto(item.id, {
							callback :this.loadItemCallback
									.createDelegate(this),
							errorHandler :this.handleException
									.createDelegate(this)
						});
					...
					newItem : function(item, _664) {
						var _665 = item.documentGroup ? item.documentGroup.id
								: null;
						var meta;
						if (_665) {
							meta = {
								fieldList :this.getFieldsForGroup(_665)
							};
						} else {
							meta = {
								fieldList :this.getFieldsForNewItem()
							};
						}
						this.newFolder = false;
						this.loadItemWithMeta( {
							documentGroup : {
								id :_665
							},
					...
					loadItemWithMeta : function(item, meta) {
						...
						if (item.isFolder) {
							meta.fieldList = this
									.filterFieldsForFolder(meta.fieldList);
						}
						this.setFieldDefinitions(meta.fieldList);
						this.setItem(item);
					...
					setGroupHandler : function() {
						...
						if (_66a && _66a.control) {
							...
							this.groupMetaControl.addListener("change",
					...
					getNewItem : function() {
						...
						if (item.documentGroup) {
							item.documentGroup = {
								id :item.documentGroup.id,
								displayPlural :item.documentGroup.displayPlural
							};
						}
						return item;
					},
					...
					getFieldsForGroup : function(_67d) {
						...
						var self = this;
						documentTypeSvc
								.getDocumentTypeMetaDataByDocumentGroupId(_67d,
										_67e, {
											callback : function(list) {
												self.dynFields = list;
											},
						...
						return this.getFieldsForNewItem(true).concat(
								this.dynFields.fieldList);
					},
					getFieldsForNewItem : function(_681) {
						...
						var self = this;
						documentManager.getDocumentGroupList(_682, {
							callback : function(list) {
								self.groupList = list;
							},
							async :false
...
Ext.extend(jx.form.ItemSaveForm, jx.form.JamaForm, {
	groupList :null,
	load : function(_686, _687) {
	...
	getFields : function(_688) {
		...
		var self = this;
		distributionGroup.getDistributionGroupListForProject(_688, {
			callback : function(list) {
				self.groupList = list;
			},
			async :false
		...
		_68b.push( {
			...
			controlTypeId :2,
			field :"comment",
			label :i18n.g("j.l.itemSaveVersionNotes"),
			labelAlign :"top"
		});
		_68b.push( {
			dataType :"multiCheckboxes",
			field :"distGroups",
			label :i18n.g("j.l.itemSaveSendNotification"),
			options :this.groupList,
			returnIds :true,
			labelAlign :"top"
		});
...
jx.form.AttachmentUploadForm = function(_68c) {
	_68c = Ext.applyIf(_68c, {
		baseCls :"x-plain",
		ctCls :"j-upload-panel",
		labelWidth :100,
		...
		baseUrl :this.getAppContext().baseUrl,
		items : [ {
			fieldLabel :i18n.g("j.l.uploadFileDescription"),
			allowBlank :false,
			name :"attachment_description",
			anchor :"100%"
		}, {
			fieldLabel :i18n.g("j.l.uploadFileName"),
			name :"fileName",
			allowBlank :true,
			inputType :"file",
			anchor :"100%",
			...
			fieldLabel :i18n.g("j.l.uploadFileNote"),
			name :"attachment_note",
			anchor :"100%",
			hidden :_68c.showNote ? false : true,
			hideLabel :_68c.showNote ? false : true
		}, {
			xtype :"checkbox",
			name :"attachment_replace",
			hidden :true,
			checked :true,
			readOnly :false,
			hideLabel :true
				...
				Ext.form.FormPanel,
				{
					...
					loadAttachment : function(att) {
						if (att.attachment_id) {
							this.textBox.getEl().innerHTML = (this.getTpl()
									.apply( {
										fileName :att.existingFileName
									}));
						} else {
					...
					render : function() {
						jx.form.AttachmentUploadForm.superclass.render.apply(
								this, arguments);
					...
					upload : function() {
						...
						var att = this.getAttachmentByName(this.uploadField
								.getRawValue());
						if (att != null && !item.attachment_id) {
							...
							Ext.MessageBox.show( {
								...
								fn :this.uploadConfirm.createDelegate(this)
							});
						} else {
							if (att != null && (item.attachment_id != att.id)) {
								Ext.MessageBox
										.alert(
												"Warning",
												"The file with the same name exists for another attachment. Please update that attachment.");
							} else {
					...
					updateDescription : function() {
						...
						attachment
								.updateFileAttachment(
										...
										{
											callback :this.updateItemCallback
													.createDelegate(this),
											exceptionHandler : function() {
												Ext.MessageBox
														.alert("Error",
																"The description can't be updated.");
											}
										});
					},
					uploadConfirm : function(_692) {
						if (_692 == "ok") {
							this.getForm().submit(
									{
										waitMsg :i18n
												.g("j.l.uploadingWaitMessge"),
										url :this.baseUrl + this.uploadUrl,
										reset :false,
										success :this.uploadCallback
												.createDelegate(this),
										failure : function(form, _694) {
										},
										params : {
											attachment_projectId :this.data
													.getProjectId()
										}
									});
						} else {
					...
					saveDocumentAttachment : function(_698) {
						...
						var att = {
							id :item.document_attachment_id,
							attachment : {
								id :_698 || item.attachment_id
							},
							note :item.attachment_note
						};
						documentManager.saveDocumentAttachment(att, {
							id :this.data.getItemId()
						}, {
							callback :this.saveDocAttachmentCallback
									.createDelegate(this),
							exceptionHandler : function() {
					...
					getAttachmentByName : function(_69c) {
						...
						var self = this;
						attachment.getAttachmentByFileName(this.data
								.getProjectId(), _69e, {
					...
					getTpl : function() {
						...
						if (!mw.tplCache) {
							mw.tplCache = new Ext.XTemplate(
									"<div class=\"j-section-header\">"
											+ i18n
													.g("j.l.uploadFileUpdateAttachmentMessage")
											+ " {fileName}</div>");
						}
						return mw.tplCache;
					}
...
Ext
		.extend(
				jx.form.VersionCompareForm,
				jx.form.JamaBasicForm,
				{
					changedClass :"changed",
					rowClass :"",
					rowAlternateClass :"alt",
					labelHeaderClass :"versionLabelHeader",
					compareHeaderClass :"versionValueHeader",
					alternateRows :false,
					showDetails :false,
					fromDoc :null,
					toDoc :null,
					updateHeader : function(_6a3, _6a4, _6a5) {
						var head = this.domNode.getElementsByTagName("thead")[0];
					...
					createHeader : function(_6ad) {
						var _6ae = Ext.DomHelper.insertFirst(this.table, {
							tag :"thead"
						});
						var row = document.createElement("tr");
					...
					createRow : function(body, _6b2, _6b3, _6b4) {
						var _6b5 = (this.alternateRows && _6b2 % 2 == 1) ? this.rowAlternateClass
								: null;
						...
						_6b7 = (_6b7 == null ? "" : _6b7);
						_6b8 = (_6b8 == null ? "" : _6b8);
						var row = Ext.DomHelper.append(body, {
							tag :"tr",
							cls :_6b5,
							children : [ {
								tag :"td",
						...
						if (!_6bf && !this.showDetails && !_6b6.ignoreChange
								&& this.changedClass) {
					...
					getFormDefinition : function(dto) {
						return this.getVersionFormDefinition().concat(
								dto.documentTypeDto.fieldList);
					},
					getVersionFormDefinition : function() {
						if (!this.versionFormDefinition) {
							this.versionFormDefinition = [
									{
										field :"versionNumber",
									...
									},
									{
										...
										field :"versionCreatedBy",
										label :i18n.g("versionBy"),
										ignoreChange :true
									} ];
						}
					...
					render : function() {
						jx.form.VersionCompareForm.superclass.render.apply(
								this, arguments);
						if (this.fromDoc && this.fromDoc.documentTypeDto
								&& this.toDoc) {
							this.compareItems(this.fromDoc, this.toDoc);
						}
					}
...
jx.form.SimpleGroupForm = function(_6ca) {
	_6ca = Ext.applyIf(_6ca, {
		formType :"readOnly",
		showButtons :false,
		dwrLoadCall :documentManager.getDocumentGroup,
		readOnly :true
	});
	jx.form.SimpleGroupForm.superclass.constructor.call(this, _6ca);
};
Ext.extend(jx.form.SimpleGroupForm, jx.form.JamaForm, {
	data :null,
	...
	getFields : function() {
		var _6cd = [ {
			...
			id :40,
			label :"Unique ID Starting Number",
			options :null,
			readOnly :false,
			required :null,
			showInFolder :true,
			...
			dataFormat :null,
			defaultValue :null,
			field :"displayInReleaseTree",
			id :40,
			label :"Visible in Releases",
			options :null,
			readOnly :false,
			required :false,
			showInFolder :true,
...
jx.form.GroupForm = function(_6ce) {
	_6ce = Ext.applyIf(_6ce, {
		dwrLoadCall :documentManager.getDocumentGroup,
		dwrSaveCall :documentManager.saveDocumentGroup,
		dwrDocumentTypeCall :documentTypeSvc.getDocumentTypeList,
		formType :"editOnly",
		showButtons :false
	});
	jx.form.GroupForm.superclass.constructor.call(this, _6ce);
};
Ext.extend(jx.form.GroupForm, jx.form.JamaForm, {
	treeImgPath :"img/tree",
	dwrLoadCall :null,
	dwrSaveCall :null,
	org :null,
	project :null,
	documentTypeList :null,
	group :null,
	loadGroup : function(_6cf, _6d0, org) {
		this.group = _6cf;
		this.project = _6d0;
		this.org = org;
		this.setFieldDefinitions(this.getFields());
	...
	validate : function(item, form) {
		var self = this;
		validation.validateDocumentGroup(item, {
			callback : function(_6d9) {
				self.errors = _6d9;
			},
			async :false
		});
	...
	handleException : function(msg, ex) {
		...
		if (_6e2 != null && _6e2.length > 0) {
			...
			Ext.MessageBox.alert("Can't save set", String.format(
					"Details: {0}", msg));
		}
	},
	getFields : function() {
		...
		var self = this;
		documentTypeSvc.getDocumentTypeList(2, this.org.id, {
			callback : function(list) {
		...
		var _6ea = [
				...
				},
				{
					...
					options : [
							...
							{
								id :"folder_page_white.png",
								name :"<img border=\"0\" src=\"" + _6e3
										+ "/folder_page_white.png\"/>"
							},
							{
								id :"folder_picture.png",
								name :"<img border=\"0\" src=\"" + _6e3
										+ "/folder_picture.png\"/>"
							},
							{
...
Ext
		.extend(
				...
				{
					project :null,
					loadFilter : function(_6ee, _6ef) {
						if (_6ef) {
							this.project = _6ef;
						}
						if (_6ee && _6ee.id) {
							var that = this;
							filterSvc.getFilter(_6ee.id, {
								callback : function(f) {
									that.filter = f;
								},
								async :false
							});
							documentTypeSvc.getDocumentTypeMetaDataForFilter(
									this.filter.typeId, this.getProjectId(), {
										callback :this.load
												.createDelegate(this),
										async :false
									});
							var _6f2 = {
								...
								documentType :this.filter.typeId,
								shared :this.filter.scope == 2
							};
					...
					onSaveForm : function(_6f3) {
						...
						if (_6f4.length == 0) {
							...
							filterSvc.saveFilter(_6f5, this.onFilterSaved
									.createDelegate(this));
							...
							this.filterMessagesDiv.innerHTML = this
									.encodeTextForDisplay(_6f6);
						}
					},
					fillCellWithControl : function(cell, meta, val) {
						if (meta.getType() == Date || meta.getType() == "date") {
							if (!isNaN(val)) {
								...
								var _6fe = this.getDateFromFilter(_6fc,
										"fromdate");
								...
								meta.field = _6fc + "_To";
								var _700 = this.getDateFromFilter(_6fc,
										"todate");
							...
							if (meta.getType() == "boolean") {
								var _701 = this
										.getBooleanFromFilter(meta.field);
								this.createCheckBox(cell, meta, _701);
							} else {
								if (meta.getType() == "Lookup") {
									this.createScrollableCheckBox(cell, meta,
											val);
								}
							}
						}
					...
					createCheckBox : function(cell, meta, val) {
						...
						_708.id = this.getEl().id + "_" + meta.field
								+ "_ignore";
						_708.name = _708.id;
					},
					createScrollableCheckBox : function(cell, meta, val) {
						...
						if (meta.actualDataType == "User") {
							...
							_710.checked = this.isValueInFilter(meta.field,
									"currentUser");
					...
					getBooleanFromFilter : function(_720) {
						...
						for ( var i = 0; i < _721.length; i++) {
							if (_721[i].field == _720
									&& _721[i].paramValues.length > 0) {
					...
					getMetaForTypeId : function(_723) {
						var self = this;
						documentTypeSvc.getDocumentTypeMetaDataForFilter(_723,
								this.getProjectId(), {
					...
					onSaveAsForm : function() {
						...
						if (_729.length == 0) {
							...
							filterSvc.saveFilter(_72a, this.onFilterSaved
									.createDelegate(this));
							this.filterMessagesDiv.style.display = "none";
						} else {
							this.filterMessagesDiv.style.display = "block";
							...
							this.filterMessagesDiv.innerHTML = this
									.encodeTextForDisplay(_72b);
						}
					},
					onViewForm : function() {
						var _72d = this.buildFilter();
						filterSvc.viewFilterResults(_72d, this.onFilterSaved
								.createDelegate(this));
					},
					...
					buildFilter : function() {
						...
						var _733 = {
							...
							scope :_72f,
							refId :_730,
							typeId :_731.documentType ? _731.documentType.id
									: null,
							parameters :new Array()
						};
						for ( var j = 0; j < this.fields.length; j++) {
							if (this.fields[j].dataType != "text"
									&& this.fields[j].dataType != "string") {
								var meta = this.fields[j];
								var _736 = {
									type :meta.getType(),
									field :meta.field,
								...
								if (meta.getType() == "Lookup") {
									meta.returnIds = true;
									_736.paramValues = this
											.getMultiCheckboxesValues(meta);
								} else {
									if (meta.getType() == "date") {
										var _737 = meta.control1.getValue();
										if (_737 != "") {
											_736.paramValues.push(_737
													.format("m/d/Y"));
										}
										var _738 = meta.control2.getValue();
										if (_738 != "") {
											_736.paramValues.push(_738
													.format("m/d/Y"));
										}
									} else {
										if (meta.getType() == "boolean") {
											var _739 = Ext
													.getDom(this.getEl().id
															+ "_" + meta.field
															+ "_ignore");
											if (!_739.checked) {
												var _73a = Ext.getDom(this
														.getEl().id
														+ "_" + meta.field);
												_736.paramValues
														.push(_73a.checked ? "T"
					...
					afterRender : function() {
						var self = this;
						documentTypeSvc.getDocumentTypeList(2, this.getOrgId(),
								{
									callback : function(list) {
										self.documentTypeList = list;
									},
						...
						this.filterMessagesDiv = _742.createChild( {
							tag :"div"
						}, null, true);
						this.documentTypeForm = new jx.form.JamaBasicForm( {
							labelClass :"label",
							fieldDefinitions :meta,
					...
					onRender : function(ct, _74c) {
						jx.form.FilterForm.superclass.onRender.call(this, ct,
								_74c);
					},
					render : function() {
						jx.form.FilterForm.superclass.render.apply(this,
								arguments);
		...
		.extend(
				...
				jx.form.JamaForm,
				{
					...
					loadFilter : function(_74e, _74f) {
						...
						documentTypeSvc.getDocumentTypeMetaData(this.typeId,
								this.getProjectId(), false, this.loadCallback
										.createDelegate(this));
					},
					createTable : function(div) {
						...
						var _752 = Ext.DomHelper.append(div, {
							cls :this.tableClass,
							tag :"table",
							width :"100%",
							children : [ {
					...
					createBatchCheckBox : function(cell, meta, val) {
						...
						Ext.get(_75c).on(
								"click",
								this.onCheckBoxClicked.createDelegate(this,
										[ meta ], 0));
					...
					setItem : function(item) {
						...
						for ( var j = 0; j < this.fields.length; j++) {
							var meta = this.fields[j];
							if (!meta.readOnly && meta.dataType != "text"
									&& meta.dataType != "string") {
								var _764 = meta.field;
								if (_764 != "modifiedDate"
										&& _764 != "createdDate"
										&& _764 != "createdBy"
										&& _764 != "modifiedBy") {
									var row = document.createElement("tr");
					...
					batchUpdate : function() {
						...
						if (_76a.length == 0) {
							...
							var _76c = this.batchUpdateCallback
									.createDelegate(this);
							...
							documentManager.updateBatchDocument(_76b,
									this.filter, _76d, _76f, _76e, _76c);
							...
							this.messagesDiv.innerHTML = this
									.encodeTextForDisplay(_771);
						}
					},
					...
					batchDelete : function() {
						...
						Ext.MessageBox.confirm("Confirm", _774,
								this.batchDeleteConfirm.createDelegate(this));
					},
					batchDeleteConfirm : function(_775) {
						if (_775 == "yes") {
							documentManager.deactivateDocumentBatch(
									this.filter, this.batchDeleteCallback
											.createDelegate(this));
						}
					},
								...
								if (meta.control) {
									if (meta.dataType == Date
										...
										if (meta.dataType == "Lookup") {
											...
											if (meta.dataType == "boolean") {
												_779 = meta.control.checked ? "true"
														: "false";
											} else {
												_779 = meta.control.value;
											}
					...
					onRender : function(ct, _784) {
						ct = Ext.get(ct);
						this.el = ct.createChild(this.autoCreate | {
							tag :"div",
							id :this.id || Ext.id()
						});
						var buf = [
								...
								"</div>",
								"<span class=\"j-batch-update-section-header\">Select fields to update:</span>",
								"<div></div>",
								"<div class=\"formErrorMessage\" style=\"display:none;\"></div>",
								"<div style=\"padding-bottom: 5px;\">",
								"<input type=\"checkbox\" style=\"padding-left: 5px;\"/>",
								"<span class=\"j-batch-update-section-header\">Version items in this update?</span>",
								"</div>", "<div></div>", "<div></div>" ];
						Ext.DomHelper.append(this.el, buf.join(""));
						var _786 = this.el.dom.childNodes[2];
						this.messagesDiv = this.el.dom.childNodes[3];
						this.checkboxNode = Ext
								.get(this.el.dom.childNodes[4].firstChild);
						this.versionFormNode = Ext
								.get(this.el.dom.childNodes[5]);
						this.versionFormNode
								.setVisibilityMode(Ext.Element.DISPLAY);
						this.versionFormNode.hide();
						this.checkboxNode.on("click", this.toggleVersionForm,
								this);
					...
					render : function() {
						jx.form.BatchUpdateForm.superclass.render.apply(this,
								arguments);
					...
					destroy : function() {
						...
						jx.form.BatchUpdateForm.superclass.destroy.apply(this,
								arguments);
					}
				});
...
Ext
		.extend(
				...
				jx.form.JamaBasicForm,
				{
					...
					showDetails :false,
					createHeader : function() {
						var _788 = Ext.DomHelper.insertFirst(this.table, {
							tag :"thead"
						});
						var row = document.createElement("tr");
					...
					createRow : function(meta, item) {
						var _78d = this.tbody;
						var val = this.getFieldFunc(item, meta);
						var row = Ext.DomHelper.append(_78d, {
							tag :"tr"
						});
						if (meta.dataType == "text") {
							meta.dataType = String;
					...
					getUpdatedItem : function() {
						...
						for ( var i = 0; i < this.fields.length; i++) {
							...
							if (meta.control) {
								if (meta.dataType == Date
									...
									if (meta.dataType == "Lookup") {
										...
										if (meta.dataType == "boolean") {
											_79d = meta.control.checked ? "true"
													: "false";
										} else {
											if (meta.dataType == "text") {
												if (meta.control.controlType == "fck") {
													var _79f = FCKeditorAPI
															.GetInstance(meta.control.instanceName);
													_79d = _79f.GetXHTML();
												} else {
							...
							item += "<field>";
							item += "<name>" + this.normalizeXML(meta.field)
									+ "</name>";
							item += "<default>" + this.normalizeXML(_79d)
									+ "</default>";
							item += "<style>" + this.normalizeXML(_79e)
									+ "</style>";
							item += "</field>\n";
						}
						item += "</fieldMapping>";
...
Ext.extend(jx.form.NotificationScheduleForm, Ext.form.FormPanel, {
	...
	initComponent : function() {
		...
		jx.form.NotificationScheduleForm.superclass.initComponent.apply(this,
				arguments);
	},
	render : function() {
		var that = this;
		notificationSvc.getJobScheduleByGroup("generate", {
			callback : function(list) {
				that.scheduleList = list;
			},
			async :false
		});
		notificationSvc.getUsersJobSchedule( {
			callback : function(job) {
				that.jobValue = (job) ? job : {
					id :"0"
				};
			},
			async :false
		...
		this.add( {
			xtype :"radio",
			fieldLabel :i18n.g("j.l.off"),
			name :"schedNotifyRadio",
			inputValue :"0",
			checked :_7a5,
			listeners : {
				check : {
		...
		for ( var i = 0; i < that.scheduleList.length; i++) {
			var _7a7 = (that.jobValue.id == that.scheduleList[i].id) ? true
					: false;
			this.add( {
				xtype :"radio",
				fieldLabel :that.scheduleList[i].jobName,
				name :"schedNotifyRadio",
				inputValue :that.scheduleList[i].id,
				checked :_7a7
			});
		}
		jx.form.NotificationScheduleForm.superclass.render.apply(this,
				arguments);
	},
	onCheck : function(_7a8, _7a9) {
		if (this.currentScheduleId != _7a8.getGroupValue()) {
			notificationSvc.saveUsersJobSchedule(_7a8.getGroupValue(), {
				callback :this.doOnSaveSuccess.createDelegate(this),
				async :false
			});
	...
	doOnSaveSuccess : function() {
		this.getAppContext().showMessage("Success",
				i18n.g("j.l.emailScheduleChange"));
	}
});
...
Ext.extend(jx.form.ChangePasswordForm, Ext.form.FormPanel, {
	render : function() {
	...
	updatePassword : function() {
		...
		if (this.validatePassword(_7ab)) {
			...
			user.updateUserPassword(_7ab, this.onSuccessSavePassword
					.createDelegate(this));
		} else {
			this.getAppContext().showMessage("Failure",
					i18n.g("j.m.passwordFailed"), this);
		}
	},
...
jx.form.LdapPropertyForm = function(_7ae) {
	...
	_7ae = Ext.applyIf(_7ae, {
		...
		items : [ {
			xtype :"checkbox",
			fieldLabel :"Enable LDAP",
			name :"enableLdap"
		}, {
			xtype :"checkbox",
			fieldLabel :"Enable Self Registration",
			name :"enableSelfReg"
		}, {
			xtype :"combo",
			hiddenName :"defaultOrgId",
			fieldLabel :"Default Organization for Self-registered User",
			store :this.orgStore,
			displayField :"name",
			valueField :"id",
			mode :"local",
			...
			anchor :"100%",
			listeners : {
				select :this.onChangeOrganization,
				scope :this
			}
		}, {
			xtype :"combo",
			hiddenName :"defaultRoleId",
			fieldLabel :"Default User Group for Self-registered User",
			store :this.roleStore,
			displayField :"name",
			valueField :"id",
			mode :"local",
			triggerAction :"all",
			emptyText :"Select an user group...",
			selectOnFocus :true,
			editable :false,
			anchor :"100%",
			allowBlank :true,
...
Ext.extend(jx.form.LdapPropertyForm, Ext.form.FormPanel, {
	render : function() {
		...
		if (_7b1.defaultOrgId) {
			this.roleStore.load( {
				arg : [ _7b1.defaultOrgId ]
			});
		}
	},
	setOrgValue : function() {
		this.getForm().findField("defaultOrgId").setValue(
				this.props.defaultOrgId);
	},
	setRoleValue : function() {
		this.getForm().findField("defaultRoleId").setValue(
				this.props.defaultRoleId);
	},
	onSave : function() {
		var _7b2 = this.getForm().getObjectValues();
		propertySvc.saveLdapProperties(_7b2, this.onSaveCallback
				.createDelegate(this));
	},
	onSaveCallback : function(item) {
		this.getAppContext()
				.showMessage("Success", "LDAP propeties are saved.");
...
Ext.extend(jx.tree.DWRTreeLoader, Ext.tree.TreeLoader, {
	load : function(node, _7b8) {
		if (this.clearOnLoad) {
	...
	requestData : function(node, _7bc) {
		if (this.fireEvent("beforeload", this, node, _7bc) !== false) {
			var _7bd = new Array();
			var _7be = this.handleResponse.createDelegate(this, [ node, _7bc ],
					1);
			var _7bf = this.handleFailure.createDelegate(this, [ node, _7bc ],
					1);
			_7bd.push(node.id);
			if (this.dwrArgs) {
...
jx.tree.ItemTree = function(_7cb) {
	_7cb = Ext.applyIf(_7cb, {
		...
		root :new Ext.tree.AsyncTreeNode( {
			iconCls :"j-project-icon",
			text :"No project selected",
			id :"p-0"
		})
	});
	Ext.apply(this, _7cb);
	this.loader = new jx.tree.DWRTreeLoader( {
		dwrCall :documentManager.getExtTreeNodes,
		dwrArgs : [ this.folderOnly, this.projectId ]
	});
	jx.tree.ItemTree.superclass.constructor.call(this, _7cb);
};
Ext.extend(jx.tree.ItemTree, Ext.tree.TreePanel, {
	folderOnly :false,
	projectId :null,
	loadProject : function(_7cc) {
		this.project = _7cc;
		if (this.enableDD) {
...
jx.tree.ProjectTree = function(_7dd) {
	_7dd = Ext.applyIf(_7dd, {
		folderOnly :true,
		animate :true,
		enableDD :this.getAppContext().getMask() != 0,
		containerScroll :true,
		rootVisible :true,
		ddGroup :"projectDD",
		root :new Ext.tree.AsyncTreeNode( {
			text :this.getAppContext().organization.name,
			draggable :false,
			expanded :true,
			iconCls :"j-organization-icon",
			id :"o-" + this.getAppContext().organization.id
		})
	});
	Ext.apply(this, _7dd);
	this.loader = new jx.tree.DWRTreeLoader( {
		dwrCall :project.getProjectsTree,
		dwrArgs : []
	}), jx.tree.ProjectTree.superclass.constructor.call(this, _7dd);
};
Ext.extend(jx.tree.ProjectTree, Ext.tree.TreePanel, {
...
Ext.extend(jx.panel.AdminPanel, Ext.TabPanel, {
	initComponent : function() {
		Ext.apply(this, {
			defaults : {
				bodyStyle :"padding:10px"
			...
			activeTab :0,
			items : [ {
				xtype :"jx.panel.OrgListPanel",
				id :this.getId() + "-orgList",
				title :i18n.g("j.t.rootOrganizationList")
			}, {
				xtype :"jx.panel.SystemPropertyPanel",
				id :this.getId() + "-property",
				title :i18n.g("j.t.rootSystemProperties")
			}, {
				xtype :"jx.panel.AdminUserListPanel",
				id :this.getId() + "-user",
				title :i18n.g("j.t.rootUsers")
			}, {
				xtype :"jx.panel.AdminLookupListPanel",
				id :this.getId() + "-lookupList",
				title :i18n.g("j.t.rootPickLists")
			}, {
				xtype :"jx.panel.AdminReportPanel",
				id :this.getId() + "-tab-lookupList",
				title :i18n.g("j.t.rootReports")
			}, {
				xtype :"jx.panel.AdminLicensePanel",
				id :this.getId() + "-license",
				title :i18n.g("j.t.rootLicenseManagement")
			}, {
				xtype :"jx.panel.DataBackupPanel",
				id :this.getId() + "-backup",
				title :i18n.g("j.t.rootBackup")
			} ]
		});
...
Ext.extend(jx.panel.AdminHeader, Ext.Panel, {
	data :null,
	initComponent : function() {
		this.data = new jx.ItemData( {
			project :new jx.Project( {
				id :0
			}),
			org :this.getAppContext().getOrganization()
		});
		Ext.apply(this, {
			autoScroll :true,
			id :"o-admin-header-panel",
			layoutConfig : {
				columns :2
			},
			defaults : {
			...
			items : [
					{
						id :"logoContainer",
						html :String.format("<img src=\"{0}\" id=\"o-logo\"/>",
								i18n.g("jama.headerLogo",
										"img/jama_contour_reflection.jpg"))
					}, {
						xtype :"jx.panel.AdminLogoutPanel",
						data :this.data,
						border :false,
						height :20,
						width :350
...
Ext.extend(jx.panel.OrgListPanel, Ext.Panel, {
	initComponent : function() {
		Ext.apply(this, {
			autoScroll :false,
			layout :"fit",
			items : [ {
				id :this.getId() + "-orgGrid",
				xtype :"jx.grid.OrganizationGrid",
				autoScroll :true,
				listeners : {
					render :this.onGridRender.createDelegate(this)
				}
			} ]
		});
...
Ext.extend(jx.panel.AdminLookupListPanel, Ext.Panel, {
	initComponent : function() {
		Ext.apply(this, {
			layout :"fit",
			items : [ {
				xtype :"jx.grid.LookupGrid",
				scope :1,
				refId :0,
				loadType :true,
				listeners : {
...
jx.panel.AdminLicensePanel = function(_7e5) {
	...
	_7e5 = Ext.applyIf(_7e5, {
		listTitle :"License",
		autoScroll :true,
		tbar : [],
		items : [ {
			items :this.licenseForm
		}, this.updateForm ]
	});
	jx.panel.AdminLicensePanel.superclass.constructor.call(this, _7e5);
};
Ext.extend(jx.panel.AdminLicensePanel, Ext.Panel, {
	loadOrg :true,
	orgId :null,
	loadLicense : function(_7e6) {
		licenseSvc.getSystemLicense(_7e6, {
			callback :this.loadLicenseCallback.createDelegate(this)
		});
	},
	...
	saveLicense : function() {
		...
		if (data) {
			licenseSvc.saveSystemLicense(data, this.orgId, {
				callback :this.saveLicenseDataCallback.createDelegate(this)
			});
		}
	},
	...
	createCombo : function() {
		this.orgStore = jx.data.StoreFactory.buildOrganizationStore(true);
		var _7ea = new Ext.form.ComboBox( {
			store :this.orgStore,
			displayField :"name",
			valueField :"id",
			mode :"local",
	...
	createUpdateForm : function() {
		return new Ext.form.FormPanel( {
			...
			items : [ {
				xtype :"textarea",
				fieldLabel :"Paste License Text Here",
				name :"licenseData",
				allowBlank :true,
				height :120,
				anchor :"100%"
...
jx.panel.AdminReportPanel = function(_7ee) {
	_7ee = Ext.applyIf(_7ee, {
		layout :"fit",
		items : [ {
			xtype :"jx.grid.ReportGrid"
		} ]
	});
...
jx.panel.AdminUserListPanel = function(_7ef) {
	_7ef = Ext.applyIf(_7ef, {
		layout :"card",
		activeItem :0,
		items : [ {
			xtype :"jx.grid.UserGrid",
			listeners : {
				title :"User List",
				render :this.onGridRender,
				addLdapUser :this.addLdapUser,
				scope :this
			},
			useLdap :this.getAppContext().getUseLdap(),
			loadOrg :true
		}, {
			title :"LDAP User Lookup",
			xtype :"jx.grid.LdapUserGrid",
			listeners : {
				backToUserList :this.showUserList,
				afterSave :this.afterSaveUser,
				scope :this
			}
		} ]
	});
	this.getAppContext().on("ldapPropertiesChange", this.changeLdapProperties,
			this);
	jx.panel.AdminUserListPanel.superclass.constructor.call(this, _7ef);
};
Ext.extend(jx.panel.AdminUserListPanel, Ext.Panel, {
	initComponent : function() {
	...
	_7f4 = Ext
			.applyIf(
					_7f4,
					{
						autoScroll :true,
						items : [ {
							html :"<div style=\"padding: 10px;\"><span class=\"sectionHeader\">Data Backup"
									+ "</span><br/><table class=noBorderTable\"><tr><td id=\"dbBackup_errorZone\" colspan=\"2\">"
									+ "</td></tr><tr><td><span class=\"sectionHeader\">Option 1:</span> Download the Backup "
									+ "XML File</td></tr><tr><td colspan=\"2\"><input type=\"button\" class=\"button\" id=\"dbBackup_download\" "
									+ "value=\"Download\" /></td></tr><tr><td>&nbsp;</td></tr><tr><td><span class=\"sectionHeader\">Option 2:"
									+ "</span> Save the Backup File to Server</td></tr><tr><td>Specify a server file name with full path:</td>"
									+ "<tr><td><input type=\"text\" id=\"dbBackup_file\" name=\"dbBackup_file\" size=\"50\" /></td></tr><tr><td><input "
									+ "type=\"button\" class=\"button\" id=\"dbBackup_saveFile\" value=\"Save to Server\" /></td></tr></table></div><div>"
									+ "<br/><br/><span class=\"sectionHeader\">Download DTD</span><br/><a id=\"dbBackup_dtd\" href=\"javascript:void(0)\">"
									+ "Download DTD for backup file</a></div>"
						} ]
					});
...
Ext
		.extend(
				jx.panel.DataBackupPanel,
				Ext.Panel,
				{
					initComponent : function() {
						jx.panel.DataBackupPanel.superclass.initComponent
								.call(this);
					},
					render : function() {
						jx.panel.DataBackupPanel.superclass.render.apply(this,
								arguments);
						this.doLayout();
						Ext.get("dbBackup_download").on("click", this.download,
								this);
						Ext.get("dbBackup_saveFile").on("click", this.saveFile,
								this);
						Ext.get("dbBackup_dtd").on("click", this.exportDtd,
								this);
					},
					download : function() {
						if (confirm("Are you sure you want to backup the whole database?")) {
							var _7f5 = window
									.open(
											"backup.req",
											"_blank",
											"height=800,width=1000,status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=yes,resizable=1");
							if (_7f5) {
								_7f5.focus();
							}
						}
	...
	_7f9 = Ext.applyIf(_7f9, {
		...
		items :new Ext.TabPanel( {
			...
			items : [ {
				...
				items : {
					xtype :"jx.form.SystemPropertyForm"
				}
			}, {
				title :"LDAP Properties",
				items : [ {
					title :"LDAP Properties",
					xtype :"jx.form.LdapPropertyForm"
				}, {
					title :"LDAP Providers",
					xtype :"jx.grid.LdapConfigGrid"
				} ],
				listeners : {
					activate : function(_7fa) {
						_7fa.doLayout();
					},
					scope :this
				}
...
Ext.extend(jx.panel.SystemPropertyPanel, Ext.Panel, {
	initComponent : function() {
...
jx.form.SystemPropertyForm = function(_7fb) {
	Ext.applyIf(_7fb, {
		labelWidth :"40%",
		fieldDefinitions : [ {
			field :"jama.system.smtp.host",
			label :"SMTP Host",
			dataType :"string"
		}, {
			field :"jama.system.smtp.port",
			label :"SMTP Port",
			dataType :"string"
		}, {
			field :"jama.system.smtp.user",
			label :"SMTP User",
			dataType :"string"
		}, {
			field :"jama.system.smtp.password",
			label :"SMPT Password",
			dataType :"string",
			inputType :"password"
		}, {
			field :"jama.system.smtp.auth",
			label :"Authorization Required",
			dataType :"boolean"
		}, {
			field :"jama.system.format.datetime",
			label :"Javascript Date Time Format",
			dataType :"string"
		}, {
			field :"jama.system.format.java.datetime",
			label :"Java Date Time Format",
			dataType :"string"
		}, {
			field :"jama.system.format.dayMonthYear",
			label :"Javascript Day/Month/Year Format",
			dataType :"string"
		}, {
			field :"jama.system.format.java.dayMonthYear",
			label :"Java Day/Month/Year Format",
			dataType :"string"
		} ],
		title :"",
		buttonPanelLocation :"bottom",
		buttonPanelAlign :"left",
		labelClass :"propertyLabel",
		titlePanelClass :"textLabel",
		dwrLoadCall :propertySvc.getSystemPropertyList,
		dwrSaveCall :propertySvc.saveSystemPropertyList,
		dwrArgs : [ 0 ]
	});
	jx.form.SystemPropertyForm.superclass.constructor.call(this, _7fb);
};
Ext.extend(jx.form.SystemPropertyForm, jx.form.DwrJamaForm, {
	getField : function(obj, meta) {
		var o = obj.properties;
		if (o) {
			o = obj.properties[meta.field];
...
Ext.extend(jx.panel.ProjectAdminPanel, Ext.TabPanel, {
	initComponent : function() {
		Ext.apply(this, {
			defaults : {
				bodyStyle :"padding:10px",
			...
			items : [ {
				xtype :"jx.panel.ProjectPropertyPanel",
				id :this.getId() + "-property",
				title :"Settings"
			}, {
				xtype :"jx.panel.ReleaseListPanel",
				id :this.getId() + "-release",
				title :"Release List",
				autoScroll :true
			}, {
				xtype :"jx.panel.ProjectLookupListPanel",
				id :this.getId() + "-lookup",
				title :"Pick Lists"
			}, {
				xtype :"jx.panel.EmailGroupListPanel",
				id :this.getId() + "-email-group",
				title :"Email Groups"
			}, {
				xtype :"jx.panel.ProjectPermissionListPanel",
				id :this.getId() + "-permission",
				title :"Project Permissions"
			}, {
				xtype :"jx.panel.BaselineListPanel",
				id :this.getId() + "-baseline",
				title :"Baselines"
			} ]
		});
...
jx.panel.BaselineListPanel = function(_805) {
	_805 = Ext.applyIf(_805, {
		layout :"fit",
		items : [ {
			xtype :"jx.grid.BaselineGrid",
			autoScroll :true,
			data :_805.data
		} ]
	});
...
Ext.extend(jx.panel.DataImportPanel, Ext.Panel, {
	initComponent : function() {
		Ext.apply(this, {});
...
jx.panel.EmailGroupListPanel = function(_807) {
	_807 = Ext.applyIf(_807, {
		layout :"fit",
		items : [ {
			xtype :"jx.grid.EmailGroupGrid",
			autoScroll :true,
			data :_807.data,
			listeners : {
				render :this.onGridRender.createDelegate(this)
...
Ext.extend(jx.panel.EmailGroupListPanel, Ext.Panel, {
	onGridRender : function(grid) {
		grid.loadList();
...
Ext.extend(jx.panel.ProjectDetailPanel, Ext.Panel, {
	initComponent : function() {
		Ext.apply(this, {});
...
Ext.extend(jx.panel.ProjectLookupListPanel, Ext.Panel, {
	initComponent : function() {
		Ext.apply(this, {
			layout :"fit",
			items : [ {
...
jx.panel.ProjectPermissionListPanel = function(_80c) {
	_80c = Ext.applyIf(_80c, {
		layout :"fit",
		items : [ {
			xtype :"jx.grid.PermissionGrid",
			autoScroll :true,
			listeners : {
				render :this.onGridRender.createDelegate(this)
			},
...
Ext.extend(jx.panel.ProjectPermissionListPanel, Ext.Panel,
		{
			initComponent : function() {
				jx.panel.ProjectPermissionListPanel.superclass.initComponent
						.call(this);
			},
			afterRender : function() {
				jx.panel.ProjectPermissionListPanel.superclass.afterRender
						.call(this);
			},
			onGridRender : function(grid) {
			}
		});
Ext.reg("jx.panel.ProjectPermissionListPanel",
		jx.panel.ProjectPermissionListPanel);
jx.panel.ProjectPropertyPanel = function(_80e) {
	_80e = Ext.applyIf(_80e, {
		labelWidth :75,
		autoScroll :true,
		bodyStyle :"padding:5px 5px 0",
		width :350,
		...
		items : [ {
			xtype :"jx.form.ProjectPropertyForm",
			data :_80e.data
		} ]
	});
...
jx.panel.ReleaseListPanel = function(_80f) {
	_80f = Ext.applyIf(_80f, {
		layout :"fit",
		items : [ {
			xtype :"jx.grid.ReleaseGrid",
			autoScroll :true,
			data :_80f.data,
			listeners : {
				render :this.onGridRender.createDelegate(this)
...
Ext.extend(jx.panel.ReleaseListPanel, Ext.Panel, {
	initComponent : function() {
		Ext.apply(this, {});
...
jx.window.OrgAdminWindow = function(_811) {
	_811 = Ext.applyIf(_811, {
		...
		layout :"fit",
		items : {
			xtype :"jx.panel.OrgAdminPanel"
		}
	});
	jx.window.OrgAdminWindow.superclass.constructor.call(this, _811);
};
Ext.extend(jx.window.OrgAdminWindow, Ext.Window, {
	onEvent : function() {
	},
	beforeDestroy : function() {
		jx.window.OrgAdminWindow.superclass.beforeDestroy
				.apply(this, arguments);
	}
});
...
Ext.extend(jx.panel.OrgAdminPanel, Ext.TabPanel, {
	initComponent : function() {
		var org = this.getAppContext().getOrganization();
		Ext.apply(this, {
			defaults : {
			...
			items : [ {
				...
				xtype :"jx.panel.OrgUserListPanel",
				title :"Users",
				orgId :org.id,
				id :this.getId() + "-user"
			}, {
				xtype :"jx.panel.UserGroupListPanel",
				title :"User Groups",
				id :this.getId() + "-group"
			}, {
				xtype :"jx.panel.OrgPermissionPanel",
				title :"Project Permissions",
				id :this.getId() + "-perm"
			}, {
				xtype :"jx.panel.LookupTypePanel",
				title :"Pick Lists",
				id :this.getId() + "-pickup"
			}, {
				xtype :"jx.panel.ItemTypePanel",
				title :"Item Types",
...
jx.panel.LookupTypePanel = function(_814) {
	_814 = Ext.applyIf(_814, {
		layout :"border",
		items : [ {
			xtype :"jx.grid.LookupTypeGrid",
			autoScroll :true,
			region :"center",
			filter :_814.orgId,
			scope :2,
			listeners : {
				render :this.onGridRender.createDelegate(this),
				configItem :this.onConfig.createDelegate(this)
			},
			columnWidth :1
		}, {
			region :"east",
...
Ext.extend(jx.panel.LookupTypePanel, Ext.Panel, {
	initComponent : function() {
	...
	onConfig : function(item) {
		if (!this.eastGrid) {
			this.eastGrid = new jx.grid.LookupGrid( {
				autoScroll :true
			});
...
jx.panel.OrgDetailPanel = function(_818) {
	_818 = Ext.applyIf(_818, {
		autoScroll :true,
		bodyStyle :"padding:5px 5px 0",
		items : [ {
			xtype :"jx.form.OrganizationForm",
			org :this.getAppContext().getOrganization(),
			showButtons :true,
			listeners : {
...
Ext.extend(jx.panel.OrgDetailPanel, Ext.Panel, {
	onAfterSave : function(form, item) {
...
jx.panel.OrgLicensePanel = function(_81c) {
	_81c = Ext.applyIf(_81c, {
		...
		items : [ {
			xtype :"jx.form.LicenseForm"
		} ]
	});
	jx.panel.OrgLicensePanel.superclass.constructor.call(this, _81c);
};
Ext.extend(jx.panel.OrgLicensePanel, Ext.Panel, {
	initComponent : function() {
		Ext.apply(this, {});
...
Ext.extend(jx.panel.OrgPermissionPanel, Ext.Panel, {
	initComponent : function() {
...
Ext.extend(jx.panel.OrgUserListPanel, Ext.Panel, {
	initComponent : function() {
...
jx.panel.UserGroupListPanel = function(_821) {
	_821 = Ext.applyIf(_821, {
		layout :"fit",
		items : [ {
			xtype :"jx.grid.UserGroupGrid",
			listeners : {
				render :this.onGridRender.createDelegate(this)
			},
			filter :_821.orgId
...
Ext.extend(jx.panel.UserGroupListPanel, Ext.Panel, {
	initComponent : function() {
		Ext.apply(this, {});
...
jx.panel.ItemTypePanel = function(_823) {
	_823 = Ext.applyIf(_823, {
		layout :"border",
		items : [ {
			xtype :"jx.grid.ItemTypeGrid",
			region :"center",
			autoScroll :true,
			filter :_823.orgId,
			listeners : {
...
Ext.extend(jx.panel.ItemTypePanel, Ext.Panel, {
	orgId :null,
	initComponent : function() {
	...
	onConfig : function(item) {
		if (!this.eastGrid) {
			this.eastGrid = new jx.grid.ItemTypeFieldGrid( {
				autoScroll :true,
				orgId :this.orgId
			});
			this.items.itemAt(1).add(this.eastGrid);
...
jx.window.MyProfileWindow = function(_827) {
	_827 = Ext.applyIf(_827, {
		title :i18n.g("j.l.myProfileTitle"),
		width :800,
		height :600,
		modal :true,
		closable :true,
		...
		minimizable :false,
		buttons : [ {
			text :i18n.g("j.b.myProfileClose"),
			handler :this.onCancel,
			scope :this
		} ],
		layout :"fit",
		items : {
			xtype :"jx.panel.MyProfilePanel"
		}
	});
...
Ext.extend(jx.panel.MyProfilePanel, Ext.TabPanel, {
	initComponent : function() {
		Ext.apply(this, {
			defaults : {
				bodyStyle :"padding:10px"
			...
			enableTabScroll :true,
			items : [ {
				xtype :"jx.panel.ProfileDetailPanel",
				title :i18n.g("j.l.profileDetails"),
				id :this.getId() + "-detail"
			}, {
				xtype :"jx.panel.NotificationPanel",
				title :i18n.g("j.l.profileNotification"),
				id :this.getId() + "-notify"
			} ]
		});
...
Ext.extend(jx.panel.NotificationPanel, Ext.Panel, {
	initComponent : function() {
		Ext.apply(this, {
			defaults : {
				bodyStyle :"padding:10px"
			...
			layout :"border",
			items : [ {
				xtype :"jx.form.NotificationScheduleForm",
				region :"north",
				height :100
			}, {
				xtype :"jx.grid.SubscriptionNotificationGrid",
				region :"center",
				autoScroll :true,
				listeners : {
					render :this.onGridRender.createDelegate(this)
...
Ext.extend(jx.panel.ProfileDetailPanel, Ext.Panel, {
	userForm :null,
	passwordForm :null,
	initComponent : function() {
		Ext.apply(this, {
	...
	createUserForm : function() {
		this.userForm = new jx.form.UserForm( {
			orgId :0,
			showButtons :false,
			formType :"both",
			showTitle :false,
	...
	getTbar : function() {
		return [ "->", {
			text :i18n.g("j.b.resetPassword"),
			iconCls :"j-profile-password-change-icon",
			handler :this.showChangePasswordTab,
			scope :this
		}, "-", {
			text :i18n.g("j.b.editProfile"),
			iconCls :"j-profile-edit-icon",
			handler :this.editProfile,
			scope :this
		}, "-", {
			text :i18n.g("j.b.editProfileSave"),
			iconCls :"j-save-icon",
			handler :this.saveProfile,
			scope :this
		}, "-", {
			text :i18n.g("j.b.editPasswordSave"),
			iconCls :"j-save-icon",
			handler :this.savePassword,
			scope :this
		}, "-", {
			text :i18n.g("j.b.editProfileCancel"),
			iconCls :"j-cancel-icon",
...
jx.grid.SubscriptionNotificationGrid = function(_82f) {
	jx.grid.SubscriptionNotificationGrid.superclass.constructor
			.call(this, _82f);
};
Ext
		.extend(
				jx.grid.SubscriptionNotificationGrid,
				jx.grid.SimpleGridDetail,
				{
					initComponent : function() {
						Ext.apply(this,
								{
									addItemLabel :"",
									listTitle :"",
									deleteItemLabel :i18n
											.g("j.b.myProfileDeleteItems"),
									singleSelect :false,
									fieldDefinitions :this.getListDefinitions()
								});
						this.dataStore = jx.data.StoreFactory
								.buildSubscriptionNotificationStore();
						jx.grid.SubscriptionNotificationGrid.superclass.initComponent
								.call(this);
					},
					getListDefinitions : function() {
						return ( [
								{
									field :"projectName",
									label :i18n.g("j.l.myProfileProject"),
									width :"20%"
								},
								{
									field :"notificationName",
									label :i18n.g("j.l.myProfileNotifications"),
									width :"50%",
									renderer : function(_830, _831, _832) {
										switch (_832.data.scope) {
										case 3:
											return "<img src=\"img/silk/brick.png\"/>&nbsp; All items located in project: "
													+ _830;
											break;
										case 4:
											return "<img src=\"img/tree/"
													+ _832.data.notificationImage
													+ "\"/>&nbsp; All items located in set: "
													+ _830;
											break;
										case 5:
											return "<img src=\"img/silk/page_white_text.png\"/>&nbsp;"
													+ _830 + " - (Item)";
											break;
										default:
											return _830;
									...
									columnOnly :true,
									dataType :"action",
									label :i18n.g("j.l.myProfileSelect"),
									sortable :false,
									actions : [ {
										name :"checkbox",
					...
					onRenderOther : function() {
						...
						tb.addFill();
						tb.addButton( {
							tooltip :this.deleteItemLabel,
							text :this.deleteItemLabel,
							iconCls :"j-profile-subscription-delete-icon",
							cls :"x-btn-text-icon",
...
Ext.reg("jx.grid.SubscriptionNotificationGrid",
		jx.grid.SubscriptionNotificationGrid);
jx.window.HelpWindow = function(_838) {
	_838 = Ext.applyIf(_838, {
		title :i18n.g("j.l.helpTitle"),
		height :600,
		width :800,
		modal :true,
		closable :true,
		...
		minimizable :false,
		buttons : [ {
			text :i18n.g("j.b.helpClose"),
			handler :this.onCancel,
			scope :this
		} ],
		layout :"fit",
		items : {
			xtype :"jx.panel.HelpPanel"
		}
	});
...
Ext.extend(jx.panel.HelpPanel, Ext.TabPanel, {
	initComponent : function() {
		Ext.apply(this, {
			defaults : {
				bodyStyle :"padding:10px"
			...
			items : [
					{
						title :i18n.g("j.t.helpHome"),
						id :this.getId() + "-home",
						html :"<div class=\"j-login-welcome\">"
								+ i18n.g("j.l.helpWelcomeText") + "</div><div>"
								+ i18n.g("j.l.helpWelcomeTextDetail")
								+ "<br><br>" + i18n.g("j.l.helpUserGuideLink")
								+ "</div>"
					}, {
						title :i18n.g("j.t.helpBackstage"),
						id :this.getId() + "-backstage",
						contentEl :this.createBackstageFrame()
					}, {
						title :i18n.g("j.t.helpJamaSupportTicket"),
						id :this.getId() + "-ticket",
						contentEl :this.createTicketFrame()
					} ]
		});
				...
				Ext.Panel,
				{
					initComponent : function() {
						Ext.apply(this, {
							...
							border :false,
							items : [ {
								xtype :"jx.panel.ProjectWestPanel",
								region :"west",
								width :300,
								split :true,
								...
								xtype :"jx.panel.OrgCenterPanel",
								region :"center",
								id :"o-panel-center"
							}, {
								xtype :"jx.panel.RelateTreePanel",
								region :"east",
								width :300,
								split :true,
								collapsed :true,
								...
								listeners : {
									relateItemToItem : {
										fn :this.relateItemToItem,
										scope :this
									}
								}
							} ]
						});
						this.getAppContext().on("showRelationshipTree",
								this.onShowRelationshipTree, this);
						jx.panel.OrganizationPanel.superclass.initComponent
								.call(this);
					},
					...
					relateItemToItem : function(_4, _5) {
						...
						if (_8.getXType() == "jx.panel.ItemPanel") {
							...
							this
									.getAppContext()
									.showMessage("Info",
											"Unable create a relationship because an Item is not active.");
						}
					}
				});
...
Ext.extend(jx.panel.ProjectHeaderPanel, Ext.Panel, {
	data :null,
	initComponent : function() {
		this.data = new jx.ItemData( {
			project :new jx.Project( {
			...
			items : [
					{
						id :"logoContainer",
						html :String.format(
								"<img src=\"{0}\" style=\"\" id=\"o-logo\"/>",
								i18n.g("jama.headerLogo",
										"img/jama_contour_reflection.jpg"))
					}, {
						xtype :"jx.panel.LogoutPanel",
						data :this.data,
						border :false,
						height :20,
						width :100
...
Ext
		.extend(
				...
				Ext.Panel,
				{
					...
					refresh : function() {
						this.toggleButtons();
						this.notifyButton.setChecked(
								this.data.project.notification, true);
					...
					render : function() {
						jx.panel.ProjectPanel.superclass.render.apply(this,
								arguments);
						this.toggleButtons();
					},
					...
					initComponent : function() {
						...
						Ext
								.apply(
										this,
										{
											...
											items : [
													{
														xtype :"jx.panel.ProjectFormPanel",
														data :this.data,
														collapsed :false,
														region :"center",
														autoScroll :true
													},
													{
														...
														border :false,
														margins :"0 0 0 0",
														id :this.propertySouthId,
														items : {
															xtype :"panel",
															layout :"card",
															id :this.cardPanelId,
															activeItem :this.data.project.isFolder ? 1
																	: 0,
															items : [
																	this
																			.getTabPanel(),
						...
						this.getAppContext().on("afterSaveProject",
								this.reconfigData, this);
						jx.panel.ProjectPanel.superclass.initComponent
								.call(this);
					},
					reconfigData : function(_15) {
						...
						this.data.reconfig( {
							project :Ext.apply(this.data.project, _15)
						});
					...
					getTbar : function() {
						...
						this.notifyButton = new Ext.menu.CheckItem( {
							text :i18n.g("j.b.projectSubscribe"),
							boxLabel :i18n.g("j.b.projectSubscribe"),
							checked :this.data.project.notification,
							listeners : {
								checkchange : {
									fn :this.subscribeToProject,
									scope :this
								}
							},
							id :"project-" + this.data.project.id
									+ "-notification-button"
						});
						return [
								"->",
								{
									split :false,
									text :i18n.g("j.b.projectViewsMenu"),
									menu : {
										id :this.propertyMenuId,
										cls :"reading-menu",
										width :150,
										items : [
												{
													text :i18n
															.g("j.b.showMatrix"),
													iconCls :"j-project-matrix-icon",
													handler :this.showWindow
															.createDelegate(
																	this,
																	[
																			"jx.window.TraceMatrixWindow",
																			true ],
																	0),
													id :"p-matrix-button",
													scope :this
												},
												{
													text :i18n
															.g("j.b.showSuspect"),
													iconCls :"j-project-suspect-icon",
													handler :this.showWindow
															.createDelegate(
																	this,
																	[
																			"jx.window.SuspectWindow",
																			true ],
																	0),
													id :"p-suspect-button",
													scope :this
												...
												"-",
												{
													...
													tooltip :i18n
															.g("j.tt.projectView"),
													iconCls :"j-item-details-display-bottom",
													handler :this.moveProperty
															.createDelegate(
																	this, []),
													id :this.propertyButtonId,
													menu : {
														cls :"reading-menu",
														width :100,
														items : [
																{
																	id :this.bottomMenuItemId,
																	text :i18n
																			.g("j.l.projectViewBottom"),
																	checked :true,
																	group :_16,
																	checkHandler :this.moveProperty,
																	scope :this,
																	iconCls :"preview-bottom"
																},
																{
																	text :i18n
																			.g("j.l.projectViewRight"),
																	id :this.rightMenuItemId,
																	checked :false,
																	group :_16,
																	checkHandler :this.moveProperty,
																	scope :this,
																...
																{
																	text :i18n
																			.g("j.l.projectViewHidden"),
																	id :this.hideMenuItemId,
																	checked :false,
																	group :_16,
																	checkHandler :this.moveProperty,
																	scope :this,
									...
									menu :new Ext.menu.Menu(
											{
												...
												items : [
														...
														"-",
														{
															text :i18n
																	.g("j.b.projectFindMe"),
															iconCls :"j-find-me-icon",
															handler :this.onFindMe,
															id :"p-findme-button",
															scope :this
														},
																		...
																		items : [
																				{
																					...
																					tooltip :i18n
																							.g("j.tt.setImportCSV"),
																					iconCls :"j-project-import-csv-icon",
																					handler :this.showWindow
																							.createDelegate(
																									this,
																									[
																											"jx.window.CsvImportWindow",
																											true ],
																									0),
																					id :"p-cvsimport-button",
																					scope :this
																				},
																				{
																					text :i18n
																							.g("j.b.setImportWord"),
																					tooltip :i18n
																							.g("j.tt.setImportWord"),
																					iconCls :"j-project-import-word-icon",
																					handler :this.showWindow
																							.createDelegate(
																									this,
																									[
																											"jx.window.WordImportWindow",
																											true ],
																									0),
																					id :"p-wordimport-button",
																					scope :this
																				} ]
																	})
														} ]
										...
										items : [
												{
													text :i18n
															.g("j.b.projectEdit"),
													iconCls :"j-project-edit-icon",
													handler :this.showWindow
															.createDelegate(
																	this,
																	[
																			"jx.window.ProjectFormWindow",
																			true ],
																	0),
													id :"p-edit-button",
													scope :this,
												...
												new Ext.menu.Separator(
														{
															mask :jx.AclPermission.ADMINISTRATION
														}),
												{
													text :i18n
															.g("j.b.copyProject"),
													iconCls :"j-project-copy-icon",
													handler :this.onCopyProject,
													id :"p-copy-button",
													scope :this,
													mask :_17
												},
												...
												"-",
												{
													text :i18n
															.g("j.b.projectSetup"),
													iconCls :"j-project-configure-icon",
													handler :this.showWindow
															.createDelegate(
																	this,
																	[
																			"jx.window.ProjectAdminWindow",
																			true ],
																	0),
													id :"p-configure-button",
													scope :this,
													mask :jx.AclPermission.ADMINISTRATION
												} ]
									}
					...
					moveProperty : function(m, _19) {
						...
						if (_19) {
							...
							case this.bottomMenuItemId:
								...
								btn
										.setIconClass("j-item-details-display-bottom");
								this.tabPanel.getActiveTab().refresh(true);
								break;
							case this.rightMenuItemId:
								...
								btn
										.setIconClass("j-item-details-display-right");
								this.tabPanel.getActiveTab().refresh(true);
								break;
					...
					getTabPanel : function() {
						this.tabPanel = new Ext.TabPanel( {
							...
							items : [ {
								xtype :"jx.panel.WhatsNewPanel",
								id :this.getId() + "-whatsnew-view"
							}, {
								title :"Attachments",
								xtype :"jx.grid.ProjectAttachmentGrid"
							} ]
						});
					...
					onCopyProject : function() {
						var w = new jx.window.ProjectCopyWindow( {
							project :this.data.project
						});
						w.show();
					},
					...
					subscribeToProject : function(_28, _29) {
						...
						if (_29) {
							subscriptionSvc.saveSubscription(sub,
									this.subCallback.createDelegate(this,
											[ "on" ]));
						} else {
							subscriptionSvc.deleteSubscription(sub,
									this.subCallback.createDelegate(this,
											[ "off" ]));
						}
					},
					subCallback : function(_2b) {
						this.getAppContext().showMessage(
								"Success",
								"Email notification has been turned " + _2b
										+ ".", this);
					},
					iconDisplayForNotification : function(_2c) {
					},
					getFolderTabPanel : function() {
						this.tabFolderPanel = new Ext.TabPanel( {
							activeItem :0,
							defaults : {
								data :this.data,
								autoScroll :true,
							...
							items : [ {
								...
								xtype :"jx.panel.ProjectGridPanel"
							} ]
						});
...
Ext.extend(jx.panel.ProjectGridPanel, jx.grid.ProjectGrid, {
	data :null,
	initComponent : function() {
		Ext.apply(this, {
			tbar : [ "->", {
				text :i18n.g("j.b.openProject"),
				tooltip :i18n.g("j.tt.openProject"),
				iconCls :"j-project-open-icon",
				handler :this.onOpenButtonClick,
				scope :this
			} ]
		});
		this.on( {
	...
	refresh : function(_2e) {
		...
		if (this.data.project && this.data.getProjectId() != null
				&& this.data.getProjectId() != 0) {
			_2f = {
				data : [ this.data.getProjectId() ]
			};
		}
	...
	rightClickEditProject : function(_37) {
		...
		var e = {
			...
			sourceEl :this,
			sourceType :"grid",
			xtype :"jx.window.ProjectFormWindow"
		};
	...
	showProject : function(_3d) {
		if (_3d) {
			this.getAppContext().fireEvent("loadProject", {
				sourceType :"grid",
				source :this,
				data : {
					project : {
...
Ext.extend(jx.panel.ProjectWestPanel, Ext.Panel, {
	project :null,
	initComponent : function() {
		Ext.apply(this, {
			bodyStyle :"padding:5px",
			layout :"border",
			title :this.getAppContext().organization.name,
			items : [ {
				region :"north",
				xtype :"jx.panel.ProjectTreePanel",
				listeners : {
					showItemTree : {
						fn :this.onShowItemTree,
						scope :this
					},
					findItem : {
						fn :this.findItem,
...
Ext
		.extend(
				...
				Ext.Panel,
				{
					...
					initComponent : function() {
						Ext.apply(this, {});
						jx.panel.ProjectFormPanel.superclass.initComponent
								.call(this);
					...
					afterLoadProject : function(_48) {
						var _49 = (_48.isFolder) ? i18n.g("j.l.projectFolder")
								: i18n.g("j.l.projectLabel");
						this.titleDiv.update("");
						this.getTpl().append(this.titleDiv, {
							leftText :_49,
							rightText :_48.name
						});
					},
					createWidget : function() {
						...
						var w = new jx.form.ProjectForm( {
							showButtons :false,
							showTitle :false,
							defaultDateFormat :_4a,
							listeners : {
								afterLoadProject :this.afterLoadProject,
								scope :this
							}
						});
						this.titleDiv = Ext.DomHelper.append(this.body, {
							tag :"div",
							html :""
						}, true);
						w.render(this.body);
					...
					render : function() {
						jx.panel.ProjectFormPanel.superclass.render.apply(this,
								arguments);
						this.data.on( {
					...
					getTpl : function() {
						...
						if (!w.tplCache) {
							w.tplCache = new Ext.XTemplate(
									"<table><tbody>",
									"<tr>",
									"<td nowrap align=\"right\" width=\"10%\"><div class=\"j-set-header-title-left\">{leftText}</div></td><td><div class=\"j-set-header-title-right\">{rightText}</div></td>",
									"</tr>", "</tbody></table>");
						}
						return w.tplCache;
					}
...
Ext
		.extend(
				...
				Ext.Panel,
				{
					...
					relateTypeDataStore :null,
					initComponent : function() {
						this.relateButtonId = this.myId("relateButton");
						Ext.apply(this, {
							tbar :this.getTbar(),
							layout :"border",
							title :i18n.g("j-l-relateTitle"),
							items : [ {
								region :"north",
								layout :"fit",
								id :"p-relate-project-tree-panel",
								split :true,
								height :150,
								autoScroll :true
							}, {
								region :"center",
								xtype :"tabpanel",
								id :"p-relate-item-tab-panel",
								active :0,
								items : [ {
									title :i18n.g("j.l.relateTreeTab"),
									layout :"fit",
									id :"p-relate-item-tree-panel"
								}, {
									title :i18n.g("j.l.relateGridTab"),
									layout :"fit",
									id :"p-relate-item-grid-panel"
								} ]
							} ]
						});
						this.on("show", this.addProjectTree, this);
						this.relateTypeDataStore = jx.data.StoreFactory
								.buildLookupByTypeCategoryStore();
						this.relateTypeDataStore.load( {
							arg : [ 1024, 2,
									this.getAppContext().organization.id ]
						});
						jx.panel.RelateTreePanel.superclass.initComponent
								.call(this);
					},
					myId : function(id) {
						return this.id + "-" + id;
					...
					render : function() {
						this.relateTypeDataStore.on("load",
								this.setInitDefaults, this);
						jx.panel.RelateTreePanel.superclass.render.apply(this,
								arguments);
					},
					setInitDefaults : function() {
						this
								.changeRelateDefaults( {
									direction :"forward",
									type :this.relateTypeDataStore.data.items[0].data.id
								});
					},
					getTbar : function() {
						return [ {
							text :i18n.g("j.b.relateDefaults"),
							iconCls :"j-relate-close-icon ",
							handler :this.showDefaultsDialog,
							scope :this
						}, "->", {
					...
					getItemTreeTbar : function() {
						return [ {
							id :this.relateButtonId,
							text :i18n.g("j-b-relateCreateRelationship"),
							tooltip :i18n.g("j-tt-relateCreateRelationship"),
							iconCls :"j-item-relate-create-icon",
							handler :this.onTreeRelateClick,
							disabled :true,
							scope :this
						}, {
							text :i18n.g("j-b-relatePreview"),
							tooltip :i18n.g("j-tt-relatePreview"),
							iconCls :"j-relate-preview-icon",
							handler :this.onTreePreviewClick,
							scope :this
						} ];
					},
					getItemSearchTbar : function() {
						return [ {
							...
							tooltip :i18n.g("j-tt-relateCreateRelationship"),
							iconCls :"j-item-relate-create-icon",
							handler :this.onGridRelateClick,
							scope :this
						}, {
							id :"p-relate-search-field",
							xtype :"textfield",
							name :"searchString",
							anchor :"100%",
							emptyText :i18n.g("j.b.search"),
							listeners : {
							...
							tooltip :i18n.g("j-tt-relatePreview"),
							iconCls :"j-relate-preview-icon",
							handler :this.onGridPreviewClick,
							scope :this
						} ];
					},
					onSpecialKey : function(_4f, _50) {
						if (_50.getKey() == Ext.EventObject.RETURN) {
							...
							this.searchGrid
									.loadSearchGrid(this.project.id, _51);
						}
					},
					closePanel : function() {
						this.hide();
					...
					addProjectTree : function(e) {
						if (!this.projectTree) {
							var _53 = this
									.findById("p-relate-project-tree-panel");
							var _54 = this.event.project;
							this.projectTree = _53.add(new jx.tree.ProjectTree(
									{
										enableDD :false,
										autoScroll :true,
										listeners : {
											"click" : {
												fn :this.onProjectTreeClick,
												scope :this
											}
										}
									}));
						...
						var _55 = this.event.project ? this.event.project
								: e.event.data.project;
						project.getPath(_55.id, this.reloadPath
								.createDelegate(this));
					...
					onProjectTreeClick : function(_58, e) {
						...
						case "p":
							if ((this.project == null)
									|| (id != this.project.id)) {
								project.getProjectDto(id, {
									callback :this.onSuccessLoadProject
											.createDelegate(this)
								});
							}
							break;
					...
					onSuccessLoadProject : function(_5c) {
									...
									.add(new jx.tree.ItemTree(
											{
												...
												listeners : {
													"dblclick" : {
														fn :this.onTreeRelateClick,
														scope :this
													},
													"click" : {
														fn :this.onTreeSingleClick,
														scope :this
													}
												},
												tbar :this.getItemTreeTbar()
											}));
							_5d.doLayout();
						}
						if (this.searchGrid == null) {
							this.searchGrid = _5f.add(new jx.grid.ItemGrid( {
								tbar :this.getItemSearchTbar(),
								pagingDisplayMsg :"",
								displayInfo :false,
								listeners : {
									rowdblclick : {
										fn :this.onGridRelateClick,
										scope :this
									}
								}
							}));
						...
						this
								.setTitle("<span style=\"color: #3F3F3F; font-size: 10pt; font-style: bold;\">"
										+ _5c.name + "</span>");
					},
					onGridRelateClick : function() {
						var _60 = this.getSelectedItemsFromGrid();
						this.fireEvent("relateItemToItem", _60,
								this.relateDefaults);
					},
					onGridPreviewClick : function(_61) {
						var _62 = this.getSelectedItemsFromGrid();
						if (_62.length != 1) {
							this.getAppContext().showMessage("Info",
									i18n.g("j.m.relatePreviewOnlyOneAllowed"));
						} else {
							var e = {
								data : {
								...
								source :this,
								sourceEl :_61.getEl(),
								xtype :"jx.window.ItemPreviewWindow",
								newWindow :false
							};
							this.getAppContext().fireEvent("showWindow", e);
						}
					...
					getSelectedItemsFromGrid : function() {
						var _64 = this.searchGrid.getSelectionModel()
								.getSelections();
						var _65 = [];
					...
					onTreeRelateClick : function() {
						...
						this.fireEvent("relateItemToItem", _67,
								this.relateDefaults);
					},
					...
					getSelectedItemsFromTree : function() {
						var _6d = this.itemTree.getSelectionModel()
								.getSelectedNodes();
						var _6e = [];
					...
					showDefaultsDialog : function() {
						if (!this.defaultDialog) {
							this.defaultDialog = new jx.window.RelateDefaultsWindow(
									{
										title :"Defaults",
										data :new jx.ItemData(
												{
													org : {
														id :this
																.getAppContext().organization.id
						...
						this.defaultDialog.alignTo(
								this.getTopToolbar().getEl(), "tl-bl",
								[ 0, 0 ], true);
					},
...
jx.window.RelateDefaultsWindow = function(_72) {
	_72 = Ext.applyIf(_72, {
		...
		buttons : [ {
			text :i18n.g("j.b.relateDefaultsSet"),
			handler :this.defaultsChanged,
			scope :this
		}, {
			text :i18n.g("j-b-relateClose"),
...
Ext
		.extend(
				jx.window.RelateDefaultsWindow,
				Ext.Window,
				{
					data :null,
					relationshipTypeStore :null,
					relationshipTypeCombo :null,
					relationshipDirectionF :null,
					createForm : function() {
						this.relationshipTypeStore = jx.data.StoreFactory
								.buildLookupByTypeCategoryStore();
						this.relationshipTypeCombo = new Ext.form.ComboBox( {
							fieldLabel :"Relationship Type",
							store :this.relationshipTypeStore,
							displayField :"name",
							valueField :"id",
							mode :"local",
							name :"relateDefaultType",
							triggerAction :"all",
							selectOnFocus :true,
							editable :false,
							forceSelection :true
						});
						this.relationshipDirectionF = new Ext.form.Radio( {
							boxLabel :"Forward",
							labelSeparator :"",
							checked :true,
							name :"relationshipDirection",
						...
						this.form = new Ext.form.FormPanel( {
							...
							bodyBorder :false,
							labelWidth :100,
							items : [ this.relationshipTypeCombo, {
								xtype :"fieldset",
								title :i18n.g("j.l.relateDirectionText"),
								labelWidth :10,
								layout :"form",
								items : [ this.relationshipDirectionF, _73 ]
							} ]
						});
						return this.form;
					},
					defaultsChanged : function() {
						...
						var _75 = {
							direction :_74.relationshipDirection,
							type :this.relationshipTypeCombo.value
						};
						this.fireEvent("changeRelateDefaults", _75);
						this.onClose();
					},
					refresh : function() {
						this.relationshipTypeStore.load( {
							arg : [ 1024, 2, this.data.getOrgId() ]
						});
					},
					setRelateTypeValue : function() {
						if (this.relationshipTypeStore.data.items.length > 0) {
							this.relationshipTypeCombo
									.setValue(this.relationshipTypeStore.data.items[0].data.name);
						}
					},
					onClose : function() {
						this.hide();
					...
					render : function() {
						this.relationshipTypeStore.on("load",
								this.setRelateTypeValue, this);
						jx.window.RelateDefaultsWindow.superclass.render.apply(
								this, arguments);
					}
				});
...
Ext
		.extend(
				jx.panel.ProjectCenterPanel,
				Ext.TabPanel,
				{
					project :null,
					mainProjectGrid :null,
					initComponent : function() {
						Ext.apply(this, {
							region :"center",
							resizeTabs :true,
						...
						jx.panel.ProjectCenterPanel.superclass.initComponent
								.call(this);
						this.getAppContext().on( {
							showItem :this.showItemPanel,
							editItem :this.editItem,
							deleteItem :this.deleteItem,
							showGroup :this.showGroupPanel,
							editGroup :this.editGroup,
							deleteGroup :this.deleteGroup,
							editFilter :this.editFilter,
							deleteFilter :this.deleteFilter,
							editRelease :this.editRelease,
							deleteRelease :this.deleteRelease,
							editTag :this.editTag,
							deleteTag :this.deleteTag,
							showGrid :this.showGridPanel,
							batchUpdate :this.batchUpdate,
							batchDelete :this.batchDelete,
							showWindow :this.showWindow,
							loadProjectGridTab :this.loadNewTab,
							showProject :this.showProjectPanel,
							showProjectGrid :this.showProjectGridPanel,
							deleteProject :this.deleteProject,
							afterProjectDelete :this.removeTab,
							scope :this
						});
					},
					...
					showProjectPanel : function(e) {
						...
						if (!(_7e = this.getItem(id))) {
							_7e = this.add(new jx.panel.ProjectPanel( {
								closable :true,
								id :id,
								data :new jx.ItemData( {
									project :_7d.project
					...
					showItemPanel : function(e) {
						...
						if (!(_82 = this.getItem(id))) {
							_82 = this.add(new jx.panel.ItemPanel( {
								closable :true,
								id :id,
								data :new jx.ItemData( {
									project :_81.project,
					...
					showGroupPanel : function(e) {
						...
						if (!(_87 = this.getItem(id))) {
							_87 = this.add(new jx.panel.GroupPanel( {
								closable :true,
								id :id,
								data :new jx.ItemData( {
									project :_85.project,
					...
					showGridPanel : function(e) {
						...
						_8a.item = jx.panel.ResultPanel.prototype
								.getDisplayAndIcon(_8a);
						if (!(_8b = this.getItem(id))) {
							_8b = this.add(new jx.panel.ResultPanel( {
								closable :true,
								id :id,
								data :new jx.ItemData( {
									project :_8a.project,
									item :_8a.item,
									itemType :_8a.itemType
								})
							}));
							this.add(_8b);
						} else {
					...
					showProjectGridPanel : function(e) {
						...
						if (!(_8f = this.getItem(id))) {
							_8f = this.add(new jx.panel.ProjectGridPanel( {
								title :i18n.g("j.l.projectGrid"),
								closable :true,
								id :id,
								data :new jx.ItemData( {
									project : {},
					...
					editGroup : function(e) {
						var w = new jx.window.GroupFormWindow( {
							listeners : {}
						});
						var _96 = e.data;
						w.show();
						w.loadGroup(_96.group, _96.project, this
								.getAppContext().getOrganization());
					},
					editFilter : function(e) {
						var _98 = e.data;
						var w = new jx.window.FilterFormWindow( {
							org :this.getAppContext().getOrganization()
						});
						w.show();
						w.loadFilter(_98.item, _98.project, this
								.getAppContext().getOrganization(), e);
					},
						...
						var _9c = String
								.format(
										"This will permanently remove \"{0}\" filter."
												...
												+ "<br>Are you sure you want to delete?",
										_9b.name);
						Ext.MessageBox.confirm("Confirm", _9c,
								this.deleteFilterConfirm.createDelegate(this,
										[ e ], 0));
					},
					deleteFilterConfirm : function(e, _9e) {
						...
						if (_9e == "yes") {
							filterSvc.deleteFilter(id, {
								callback :this.deleteFilterCallback
					...
					editRelease : function(e) {
						var _a3 = e.data;
						var w = new jx.window.ReleaseFormWindow( {
							data :_a3
						});
					...
					deleteRelease : function(e) {
						...
						var _a7 = String.format(
								"Are you sure you want to delete release {0}?",
								_a6.name);
						Ext.MessageBox.confirm("Confirm", _a7,
								this.deleteReleaseConfirm.createDelegate(this,
										[ e ], 0));
					},
					deleteReleaseConfirm : function(e, _a9) {
						var id = e.data.item.id;
						if (_a9 == "yes") {
							releaseSvc.deleteRelease(id, e.data.project.id, {
								callback :this.deleteReleaseCallback
										.createDelegate(this, [ e ])
							});
						}
					},
					deleteReleaseCallback : function(e) {
						...
						this.getAppContext().fireEvent("showMessage",
								"Success", "The release has been deleted.");
					},
					editTag : function(e) {
						var _ae = e.data;
						var w = new jx.window.TagFormWindow( {
							closeAction :"destroy",
							cancelAction :"destroy",
							listeners : {
								afterSaveTag :this.afterSaveTag.createDelegate(
										this, [ e ], 0)
							}
						});
					...
					afterSaveTag : function(e, w, _b2) {
						var _b3 = Ext.apply(e.data.item, {
							name :_b2.tagName
						});
						if (e.sourceType == "grid") {
							e.source.data.reconfig( {
								item :_b3
							});
						}
					...
					deleteTag : function(e) {
						...
						var _b6 = String.format(
								"Are you sure you want to delete Tag {0}?",
								_b5.name);
						Ext.MessageBox.confirm("Confirm", _b6,
								this.deleteTagConfirm.createDelegate(this,
										[ e ], 0));
					},
					deleteTagConfirm : function(e, _b8) {
						...
						if (_b8 == "yes") {
							tagSvc.removeTag(id, {
								callback :this.deleteTagCallback
										.createDelegate(this, [ e ])
							});
						}
					},
					...
					batchUpdate : function(e) {
						...
						w.show();
						w.loadFilter(e.data.item, e.data.project, this
								.getAppContext().getOrganization(), e);
					},
					batchDelete : function(e) {
						var _bf = e.data.itemType == "filter" ? "Are you sure you want to delete all the items?"
								: "Are you sure you want to delete the selected items?";
						Ext.MessageBox.confirm("Confirm", _bf,
								this.batchDeleteConfirm.createDelegate(this,
										[ e ], 0));
					},
					batchDeleteConfirm : function(e, _c1) {
						if (_c1 == "yes") {
							documentManager.deactivateDocumentBatch(
									e.data.item, this.batchDeleteCallback
					...
					deleteItem : function(e) {
						...
						if (!doc.isFolder) {
							var _c5 = String.format(i18n.g("j.m.itemDelete"),
									doc.name);
							Ext.MessageBox.confirm("Confirm", _c5,
									this.deleteItemConfirm.createDelegate(this,
											[ e ], 0));
						} else {
							var _c5 = String.format(i18n.g("j.m.folderDelete"),
									doc.name);
							Ext.MessageBox.confirm("Confirm", _c5,
									this.deleteItemConfirm.createDelegate(this,
											[ e ], 0));
					...
					deleteItemConfirm : function(e, _c7) {
						...
						if (_c7 == "yes") {
							documentManager.deactivateDocument(_c8, {
								callback :this.deleteItemCallback
										.createDelegate(this, [ e ])
							});
						}
					},
					...
					deleteGroup : function(e) {
						...
						var _cd = String
								.format(
										"Are you sure you want to delete Set {0} and items in the set?",
										_cc.name ? _cc.name : _cc.displayPlural);
						Ext.MessageBox.confirm("Confirm", _cd,
								this.deleteGroupConfirm.createDelegate(this,
										[ e ], 0));
					},
					deleteGroupConfirm : function(e, _cf) {
						var id = e.data.item.id;
						if (_cf == "yes") {
							documentManager.deactivateDocumentGroup(id, {
								callback :this.deleteGroupCallback
										.createDelegate(this, [ e ])
							});
						}
					},
					deleteGroupCallback : function(e) {
						...
						this.getAppContext().fireEvent("showMessage",
								"Success", "The Set has been deleted.");
					},
					deleteProject : function(e) {
						...
						if (!_d4.isFolder) {
							var _d5 = String
									.format(
											"This will delete the project \"{0}\" "
													+ "<br><br>By selecting \"Yes\" everything within this project will be permanently removed, "
													+ "including all Sets, Items and Relationships."
													+ "<br>"
													+ "<br>Are you sure you want to delete \"{0}\"?",
											[ _d4.name ]);
							Ext.MessageBox.confirm("Warning!", _d5,
									this.deleteProjectConfirm.createDelegate(
											this, [ e ], 0));
						} else {
							var _d5 = String
									.format(
											"This will delete the folder \"{0}\" and all sub projects."
													+ "<br>"
													+ "<br>Are you sure you want to delete?",
											[ _d4.name ]);
							Ext.MessageBox.confirm("Warning!", _d5,
					...
					deleteProjectConfirm : function(e, _d7) {
						if (_d7 == "yes") {
							this
									.createLoadingMessageBox("Deleting the project");
							project.deleteProject( {
								id :e.data.project.id
							}, {
								callback :this.deleteProjectSuccess
										.createDelegate(this, [ e ], 0),
								exceptionHandler :this.deleteProjectException
										.createDelegate(this, [ e ], 0)
							});
						}
					},
					...
					deleteProjectException : function(e, _e1, _e2) {
						...
						Ext.MessageBox
								.alert("Error",
										"Delete project did not complete successfully. Nothing has been changed.");
					},
					...
					processUrl : function() {
						...
						if (_ea != -1 && (pId.length > 0 || !isNaN(pId))) {
							...
							var _ef = this;
							project.getProjectDto(pId, {
								callback : function(_f0) {
									_ef.urlProject = _f0;
								},
								async :false
							});
							...
							if (e.data.project.getMask() == 0) {
								this.getAppContext().showMessage("Warning",
										"Access Denied");
								return;
							}
							if (idx != -1) {
								var dId = parseInt(_e9.substr(idx + 6));
								documentManager.getDocumentDto(dId, {
									callback : function(_f2) {
										_ef.urlItem = _f2;
									},
									async :false
								});
					...
					render : function() {
						jx.panel.ProjectCenterPanel.superclass.render.apply(
								this, arguments);
						var e = {
							sourceType :"onLoad",
							source :this,
...
Ext.extend(jx.panel.RelationshipPanel, Ext.Panel, {
	initComponent : function() {
		Ext.apply(this, {
			title :"Relate"
		});
...
Ext.extend(jx.panel.ReportPanel, Ext.Panel, {
	initComponent : function() {
		Ext.apply(this, {
			title :"Report"
		});
...
jx.panel.ItemTreePanel = function(_f6) {
	project: null, _f6 = Ext.applyIf(_f6, {
		title :i18n.g("j.l.itemTree"),
		folderOnly :false,
		border :false,
		tbar :this.getTbar(),
		data :new jx.ItemData( {
...
Ext
		.extend(
				...
				jx.tree.ItemTree,
				{
					...
					initComponent : function() {
						var ctx = this.getAppContext();
						jx.panel.ItemTreePanel.superclass.initComponent
								.call(this);
						ctx.on( {
							refreshItemTree :this.refresh,
							afterDeleteItem :this.deleteItem,
							scope :this
						});
						this.on( {
						...
						this.data.on("dataChanged", this.refresh, this);
						this.getAppContext().on("nullProject",
								this.disableButtons, this);
					},
					...
					loadProject : function(_f9) {
						...
						jx.panel.ItemTreePanel.superclass.loadProject.call(
								this, _f9);
					},
					getTbar : function() {
						var wa = jx.AclPermission.WRITEADMIN;
						return [
								{
									text :i18n.g("j.b.itemAdd"),
									iconCls :"j-item-add-icon",
									disabled :true,
									mask :wa,
									menu :new Ext.menu.Menu( {
										items : [ {
											iconCls :"j-item-add-icon",
											text :i18n.g("j.b.addItem"),
											tooltip :i18n.g("j.tt.addItem"),
											handler :this.onAddItem,
											id :"p-itemtree-addItem-button",
											scope :this
										}, {
											text :i18n.g("j.b.addSet"),
											tooltip :i18n.g("j.tt.addSet"),
											iconCls :"j-set-add-icon",
											handler :this.onAddGroup,
											id :"p-itemtree-addSet-button",
											scope :this
										}, {
											iconCls :"j-item-folder-add-icon",
											text :i18n.g("j.b.itemAddFolder"),
											tooltip :i18n.g("j.tt.addFolder"),
											handler :this.onAddItemFolder,
											id :"p-itemtree-addFolder-button",
											scope :this
										} ]
									})
								},
												...
												items : [
														{
															...
															tooltip :i18n
																	.g("j.tt.tags"),
															iconCls :"j-tag-blue-icon",
															handler :this.showTags,
															scope :this
														},
														{
															id :"o-filters-button",
														...
														},
														{
															...
															tooltip :i18n
																	.g("j.tt.releaseTree"),
															iconCls :"j-item-release-icon",
															handler :this.showRelease,
															scope :this
														} ]
											})
								},
								"->",
								{
									text :"",
									tooltip :i18n
											.g("j.tt.itemTreeShowHideItems"),
									icon :"img/silk/page_white_text.png",
									cls :"x-btn-icon",
									enableToggle :true,
									pressed :true,
									toggleHandler :this.toggleItems
											.createDelegate(this)
								},
								{
									iconCls :"j-item-refresh-icon",
									tooltip :i18n.g("j.tt.refreshItemExplorer"),
									handler :this.refresh,
									id :"p-itemtree-refresh-button",
									scope :this,
									disabled :true
								} ];
					},
										...
										items : [
												{
													text :i18n
															.g("j.b.itemPreview"),
													iconCls :"j-item-preview-icon",
													handler : function() {
														this
																.onPreviewItem(this.ctxMenuNode);
													},
													scope :this
												},
												{
													text :i18n
															.g("j.b.itemEdit"),
													iconCls :"j-item-edit-icon",
													handler : function() {
														this
																.editSelectedItem(this.ctxMenuNode);
													},
													scope :this,
													mask :_ff
												},
												{
													text :i18n
															.g("j.b.itemDelete"),
													iconCls :"j-item-delete-icon",
													handler : function() {
														this
																.deleteSelectedItem(this.ctxMenuNode);
													},
													scope :this,
													mask :_ff
												},
												{
													...
													tooltip :i18n
															.g("j.tt.openInNewTab"),
													iconCls :"j-item-grid-open-selected",
													handler :this.showItemInNewTab,
													scope :this
												} ]
									});
						}
						this.actionMenu
								.showButtons(this.data.project.getMask());
					...
					moveItems : function(e) {
						...
						documentManager.moveItems(this.getNodeList(e.dropNode),
								null, _10a.id, _109 ? _109.id : null, {
									exceptionHandler :this.handleMoveException
											.createDelegate(this, [ e ], 0),
									async :false
								});
					...
					handleMoveException : function(e, msg, ex) {
						e.cancel = true;
						this.getAppContext().fireEvent("showMessage", "Error",
								msg);
					},
					...
					nodeDrop : function(e) {
						if (e.source.tree) {
							...
							if (e.source.grid) {
								...
								this.getAppContext().fireEvent("showMessage",
										"Success",
										"{0} selected item(s) moved",
										e.dropNode.length);
								e.source.grid.fireEvent("itemsMoved",
										"artifact");
							}
						}
					},
					nodeDragOver : function(e) {
						var _113 = e.source;
						var _114 = (e.point == "append") ? e.target
								: e.target.parentNode;
						if (_113.tree) {
							var _115 = e.dropNode;
							return ((_115.id.charAt(0) == "a" && (_115.attributes.typeId == _114.attributes.typeId)) || (_115.id
									.charAt(0) == "g" && _114.id.charAt(0) == "p"));
						} else {
							if (_113.grid) {
								...
								for ( var i = 0, len = s.length; i < len; i++) {
									var _11d = s[i];
									var rid = "a-" + _11d.id;
									if (_11d.data.typeId != _118
											|| rid == pid
											|| rid == _11b.id
											|| (_11d.data.isFolder && path
													.indexOf(rid + "/") >= 0)) {
										return false;
									}
								}
					...
					generateDropNode : function(e) {
						...
						for ( var i = 0, len = s.length; i < len; i++) {
							var data = s[i].data;
							var text = data.name;
							var icon = data.isFolder ? "img/silk/folder.png"
									: "img/silk/page_white_text.png";
							var _126 = data.typeId;
							r.push(new Ext.tree.AsyncTreeNode( {
								allowDrop :false,
								text :_121 ? data.documentKey + " " + text
										: text,
								leaf :data.isFolder ? false : true,
								id :"a-" + s[i].id,
								icon :icon,
								typeId :_126
							}));
					...
					findMe : function(e) {
						...
						if (item) {
							documentManager.getPath(item.id, this.reloadPath
									.createDelegate(this));
						}
					},
					reloadPath : function(path) {
						...
						if (pos > 0) {
							...
							this.selectPath(_12b, null, this.selectPathCallback
									.createDelegate(this, [ path ], true));
						}
					},
					selectPathCallback : function(_12c, node, path) {
						if (_12c && node) {
							node.reload(this.selectPath.createDelegate(this,
									[ path ]));
						}
					},
					...
					deleteSelectedItem : function(node) {
						if (node) {
							...
							this.getAppContext().fireEvent("deleteItem", {
								sourceType :"tree",
								source :this,
								data : {
									project :this.data.project,
							...
							Ext.MessageBox.alert(i18n.g("j.m.warning"), i18n
									.g("j.m.noItemSelected"));
						}
					},
					...
					onPreviewItem : function(node) {
						if (node) {
							...
							this.getAppContext().fireEvent("showWindow", {
								sourceType :"tree",
								source :this,
								sourceEl :this.getEl(),
								xtype :"jx.window.ItemPreviewWindow",
					...
					showTags : function() {
						if (!this.tagDialog) {
							this.tagDialog = new jx.window.TagListWindow( {
								data :this.data
							});
						}
						this.tagDialog.show();
						this.tagDialog.refresh();
						this.tagDialog.alignTo(this.getTopToolbar().getEl(),
								"tl-bl", [ 0, 0 ], true);
					},
					showFilters : function() {
						if (!this.filterDialog) {
							this.filterDialog = new jx.window.FilterListWindow(
									{
										data :this.data
									});
						}
						...
						this.filterDialog.alignTo(this.getTopToolbar().getEl(),
								"tl-bl", [ 0, 0 ], true);
					},
					showRelease : function() {
						if (!this.releaseWindow) {
							this.releaseWindow = new jx.window.ReleaseTreeWindow(
									{
										data :this.data
									});
						}
					...
					beforeDestroy : function() {
						...
						jx.panel.ItemTreePanel.superclass.beforeDestroy.apply(
								this, arguments);
					},
...
Ext.extend(jx.panel.ProjectTreePanel, jx.tree.ProjectTree, {
	project :null,
	inNewTab :false,
	initComponent : function() {
		var ctx = this.getAppContext();
		...
		this.on( {
			...
			afterLoadItemTree :this.onAfterLoadItemTree
		});
		ctx.on( {
			refreshProjectList :this.refresh,
			findMe :this.findMe,
	...
	getTbar : function() {
		...
		return [ {
			iconCls :"j-project-add-icon",
			text :i18n.g("j.b.addProject"),
			tooltip :i18n.g("j.tt.addProject"),
			handler :this.onAddProject.createDelegate(this, [ false ], 0),
			id :"p-add-button",
			scope :this,
			mask :_15e
		}, {
			...
			iconCls :"j-project-folder-add-icon",
			text :i18n.g("j.b.addFolder"),
			tooltip :i18n.g("j.tt.addFolder"),
			handler :this.onAddProject.createDelegate(this, [ true ], 0),
			id :"g-add-button",
			scope :this,
			mask :_15e
		}, "->", {
			iconCls :"j-project-refresh-icon",
			handler :this.refreshTree,
			tooltip :i18n.g("j.tt.refreshProjectExplorer"),
			id :"p-tree-refresh-button",
			scope :this
		}, {
			tooltip :i18n.g("j.tt.minimizeProjectExplorer"),
			iconCls :"j-minimize-panel-up",
	...
	loadProject : function(e) {
		if ((this.project == null) || (e.data.project.id != this.project.id)) {
			project.getProjectDto(e.data.project.id, {
				callback :this.onSuccessLoadProject.createDelegate(this, [ e ],
						0)
			});
		} else {
	...
	onContextMenu : function(node, e) {
		...
		if (node.id.charAt(0) == "p") {
			this.ctxMenuNode = node;
			this.getProjectActionMenu(parseInt(node.id.substring(2))).showAt(
					[ _16a[0], _16a[1] ]);
		}
	...
	getOrgActionMenu : function() {
		if (!this.orgActionMenu) {
			this.orgActionMenu = new Ext.menu.Menu( {
				items : [ {
					text :i18n.g("j.b.admin"),
					iconCls :"j-header-admin-icon",
					handler : function() {
						this.rightClickShowOrgAdmin(this.ctxMenuNode);
					},
					scope :this,
					mask :jx.AclPermission.ORGADMIN
				} ]
			});
		}
	...
	rightClickShowOrgAdmin : function(node) {
		if (node) {
			...
			var e = {
				...
				sourceType :"tree",
				newWindow :false,
				xtype :"jx.window.OrgAdminWindow"
			};
			this.getAppContext().fireEvent("showWindow", e);
		}
	},
	...
	moveItems : function(e) {
		...
		var proj = {
			id :parseInt(e.dropNode.id.substring(2)),
			parent :_185
		};
		project.moveProject(proj, {
			exceptionHandler :this.handleMoveException.createDelegate(this,
					[ e ], 0),
			async :false
		});
	...
	nodeDrop : function(e) {
		if (e.source.tree) {
			this.moveItems(e);
			this.getAppContext().fireEvent("showMessage", "Success",
					"Item {0} moved", e.dropNode.text);
		} else {
			if (e.source.grid) {
				this.moveItems(e);
				this.getAppContext().fireEvent("showMessage", "Success",
						"{0} selected item(s) moved", e.dropNode.length);
	...
	findMe : function(e) {
		project
				.getPath(e.data.project.id, this.reloadPath
						.createDelegate(this));
		e.source = this;
	...
	reloadPath : function(path) {
		...
		if (pos > 0) {
			...
			this.selectPath(_19c, null, this.selectPathCallback.createDelegate(
					this, [ path ], true));
		}
	},
...
jx.panel.FilterListPanel = function(_1a6) {
	_1a6 = Ext.applyIf(_1a6, {
		autoScroll :true
	});
	jx.panel.FilterListPanel.superclass.constructor.call(this, _1a6);
};
Ext.extend(jx.panel.FilterListPanel, Ext.Panel, {
	filterListView :null,
	data :null,
	dialog :null,
	refresh : function() {
	...
	loadFilterResults : function(view, _1a8, e) {
		if (_1a8) {
			...
			this.getAppContext().fireEvent("showGrid", {
				data :data,
				source :this
			});
		}
	...
	getTbar : function() {
		var wa = jx.AclPermission.WRITEADMIN;
		return [ {
			text :i18n.g("j.b.addFilter"),
			iconCls :"j-filter-add-icon",
			tooltip :i18n.g("j.tt.addFilter"),
			handler :this.addItem,
			scope :this,
			mask :wa
		}, "->", {
			iconCls :"j-refresh-icon",
			tooltip :i18n.g("j.tt.refresh"),
			handler :this.refresh,
			scope :this
		} ];
	},
	render : function() {
		...
		this.filterListView = new jx.view.FilterListView( {
			data :this.data,
			listeners : {
				viewFilterResults :this.loadFilterResults,
				editFilter :this.editFilter,
				scope :this
			}
		});
		...
		.extend(
				...
				Ext.Panel,
				{
					...
					onOpenRelate : function() {
						...
						this.getAppContext().fireEvent("showRelationshipTree",
								e);
					},
					onFindMe : function() {
						var e = {
					...
					initComponent : function() {
						...
						Ext.apply(this, {
							autoScroll :false,
							tbar :this.getTbar(),
							iconCls :"j-item-folder-icon",
							border :false,
							layout :"border",
							items : [ {
								xtype :"jx.panel.ItemFormPanel",
								defaults : {
									bodyStyle :"padding: 5px;"
								},
								data :this.data,
								...
								autoScroll :true,
								listeners : {
									afterLoadArtifact :this.afterLoadItem,
									scope :this
								}
							}, {
								region :"south",
					...
					processComponents : function(item) {
						...
						var func = this.toggleTab.createDelegate(this,
								[ _1bd ], 0);
					...
					getTabPanel : function() {
						this.tabPanel = new Ext.TabPanel( {
							...
							items : [ {
								itemCmpName :"folderList",
								title :"Sub-items",
								xtype :"jx.panel.ItemGridPanel",
								refreshOnDataChange :false
							}, {
								itemCmpName :"comment",
								title :"Discussions",
								xtype :"jx.panel.ItemCommentPanel"
							}, {
								itemCmpName :"relationship",
								title :"Relationships",
								xtype :"jx.panel.ItemRelationshipPanel",
								bodyStyle :"padding: 5px;",
								id :this.myId("i-relationship-panel")
							}, {
								itemCmpName :"attachment",
								title :"Attachments",
								bodyStyle :"padding: 5px;",
								xtype :"jx.grid.ItemAttachmentGrid"
							}, {
								itemCmpName :"tag",
								title :"Tags",
								bodyStyle :"padding: 5px;",
								xtype :"jx.panel.ItemTagPanel"
							}, {
								itemCmpName :"history",
								title :"History",
								bodyStyle :"padding: 5px;",
								xtype :"jx.grid.VersionGrid"
							}, {
								itemCmpName :"testHistory",
								title :"Test Results",
								bodyStyle :"padding: 5px;",
								xtype :"jx.grid.ItemTestResultsGrid"
							}, {
								itemCmpName :"selenium",
								title :"Selenium",
								bodyStyle :"padding: 5px;",
								xtype :"jx.panel.ItemSeleniumPanel"
							} ]
						});
						return this.tabPanel;
					},
					getTbar : function() {
						...
						this.notifyButton = new Ext.menu.CheckItem( {
							text :i18n.g("j.b.itemSubscribe"),
							boxLabel :i18n.g("j.b.itemSubscribe"),
							checked :this.data.item.notification,
							listeners : {
								checkchange : {
									fn :this.subscribeToItem,
									scope :this
								}
							},
							id :"i-" + this.data.item.id
									+ "-notification-button"
						});
						return [
								"->",
								{
									...
									menu : {
										...
										items : [
												{
													text :i18n
															.g("j.b.itemOpenRelate"),
													iconCls :"j-relationship-open-tree-icon",
													handler :this.onOpenRelate,
													scope :this,
													mask :_1c9
												},
												"-",
												{
													text :i18n
															.g("j.b.itemQuickReports"),
													iconCls :"j-quick-report-icon",
													handler :this.openQuickReport,
													scope :this
												},
												"-",
												{
								...
								{
									text :i18n.g("j.l.itemMenuActions"),
									menu :new Ext.menu.Menu( {
										id :this.actionMenuId,
										items : [ this.notifyButton, "-", {
											text :i18n.g("j.b.itemAddRelated"),
											iconCls :"j-add-related-icon",
											handler :this.onAddRelItem,
											scope :this,
											mask :_1c9
										}, "-", {
											text :i18n.g("j.b.itemFindMe"),
											handler :this.onFindMe,
											scope :this,
											iconCls :"j-find-me-icon"
										}, new Ext.menu.Separator( {
											...
											text :i18n.g("j.b.itemEmailLink"),
											handler :this.emailItem,
											scope :this,
											iconCls :"j-email-icon"
										} ]
									})
								},
								{
									text :i18n.g("j.l.itemMenuEdit"),
									mask :_1c9,
									menu :new Ext.menu.Menu(
											{
												id :this.editMenuId,
												items : [
																...
																}),
														{
															text :i18n
																	.g("j.b.itemCopy"),
															iconCls :"j-item-copy-icon",
															handler :this.showWindow
																	.createDelegate(
																			this,
																			[ "jx.window.ItemCopyWindow" ],
																			0),
															mask :_1c9
														},
														{
					...
					moveProperty : function(m, _1cb) {
						if (!m) {
							var _1cc = Ext.menu.MenuMgr
									.get(this.propertyMenuId);
							_1cc.render();
					...
					onRelateItemsToItem : function(_1d3, _1d4) {
							...
							if (_1d8 != this.data.getItemId()) {
								if (_1d6) {
									_1d9 = {
										...
										associationType :(_1d4.type != null) ? {
											id :_1d4.type
										}
												: null
									};
						...
						if (_1d5.length > 0) {
							relationshipSvc.saveRelationships( {
								associations :_1d5
							}, this.onSuccessSaveRelationship
									.createDelegate(this));
						}
					},
					onSuccessSaveRelationship : function() {
						var _1da = this.tabPanel.findById(this
								.myId("i-relationship-panel"));
					...
					subCallback : function(_1e1) {
						this.getAppContext().showMessage(
								"Success",
								"Email notification has been turned " + _1e1
										+ ".", this);
					},
					emailItem : function() {
						...
						var _1e6 = String.format("{0}?projectId={1}&docId={2}",
								url, this.data.getProjectId(), this.data
										.getItemId());
						var link = "mailto:?" + "subject="
								+ escape("Link to Contour item") + "&body="
								+ escape(_1e6);
					...
					openQuickReport : function() {
						...
						window
								.open(
										"velocityReport.req",
										null,
										"height=600,width=800,status=yes,toolbar=no,menubar=yes,location=yes,resizable=1,scrollbars=yes");
					}
				});
...
Ext
		.extend(
				...
				jx.grid.ItemGrid,
				{
					...
					singleRowChangeRefresh : function() {
						this.refresh(false);
					},
					refresh : function(_1ea) {
						...
						var _1ed = item.id;
						if ((this.refreshOnDataChange || !_1ea || !_1ed || _1ed != this.loadedId)
								&& this.rendered) {
							this.loadedId = _1ed;
							...
							case "filter":
								var self = this;
								filterSvc.getFilter(item.id, {
									callback : function(_1ef) {
										self.tmpFilter = _1ef;
									},
									async :false
								});
								...
								this.loadFilterGrid(this.tmpFilter, _1f0, {
									typeId :this.tmpFilter.typeId
								});
								break;
							case "folder":
								this.loadFolderGrid(this.showSubFolders,
										data.item.id, data.project.id);
								break;
							case "group":
								this.loadGroupGrid(this.showSubFolders,
										data.item.id, data.project.id,
										data.item.typeId);
								break;
							case "release":
								this.loadReleaseGrid(data.item.id,
										data.project.id);
								break;
							}
						}
					...
					initComponent : function() {
								...
								.apply(
										this,
										{
											tbar : [
													...
													{
														xtype :"tbtext",
														text :"&nbsp;Include items in subfolders",
														mask :all,
														mode :mm.group
																+ mm.folder
													},
															...
															items : [
																	{
																		text :i18n
																				.g("j.b.gridMenuCopy"),
																		iconCls :"j-item-grid-copy-icon",
																		handler :this.onCopySelected,
																		scope :this,
																		mask :wa,
																		mode :mm.selected
																	},
																	{
																		text :i18n
																				.g("j.b.gridMenuUpdate"),
																		iconCls :"j-item-grid-update-selected",
																		handler :this.onUpdateSelected,
																		scope :this,
																		mask :wa,
																		mode :mm.selected
																	},
																	{
																		text :i18n
																				.g("j.b.gridMenuDelete"),
																		iconCls :"j-item-grid-delete-selected",
																	...
																	{
																		text :i18n
																				.g("j.b.gridMenuUpdateAll"),
																		iconCls :"j-item-grid-update-selected",
																		handler :this.onUpdateAll,
																		scope :this,
																		mask :wa,
																		mode :mm.filter
																	},
						...
						jx.panel.ItemGridPanel.superclass.initComponent
								.call(this);
					...
					onRowContextMenu : function(grid, _1f6, e) {
						if (!this.actionMenu) {
							...
							this.actionMenu = new Ext.menu.Menu(
									{
										items : [
												...
												},
												{
													...
													handler : function() {
														this
																.editSelectedItem(this.ctxRecord);
													},
													scope :this,
													mask :_1f8
												},
												{
													...
													handler : function() {
														this
																.deleteSelectedItem(this.ctxRecord);
													},
													scope :this,
													mask :_1f8
												},
							...
							this.actionMenu
									.on("hide", this.onContextHide, this);
						}
						e.stopEvent();
						if (this.ctxRow) {
							Ext.fly(this.ctxRow).removeClass("x-node-ctx");
					...
					onDeleteAll : function(_202) {
						this.getAppContext().fireEvent("batchDelete",
								this.createUpdateEvent(this.filter, false));
					},
					onDeleteSelected : function(_203) {
						this.updateSelected(_203, false);
					},
					onUpdateAll : function(_204) {
						this.getAppContext().fireEvent("batchUpdate",
								this.createUpdateEvent(this.filter, false));
					},
								...
								var e = {
									data : {
										...
										item : {
											...
											name :_208.data.name,
											documentGroup :_20a,
											typeId :_208.data.typeId
										},
										itemType :"doc"
									},
									source :this,
									sourceEl :_206.getEl(),
									xtype :"jx.window.ItemCopyWindow"
								};
							} else {
					...
					updateSelected : function(_20d, _20e) {
						...
						if (_20f.length > 0) {
							...
							if (_210) {
								this.getAppContext().fireEvent(
										_20e ? "batchUpdate" : "batchDelete",
										this.createUpdateEvent(_210, true));
							} else {
								Ext.MessageBox.alert(i18n.g("j.m.warning"),
										i18n.g("j.m.selectedMustHaveSameType"));
							}
						} else {
							Ext.MessageBox.alert(i18n.g("j.m.warning"), i18n
									.g("j.m.noItemSelected"));
					...
					createUpdateEvent : function(_223, _224) {
						return {
							...
							data : {
								project :this.data.project,
								item :_223,
								itemType :_224 ? "selectedFilter" : "filter"
							}
						};
					},
					render : function() {
						jx.panel.ItemGridPanel.superclass.render.apply(this,
								arguments);
						this.refresh();
					},
					openQuickReport : function() {
		...
		.extend(
				...
				Ext.Panel,
				{
					...
					createWidget : function() {
						...
						var w = new jx.form.SimpleItemForm( {
							showButtons :false,
							showTitle :false,
							defaultDateFormat :_228,
							listeners : {
								afterLoadArtifact :this.afterLoadArtifact,
								scope :this
							}
						});
						this.titleDiv = Ext.DomHelper.append(this.body, {
					...
					afterLoadArtifact : function(item) {
						...
						this
								...
								.append(
										this.titleDiv,
										{
											display :item.documentGroup.display,
											description :"description",
											id :item.id,
											image :item.isFolder ? "class=\"j-folder-icon\""
													: "class=\"j-item-icon\""
										});
						this.fireEvent("afterLoadArtifact", item);
					},
					render : function(_22b) {
						jx.panel.ItemFormPanel.superclass.render.call(this,
								_22b);
						this.data.on( {
							"dataChanged" :this.refresh,
							scope :this
					...
					getTpl : function() {
						...
						if (!w.tplCache) {
							w.tplCache = new Ext.XTemplate(
									"<table><tbody>",
									"<tr>",
									"<td nowrap align=\"left\" {image} width=\"10%\"><div class=\"j-set-header-title-left-item\">{display}</div></td>",
									"</tr>", "</tbody></table>");
						}
						return w.tplCache;
					}
...
jx.panel.ItemRelationshipPanel = function(_22d) {
	_22d = Ext.applyIf(_22d, {
		title :i18n.g("j-t-relationships")
	});
	jx.panel.ItemRelationshipPanel.superclass.constructor.call(this, _22d);
};
Ext
		.extend(
				jx.panel.ItemRelationshipPanel,
				Ext.Panel,
				{
					view :null,
					viewEast :null,
					...
					initComponent : function() {
						...
						jx.panel.ItemRelationshipPanel.superclass.initComponent
								.call(this);
					},
					getTbar : function() {
						var wa = jx.AclPermission.WRITEADMIN;
						return [
								...
								{
									text :i18n
											.g("j-b-relationships-table-view"),
									tooltip :i18n
											.g("j-tt-relationships-table-view"),
									iconCls :"j-relationship-grid-icon",
									handler :this.showGrid,
									scope :this
								},
								"-",
								{
									text :i18n
											.g("j-b-relationships-visual-view"),
									tooltip :i18n
											.g("j-tt-relationships-visual-view"),
									iconCls :"j-relationship-view-icon",
									handler :this.showVisual,
									scope :this
								},
								"-",
								{
									text :i18n.g("j-b-relationships-impact"),
									tooltip :i18n
											.g("j-tt-relationships-impact"),
									iconCls :"j-relationship-impact-icon",
									handler :this.showImpact,
									scope :this
								},
								"-",
								{
									text :i18n.g("j.b.showMatrix"),
									iconCls :"j-project-matrix-icon",
									handler :this.showWindow.createDelegate(
											this,
											[ "jx.window.TraceMatrixWindow" ],
											0),
									id :"p-matrix-button",
								...
								{
									text :i18n
											.g("j-b-relationships-open-relate"),
									tooltip :i18n
											.g("j-tt-relationships-open-relate"),
									iconCls :"j-relationship-open-tree-icon",
									handler :this.showRelationshipTree,
									scope :this,
									mask :wa
								} ];
					},
					...
					render : function() {
						jx.panel.ItemRelationshipPanel.superclass.render.apply(
								this, arguments);
						var grid = new jx.grid.ItemRelationshipGrid( {
							data :this.data,
							autoScroll :true,
							listeners : {
								refresh : {
									fn :this.refreshRelationshipViews,
									scope :this
								}
							}
						});
						this.add(grid);
						this.grid = grid;
						this.viewEast = new jx.view.ItemRelationshipView( {
							data :this.data,
							direction :false,
							id :"p-relationship-view-left",
							columnWidth :0.45,
							listeners : {
								...
								afterLoadRelationships : {
									fn :this.doLayoutViews,
									scope :this
								},
								editRelationship : {
									fn :this.grid.editItem,
									scope :this.grid
								}
							}
						});
						this.viewWest = new jx.view.ItemRelationshipView( {
							data :this.data,
							direction :true,
							id :"p-relationship-view-right",
							columnWidth :0.45,
							listeners : {
								refreshRelationshipViews : {
									fn :this.refreshRelationshipViews,
						...
						var view = new Ext.Panel(
								{
									...
									items : [
											this.viewEast,
											{
												html :"<div class=\"j-relate-center-text\"><div>Item</div><br><img src=\"img/32x32/file_32.gif\"/></div>",
												border :false,
												columnWidth :0.1
											}, this.viewWest ]
								});
...
jx.panel.ItemCommentPanel = function(_23a) {
	_23a = Ext.applyIf(_23a, {
		title :i18n.g("j-t-comment")
	});
	jx.panel.ItemCommentPanel.superclass.constructor.call(this, _23a);
};
Ext.extend(jx.panel.ItemCommentPanel, Ext.Panel, {
	dialog :null,
	view :null,
	data :null,
	loadedId :null,
	refresh : function(_23b) {
	...
	createView : function() {
		return new jx.view.CommentView( {
			data :this.data,
			userId :this.getAppContext().user.id,
			listeners : {
				click : {
					fn :this.onClickItem,
					scope :this
	...
	getTbar : function() {
		return [ "->", {
			text :i18n.g("j-b-comment-add"),
			iconCls :"j-comment-add-icon",
			tooltip :i18n.g("j-tt-comment-add"),
			handler :this.addItem,
			scope :this
		} ];
	},
	...
	getDialog : function() {
		if (!this.dialog) {
			this.dialog = new jx.window.CommentWindow( {
				title :"Add/Edit Comment",
				data :this.data,
				listeners : {
					afterSaveComment : {
						fn :this.refresh.createDelegate(this, [ false ], 0),
						scope :this
					}
				}
			});
	...
	deleteItem : function(_24e) {
		...
		Ext.MessageBox.confirm("Confirm", _24f, this.deleteItemConfirm
				.createDelegate(this, [ _24e ], 0));
	},
...
Ext.extend(jx.window.CommentWindow, Ext.Window, {
	data :null,
	render : function(_253) {
		...
		.extend(
				...
				jx.grid.ItemGrid,
				{
					...
					refresh : function(_258) {
						...
						var item = this.data.item;
						var _25b = item.id;
						if ((this.refreshOnDataChange || !_258 || !_25b || _25b != this.loadedId)
								&& this.rendered) {
							this.loadedId = _25b;
							if (data.itemType == "doc" && item.isFolder) {
								data.itemType = "folder";
							...
							case "filter":
								...
								this.loadFilterGrid(this.tmpFilter, _25e, {
									typeId :this.tmpFilter.typeId
								});
								break;
							case "folder":
					...
					updateSelected : function(_27b, _27c) {
						...
						if (_27d.length > 0) {
							...
							if (_27e) {
								this.getAppContext().fireEvent(
										_27c ? "batchUpdate" : "batchDelete",
										this.createUpdateEvent(_27e, true));
							} else {
								Ext.MessageBox.alert(i18n.g("j.m.warning"),
										i18n.g("j.m.selectedMustHaveSameType"));
							}
					...
					createUpdateEvent : function(_291, _292) {
						return {
							...
							data : {
								project :this.data.project,
								item :_291,
								itemType :_292 ? "selectedFilter" : "filter"
							}
						};
					},
					render : function() {
...
jx.panel.WhatsNewPanel = function(_295) {
	_295 = Ext.applyIf(_295, {
		title :i18n.g("j.l.whatsNew"),
		tbar :this.getTbar()
	});
	jx.panel.WhatsNewPanel.superclass.constructor.call(this, _295);
};
Ext.extend(jx.panel.WhatsNewPanel, Ext.Panel, {
	data :null,
	view :null,
	loadedId :null,
	initComponent : function() {
	...
	refresh : function(_296) {
		...
		if ((!_296 || _297 != this.loadedId) && this.rendered) {
			...
			this.view.store.load( {
				arg : [ {
					projectId :this.data.getProjectId()
				} ],
				params : {
					start :0,
					limit :50
	...
	getTbar : function() {
		return [ {
			iconCls :"j-project-refresh-icon",
			handler :this.refresh.createDelegate(this, [ false ]),
			tooltip :i18n.g("j.tt.refreshWhatsNew"),
			id :"p-tree-refresh-button",
			scope :this
		} ];
	},
	...
	render : function() {
		...
		var view = new jx.view.WhatsNewView( {
			data :this.data,
			listeners : {
				click : {
					fn :this.onEventClick,
					scope :this
				}
			}
		});
...
jx.panel.ProjectDashboardPanel = function(_2a4) {
	_2a4 = Ext.applyIf(_2a4, {
		title :i18n.g("j.l.dashboardTab")
	});
	jx.panel.ProjectDashboardPanel.superclass.constructor.call(this, _2a4);
};
Ext.extend(jx.panel.ProjectDashboardPanel, Ext.Panel,
		{
			data :null,
			view :null,
			loadedId :null,
			initComponent : function() {
				jx.panel.ProjectDashboardPanel.superclass.initComponent
						.call(this);
			},
			...
			render : function() {
				jx.panel.ProjectDashboardPanel.superclass.render.apply(this,
						arguments);
			}
		});
...
Ext.extend(jx.panel.SearchPanel, Ext.Panel, {
	filterListView :null,
	data :null,
	dialog :null,
	disabled :false,
	...
	showSearch : function() {
		if (!this.searchDialog) {
			this.searchDialog = new jx.window.SearchWindow( {
				data :this.data
			});
		}
...
Ext.extend(jx.panel.LogoutPanel, Ext.Panel, {
	filterListView :null,
	data :null,
	dialog :null,
	id :"o-logout-panel",
	...
	getTbar : function() {
		return [
				{
					id :"o-myprofile-button",
					text :"Welcome "
							+ this.getAppContext().user.firstName.toString()
							+ " (Edit Profile)",
					tooltip :i18n.g("j.tt.myProfile"),
					handler :this.showMyProfileWindow,
					scope :this,
					mask :jx.AclPermission.ALL
				},
				{
					id :"o-help-button",
					text :i18n.g("j.b.help"),
					tooltip :i18n.g("j.tt.help"),
					iconCls :"j-header-help-icon",
					handler :this.showHelp,
					scope :this,
					mask :jx.AclPermission.ALL
				},
				{
					id :"o-orgadmin-button",
					text :i18n.g("j.b.admin"),
					tooltip :i18n.g("j.tt.admin"),
					iconCls :"j-header-admin-icon",
					handler :this.showWindow.createDelegate(this, [
							"jx.window.OrgAdminWindow", false ], 0),
					scope :this,
					mask :jx.AclPermission.ORGADMIN
				},
				{
					id :"o-report-button",
					text :i18n.g("j.b.report"),
					tooltip :i18n.g("j.tt.report"),
					iconCls :"j-header-report-icon",
					handler :this.showWindow.createDelegate(this, [
							"jx.window.ProjectReportWindow", true ], 0),
					scope :this,
					disabled :true,
					mask :jx.AclPermission.ALL
				}, "->", {
					id :"o-logout-button",
					text :i18n.g("j.b.logout"),
					tooltip :i18n.g("j.tt.logout"),
					iconCls :"j-header-logout-icon",
					handler :this.logout,
					scope :this,
					mask :jx.AclPermission.ALL
				} ];
	...
	showMyProfileWindow : function(_2b4) {
		if (!this.profileDialog) {
			this.profileDialog = new jx.window.MyProfileWindow( {
				data :this.data,
				cancelAction :"hide",
				closeAction :"hide"
			});
	...
	afterRender : function() {
		...
		this.getTopToolbar().showButtons(
				this.getAppContext().isOrgAdmin() ? jx.AclPermission.ORGADMIN
						: jx.AclPermission.READ);
	},
	logout : function() {
		window.location = "logout.req";
	},
	showHelp : function(_2b7) {
		if (!this.helpDlg) {
			this.helpDlg = new jx.window.HelpWindow( {
				closeAction :"hide",
				cancelAction :"hide"
			});
		}
...
Ext.extend(jx.panel.AdminLogoutPanel, Ext.Panel, {
	filterListView :null,
	data :null,
	dialog :null,
	id :"o-logout-panel",
...
jx.panel.ReleaseTreePanel = function(_2c2) {
	project: null, _2c2 = Ext.applyIf(_2c2, {
		folderOnly :false,
		tbar :this.getTbar()
	});
	jx.panel.ReleaseTreePanel.superclass.constructor.call(this, _2c2);
};
Ext.extend(jx.panel.ReleaseTreePanel, jx.tree.ItemTree, {
	buttonEnabled :false,
	data :null,
	initComponent : function() {
		var ctx = this.getAppContext();
		...
		ctx.on( {
			afterSaveRelease :this.afterSaveRelease,
			afterDeleteRelease :this.afterDeleteRelease,
			scope :this
		});
		this.on( {
			nodedragover :this.nodeDragOver,
	...
	getTbar : function() {
		var wa = jx.AclPermission.WRITEADMIN;
		return [ {
			text :i18n.g("j.b.addRelease"),
			tooltip :i18n.g("j.tt.addRelease"),
			iconCls :"j-item-add-icon",
			handler :this.addRelease,
			scope :this,
			mask :wa
		} ];
	},
	addRelease : function() {
		this.releaseFormWindow = new jx.window.ReleaseFormWindow( {
			data :this.data
		});
	...
	getActionMenu : function() {
		if (!this.actionMenu) {
			this.actionMenu = new Ext.menu.Menu( {
				items : [ {
					text :i18n.g("j.b.openInNewTab"),
					tooltip :i18n.g("j.tt.openInNewTab"),
					iconCls :"j-set-add-icon",
					handler :this.showItemInNewTab,
					id :"p-itemtree-showItemInNewTab-menu",
					scope :this
				} ]
			});
		}
	...
	moveItems : function(e) {
		...
		documentManager.moveItems(this.getNodeList(e.dropNode), null, _2d0.id,
				_2cf ? _2cf.id : null, {
					exceptionHandler :this.handleMoveException.createDelegate(
							this, [ e ], 0),
					async :false
				});
		if (e.source.grid && !e.dropNode.parentExpanded) {
	...
	generateDropNode : function(e) {
		...
		for ( var i = 0, len = s.length; i < len; i++) {
			...
			r.push(new Ext.tree.AsyncTreeNode( {
				allowDrop :false,
				text :_2de ? data.documentKey + " " + text : text,
				leaf :data.isFolder ? false : true,
				id :"a-" + s[i].id,
				icon :icon,
				typeId :_2e3
	...
	reloadPath : function(path) {
		...
		if (pos > 0) {
			...
			this.selectPath(_2e8, null, this.selectPathCallback.createDelegate(
					this, [ path ], true));
		}
	},
...
jx.panel.TagListPanel = function(_305) {
	_305 = Ext.applyIf(_305, {
		autoScroll :true
	});
	jx.panel.TagListPanel.superclass.constructor.call(this, _305);
};
Ext.extend(jx.panel.TagListPanel, Ext.Panel, {
	data :null,
	tagStore :null,
	tagCloud :null,
	refresh : function() {
		if (this.data && this.data.getProjectId() && this.rendered) {
			this.tagStore.load( {
				arg : [ this.data.getProjectId(), true ]
			});
			this.toggleButtons();
		}
	},
	...
	getTbar : function() {
		var wa = jx.AclPermission.WRITEADMIN;
		return [ {
			text :i18n.g("j.b.addTag"),
			tooltip :i18n.g("j.tt.addTag"),
			iconCls :"j-tag-add-icon",
			handler :this.addTag,
			scope :this,
			mask :wa
		}, "->", {
			text :i18n.g("j.b.viewTagCloud"),
			tooltip :i18n.g("j.tt.viewTagCloud"),
			iconCls :"j-tag-cloud-icon",
			handler :this.showAsCloud,
			scope :this
		}, "-", {
			text :i18n.g("j.b.viewTagList"),
			tooltip :i18n.g("j.tt.viewTagList"),
			iconCls :"j-tag-list-icon",
			handler :this.showAsList,
			scope :this
		}, "-", {
			iconCls :"j-refresh-icon",
			tooltip :i18n.g("j.tt.refresh"),
	...
	editTag : function() {
		...
		if (this.selectedRecord) {
			...
			d.editTag( {
				...
				tagName :this.editRecord.data.tagName
			}, this.data.project);
		} else {
	...
	getDialog : function() {
		if (!this.dialog) {
			this.dialog = new jx.window.TagFormWindow( {
				listeners : {
					afterSaveTag :this.afterSaveTag,
					scope :this
				}
			});
		}
...
jx.panel.ItemTagPanel = function(_311) {
	_311 = Ext.applyIf(_311, {
		title :"Tags"
	});
	jx.panel.ItemTagPanel.superclass.constructor.call(this, _311);
};
Ext.extend(jx.panel.ItemTagPanel, Ext.Panel, {
	data :null,
	loadedId :null,
	dialog :null,
	refresh : function(_312) {
		var _313 = this.data.getItemId();
		if ((!_312 || _313 != this.loadedId) && this.rendered) {
			this.loadedId = _313;
			this.tagView.store.load( {
				arg : [ this.data.item.id ]
			});
			if (this.dialog) {
	...
	initComponent : function() {
		...
		Ext.apply(this, {
			...
			tbar : [ "->", {
				text :i18n.g("j.b.itemTagAddEdit"),
				iconCls :"j-tag-add-icon",
				handler :this.addItem,
				scope :this,
				mask :wa
	...
	getDialog : function() {
		if (!this.dialog) {
			this.dialog = new jx.window.ItemTagFormWindow( {
				title :i18n.g("j.l.itemTagWindowTitle"),
				data :this.data,
				listeners : {
					afterSaveTag : {
						fn :this.refresh.createDelegate(this, [ false ], 0),
					...
					refreshItemTagTab : {
						fn :this.simpleRefresh.createDelegate(this),
						scope :this
					}
				}
			});
	...
	createView : function() {
		...
		this.tagView = new Ext.DataView( {
			emptyText :i18n.g("j.l.itemTagNoTagText"),
			tpl :this.getTemplate(),
			selectedClass :"j-tag-selected",
			store :_31b,
			itemSelector :"span.j-item-tag-span",
			listeners : {
				"click" :this.clickTag,
				scope :this
			}
	...
	getTemplate : function() {
		return new Ext.XTemplate(
				"<div><div class=\"j-tag-tab-panel\"><tpl for=\".\">",
				"{[xindex > 1 ? \"&nbsp;|&nbsp;\" : \"\"]}",
				"<span class=\"j-item-tag-span\">",
				"<a href=\"javascript:void(0);\">{[values.tag.tagName]}</a>",
				"</span>", "</tpl></div></div>");
	}
});
Ext.reg("jx.panel.ItemTagPanel", jx.panel.ItemTagPanel);
jx.window.ItemTagFormWindow = function(_31c) {
	_31c = Ext.applyIf(_31c, {
		width :600,
		height :400,
		modal :false,
		closable :true,
		...
		items : {
			xtype :"panel",
			id :"i-tag-panel-window",
			layout :"border",
			items : [ {
				region :"center",
				id :"i-tag-list-window",
				xtype :"jx.panel.ItemTagListPanel",
				listeners : {
					afterSaveNewTag : {
						fn :this.refreshTagView,
						scope :this
					}
				},
				data :_31c.data
				...
				layout :"fit",
				items : [ {
					xtype :"jx.view.ItemTagView",
					data :_31c.data,
					id :"i-tag-view-window",
					listeners : {
						afterRemoveTag : {
							fn :this.afterRemoveTag,
							scope :this
						}
					}
				} ]
		...
		buttons : [ {
			text :i18n.g("j.b.itemTagWindowClose"),
			handler :this.onCancel,
			scope :this
		} ]
	});
...
Ext.extend(jx.window.ItemTagFormWindow, Ext.Window, {
	data :null,
...
jx.view.ItemTagView = function(_321) {
	...
	_321 = Ext.applyIf(_321, {
		store :_322,
		tpl :this.getTemplate(),
		title :"Click to remove",
		overClass :"j-item-tag-view-overr",
		emptyText :i18n.g("j.m.noTags"),
		itemSelector :"div.itemTagBox"
	});
		...
		.extend(
				...
				Ext.DataView,
				{
					getTemplate : function() {
						return new Ext.XTemplate(
								"<tpl for=\".\">",
								"<div class=\"itemTagBox x-cloud-list-item\" ><a href=\"javascript:void(0)\">{[values.tag.tagName]}</a></div>",
								"</tpl>");
					},
					refreshTagView : function() {
						this.store.load( {
							arg : [ this.data.getItemId() ]
						});
					},
					render : function() {
						jx.view.ItemTagView.superclass.render.apply(this,
								arguments);
						this.store.load( {
							arg : [ this.data.getItemId() ]
						});
					...
					removeTag : function(view, _324, item, e) {
						...
						tagSvc.removeDocumentTag( {
							id :_327.id
						}, this.onSuccessRemoveTag.createDelegate(this));
					},
...
jx.panel.ItemTagListPanel = function(_328) {
	_328 = Ext.applyIf(_328, {
		autoScroll :true
	});
	jx.panel.ItemTagListPanel.superclass.constructor.call(this, _328);
};
Ext.extend(jx.panel.ItemTagListPanel, jx.panel.TagListPanel, {
	data :null,
	loadTagResults : function(_329, _32a, _32b) {
		var _32c = {
			tag : {
				id :_32a.id
			},
		...
		tagSvc.saveDocumentTagProjectScope(_32c, this.afterSaveTag
				.createDelegate(this));
	},
	...
	saveTagCallback : function(tag) {
		...
		tagSvc.saveDocumentTagProjectScope(_32e, this.afterSaveTag
				.createDelegate(this));
		jx.panel.ItemTagListPanel.superclass.saveTagCallback.apply(this,
				arguments);
	}
});
		...
		.extend(
				...
				Ext.Panel,
				{
					...
					getNotifyButton : function() {
						this.notifyButton = new Ext.menu.CheckItem( {
							text :i18n.g("j.b.setSubscribe"),
							boxLabel :i18n.g("j.b.setSubscribe"),
							checked :this.data.group.notification,
							listeners : {
								checkchange : {
									fn :this.subscribeToItem,
									scope :this
					...
					defaultNotifyButton : function() {
						this.notifyButton.setChecked(
								this.data.group.notification, true);
					},
					subCallback : function(_333) {
						this.getAppContext().showMessage(
								"Success",
								"Email notification has been turned " + _333
										+ ".", this);
					},
					refresh : function() {
						if (this.data.group.id) {
							documentManager.getDocumentGroup(
									this.data.group.id, this.afterLoadGroup
											.createDelegate(this));
					...
					toggleButtons : function() {
						if (this.rendered) {
							...
							if (_335.rendered) {
								...
								var menu = Ext.menu.MenuMgr
										.get(this.actionMenuId);
					...
					initComponent : function() {
						Ext.apply(this, {
							...
							items : [ {
								margins :"0 0 0 0",
								ctCls :"j-set-header-panel",
								border :false,
								region :"north",
								tbar :this.createGroupTb(),
								height :130
							}, this.createPortal() ]
						});
						...
						return [
								"->",
								{
									...
									menu : {
										...
										items : [ {
											text :i18n
													.g("j.b.setDisplayInGrid"),
											tooltip :i18n
													.g("j.tt.setDisplayInGrid"),
											iconCls :"j-set-show-grid-icon",
											handler :this.showGrid,
											scope :this
										} ]
									}
								...
								{
									text :i18n.g("j.l.setMenuActions"),
									menu :new Ext.menu.Menu(
											{
												id :this.actionMenuId,
												items : [
														this.getNotifyButton(),
														new Ext.menu.Separator(
																{
																	mask :wa
																}),
									...
									text :i18n.g("j.l.setMenuEdit"),
									tooltip :i18n.g("j.tt.editSet"),
									mask :wa,
									menu : {
										items : [ {
											text :i18n.g("j.b.editSet"),
											tooltip :i18n.g("j.tt.editSet"),
											iconCls :"j-set-edit-icon",
											handler :this.onEditGroup,
											scope :this
										}, "-", {
											text :i18n.g("j.b.deleteSet"),
											tooltip :i18n.g("j.tt.deleteSet"),
											iconCls :"j-set-delete-icon",
					...
					createWidget : function() {
						...
						var w = new jx.form.SimpleGroupForm( {
							data :this.data,
							showButtons :false,
							showTitle :false,
							listeners : {
								onLoadGroup :this.afterLoadGroup,
								scope :this
							},
							defaultDateFormat :_33c
						});
						this.groupForm = w;
						return w;
					},
					afterLoadGroup : function(_33e) {
						...
						this
								.setTabTitleAndImage(_33e.displayPlural,
										_33e.image);
					...
					setGroupPanelIcon : function(_340) {
						...
						span
								.applyStyles(String
										.format(
												"background-image: url(img/tree/{0}) !important; background-repeat:no-repeat;",
												_340.image));
					},
						...
						var _343 = [
								{
									...
									id :"close",
									handler : function(e, _345, _346) {
										_346.ownerCt.remove(_346, true);
									}
								} ];
						this.gridLink = new Ext.ux.Portlet(
								{
									title :"Link to Items",
									tools :_343,
									height :200,
									html :"<div class=\"j-section-header\"><a href=\"javascript:void(0)\">"
											+ i18n.g("j.l.setViewItemsLink")
											+ "</a></div>"
								});
						return {
							xtype :"portal",
							...
							items : [ {
								columnWidth :0.5,
								style :"padding:30px 5px 10px 10px",
								items : [ {
									title :i18n.g("j.l.setFiltersTitle"),
									autoScroll :true,
									height :400,
									items : {
										id :this.id + "-filterList",
										xtype :"jx.panel.FilterListPanel",
										data :this.data
									}
								} ]
							}, {
								columnWidth :0.5,
								style :"padding:30px 10px 10px 5px",
								items : [ {
									title :"View Items",
									layout :"fit",
									height :90,
									...
									title :i18n.g("j.l.setTagsTitle"),
									layout :"fit",
									height :300,
									items : {
										id :this.id + "-tagList",
										xtype :"jx.panel.TagListPanel",
										data :this.data
									}
								} ]
							} ]
					...
					setLink : function(_347) {
						_347.body
								.update("<div class=\"j-set-portal-link\"><a href=\"javascript:void(0)\">Open Items in List View</a></div>");
						var link = _347.body.child("div.j-set-portal-link");
						link.on("click", this.showGrid, this);
					},
					setAddLink : function(_349) {
						_349.body
								.update("<div class=\"j-set-portal-link\"><a href=\"javascript:void(0)\">Add New Item</a></div>");
					...
					getTpl : function() {
						...
						if (!w.tplCache) {
							w.tplCache = new Ext.XTemplate(
									"<table><tbody>",
									"<tr>",
									"<td nowrap align=\"right\" width=\"10%\"><div class=\"j-set-header-title-left\">Set</div></td><td><div class=\"j-set-header-title-right\">{displayPlural}</div></td>",
									"</tr>",
									"</tbody></table>",
									"<div><table class=\"j-set-header-table\"><tbody>",
									"<tr>",
									"<td nowrap align=\"right\" width=\"10%\"><span class=\"j-text-bold\">Description:&nbsp;</span></td><td>{description}</td>",
									"</tr>",
									"<tr>",
									"<td nowrap align=\"right\"><span class=\"j-text-bold\">API ID:&nbsp;</span></td><td>{id}</td>",
									"</tr>", "</tbody></table></div>");
						}
						return w.tplCache;
					}
...
Ext
		.extend(
				jx.panel.SuspectPanel,
				Ext.Panel,
				{
					data :null,
					all :null,
					project :null,
					itemSelector :"div.j-supect-head",
					emptyText :"<p>There are no supect links for this project</p>",
					gridList : [],
					refresh : function() {
					...
					loadSuspects : function(_352) {
						...
						documentManager.getDocumentListWithSuspectLinks(
								this.project.id, this.fillTable
										.createDelegate(this));
					},
					initComponent : function() {
						jx.panel.SuspectPanel.superclass.initComponent
								.call(this);
					},
					...
					createDocumentLink : function(item, cell) {
						var html = String
								.format(
										"<div class=\"j-supect-head\"> <a href=\"javascript:void(0)\">{0}</a>"
												+ "\"{1}\" was modified by {2} on {3}. The following may be affected:</div>",
										item.documentKey, item.name,
					...
					createSuspectGrid : function(item) {
						if (item.documentTraceList != null) {
							var _35a = new jx.grid.SuspectGrid( {
								data :item.documentTraceList,
								project :this.project,
								listeners : {
									showItem :this.showItem,
									afterClear :this.refresh,
									scope :this
								}
							});
					...
					beforeDestroy : function() {
						jx.panel.SuspectPanel.superclass.beforeDestroy.apply(
								this, arguments);
				...
				jx.grid.SimpleGrid,
				{
					getListDefinitions : function() {
						return ( [
								{
									field :"documentKey",
									renderer :this.documentKeyRenderer
											.createDelegate(this),
									label :"ID",
									width :"20%"
								},
					...
					documentKeyRenderer : function(_365, node, item) {
						return "<a href=\"javascript:void(0);\" class=\"j-action-show\">"
								+ item.data.documentKey + "</a>";
					...
					buildImpactStore : function(data) {
						...
						var _36d = new jx.data.SimpleListStore( {
							id :"documentId",
							fields :_36c,
							data :data
						});
					...
					onSelectItem : function(view, _36f, _370, e, _372) {
						...
						case "show":
							this
									.fireEvent("showItem",
											_370.data.documentId,
											_370.data.documentName,
											_370.data.projectId);
							break;
						default:
							break;
					...
					render : function() {
						jx.grid.SuspectGrid.superclass.render.apply(this,
								arguments);
						this.loadList();
					},
					destroy : function() {
						jx.grid.SuspectGrid.superclass.destroy.apply(this,
								arguments);
					},
					loadList : function() {
						this.dataStore.load();
...
Ext
		.extend(
				...
				Ext.Panel,
				{
					...
					traceWindow :null,
					itemWindow :null,
					documentGroupStore :null,
					selectedClass :"selected",
					selectedRow :null,
					load : function(_377) {
						this.project = _377;
						this.documentGroupStore.load( {
							arg : [ this.project.id ]
						});
					},
					onViewMatrix : function() {
						...
						if (_37a && _37c && _37b && _37d) {
							relationshipSvc.getMatrixBetweenGroups(_379, _37a,
									_37b, _37c, _37d, {
										callback :this.loadMatrix
												.createDelegate(this),
										async :true
									});
						}
					...
					createToolbar : function() {
						this.documentGroupStore = jx.data.StoreFactory
								.buildDocumentGroupStore();
						...
						return [ "Left:&nbsp;", this.leftGroup,
								"&nbsp;Limit:&nbsp;", this.leftNumber, "->",
								"Top:&nbsp;", this.rightGroup,
								"&nbsp;Limit:&nbsp;", this.rightNumber, {
									text :"View Matrix",
									cls :"x-btn-text",
					...
					createCombo : function() {
						var _37f = new Ext.form.ComboBox( {
							store :this.documentGroupStore,
							displayField :"displayPlural",
							valueField :"id",
							mode :"local",
							triggerAction :"all",
							emptyText :"Select a set...",
							selectOnFocus :true,
							editable :false
						});
						return _37f;
					...
					createNumberCombo : function() {
						var _380 = new Ext.data.SimpleStore( {
							fields : [ "value" ],
							data : [ [ 5 ], [ 10 ], [ 15 ], [ 20 ], [ 25 ],
									[ 50 ], [ 75 ], [ 100 ], [ 150 ] ]
						});
						var _381 = new Ext.form.ComboBox( {
							store :_380,
							displayField :"value",
							valueField :"value",
							mode :"local",
							triggerAction :"all",
							emptyText :"Select a limit...",
							selectOnFocus :true,
							value :20,
							width :60,
							regex :/^\d+$/
						...
						if (_383) {
							...
							if (row && cell) {
								...
								if (_387 == 0) {
									...
									this.showTrace(_388, _387, _389, _38a,
											_38b, cell);
								}
							}
						}
					...
					onClick : function(e) {
						...
						if (_38d) {
							...
							if (row) {
								if (this.selectedRow) {
									Ext.get(this.selectedRow).removeClass(
											this.selectedClass);
								}
					...
					showTrace : function(_391, _392, _393, _394, _395, cell) {
						if (this.project.getMask()
								& jx.AclPermission.WRITEADMIN) {
							if (!this.traceWindow) {
								this.traceWindow = new jx.window.MatrixTraceWindow(
										{
											listeners : {
												afterUpdateTrace : {
													fn :this.updateCell,
					...
					parseMatrixData : function(_39d) {
						return {
							columns :this.parseColumns(_39d.topList),
							data :this.parseData(_39d)
						};
					},
					...
					getValueMap : function(_3aa, _3ab) {
						return {
							"1" :"<img src=\"img/trace_to.png\" />",
							"2" :"<img src=\"img/trace_from.png\" />",
							"3" :"<img src=\"img/trace.png\" />"
						};
					},
					getTpl : function() {
						...
						if (!mw.tplCache) {
							mw.tplCache = new Ext.XTemplate(
									...
									"<tr>",
									"<tpl for=\".\">",
									"<td align=\"{[xindex==0?\"left\":\"center\"]}\">{[this.getCellValue(values)]}</td>",
									"</tpl>", "</tr>", "</tpl>", "</tbody>",
									"</table>", {
...
Ext
		.extend(
				jx.window.MatrixItemWindow,
				Ext.Window,
				{
					loadItem : function(item) {
						this.panel.body.update("");
						documentManager.getDocumentDto(item.id,
								this.loadItemCallback.createDelegate(this));
					},
					loadItemCallback : function(item) {
					...
					getTpl : function() {
						...
						if (!mw.tplCache) {
							mw.tplCache = new Ext.XTemplate(
									...
									"<tr><td valign=\"top\" class=\"j-text-box\">Description:</td><td>{description}</td></tr>",
									"</tbody></table>");
						}
						return mw.tplCache;
					}
...
Ext
		.extend(
				jx.window.MatrixTraceWindow,
				Ext.Window,
				{
					trace :null,
					loadTrace : function(_3b2) {
						if (!this.form) {
							this.renderForm();
						}
						this.trace = _3b2;
						var tpl = this.getTpl();
						this.textBox.update("");
						this.getTpl().append(this.textBox, {
							toDoc :_3b2.toDoc.name,
							fromDoc :_3b2.fromDoc.name
						});
						this.form.getForm().setValues( {
							traceDir :_3b2.traceDir
						});
					},
					saveTrace : function() {
						...
						var form = new Ext.form.FormPanel(
								{
									...
									items : [ {
										...
										radios : [
												...
												{
													value :"1",
													boxLabel :"Trace forward <img src=\"img/trace_to.png\"/>"
												},
												{
													value :"2",
													boxLabel :"Trace backward <img src=\"img/trace_from.png\"/>"
												},
												{
													value :"3",
													boxLabel :"Trace forward and backward <img src=\"img/trace.png\"/>"
												} ]
									} ]
								});
						return form;
					...
					getTpl : function() {
						...
						if (!mw.tplCache) {
							mw.tplCache = new Ext.XTemplate(
									"<div>Relationship from \"{fromDoc}\" to \"{toDoc}\":</div><div>&nbsp;</div>");
						}
						return mw.tplCache;
					},
					render : function() {
						jx.window.MatrixTraceWindow.superclass.render.apply(
								this, arguments);
					},
					renderForm : function() {
						this.form = this.createForm( {});
						this.textBox = Ext.DomHelper.append(this.panel.body, {
							tag :"div"
						}, true);
						this.form.render(this.panel.body);
					},
...
jx.panel.WordImportPanel = function(_3be) {
	_3be = Ext.applyIf(_3be, {
		items : [ {
			xtype :"jx.form.WordImportForm",
			project :_3be.project,
			baseUrl :this.getAppContext().baseUrl,
			listeners : {
...
Ext.extend(jx.panel.WordImportPanel, Ext.Panel, {
	importData : function() {
			...
			.applyIf(
					_3c0,
					{
						...
						items : [
								{
									xtype :"combo",
									fieldLabel :"Select Set to Import Data Into",
									name :"import_doc_group_display",
									hiddenName :"import_doc_group",
									anchor :"100%",
									store :this.creatdDocumentGroupStore(),
									displayField :"displayPlural",
									valueField :"id",
									mode :"local",
									triggerAction :"all",
								...
								{
									fieldLabel :"Enter Requirement Name Styles",
									name :"field_nameStyles",
									anchor :"100%",
									listeners : {
										render : function(c) {
											Ext.QuickTips
													.register( {
														target :c.getId(),
														text :"Enter one or more Word style names separated by a comma. Style names are not case sensitive and you may use wildcards. Example: reqname, heading*, name?"
													});
										}
									}
								},
								{
									fieldLabel :"Enter Requirement Description Styles (Optional)",
									name :"field_descriptionStyles",
									anchor :"100%",
									listeners : {
										render : function(c) {
											Ext.QuickTips
													.register( {
														target :c.getId(),
														text :"Enter one or more Word style names separated by a comma.  Style names are not case sensitive and you may use wildcards. Example: normal, desc*"
													});
										}
									}
								}, {
									fieldLabel :"Select file to import",
									name :"import_file",
									type :"file",
									allowBlank :true,
									anchor :"100%",
...
Ext.extend(jx.form.WordImportForm, Ext.form.FormPanel, {
	project :null,
	baseUrl :"",
	uploadUrl :"dataImport.req",
	...
	importData : function() {
		this.getForm().submit( {
			...
			url :this.baseUrl + this.uploadUrl,
			reset :false,
			success :this.uploadCallback.createDelegate(this),
			failure : function(form, _3c5) {
				alert(_3c5.result.data.cause);
			},
			params : {
				import_projectId :this.project.id,
				field_docType :"wordxml"
			}
		});
	},
...
jx.panel.CsvImportPanel = function(_3c8) {
	_3c8 = Ext.applyIf(_3c8, {
		items : [ {
			xtype :"jx.form.CsvImportForm",
			project :_3c8.project,
			baseUrl :this.getAppContext().baseUrl,
			listeners : {
				afterImport :this.afterImport,
				scope :this
...
Ext.extend(jx.panel.CsvImportPanel, Ext.Panel, {
	importData : function() {
		this.items.itemAt(0).importData();
	},
...
jx.form.CsvImportForm = function(_3ca) {
	_3ca = Ext.applyIf(_3ca, {
		...
		items : [ {
			...
			xtype :"ux-radiogroup",
			fieldLabel :"Text delimiter",
			name :"text_delimiter",
			anchor :"100%",
			horizontal :true,
			radios : [ {
				value :"\"",
				boxLabel :"Double quote",
				checked :true
			}, {
				value :"'",
				boxLabel :"Single quote"
			} ]
		}, {
			fieldLabel :"Select file to import",
			name :"import_file",
...
Ext.extend(jx.form.CsvImportForm, Ext.form.FormPanel,
		{
			project :null,
			baseUrl :"",
			uploadUrl :"dataImport.req",
			...
			creatdDocumentGroupStore : function() {
				this.groupStore = jx.data.StoreFactory
						.buildDocumentGroupStore();
				return this.groupStore;
			},
			onChangeGroup : function(_3cb) {
				var _3cc = _3cb.getValue();
				documentTypeSvc.getDocumentTypeMetaDataByDocumentGroupId(_3cc,
						this.project.id, this.changeGroupCallback
								.createDelegate(this));
			},
			...
			importData : function() {
				...
				this.getForm().submit( {
					...
					reset :false,
					success :this.uploadCallback.createDelegate(this),
					failure : function(form, _3d1) {
						alert(_3d1.result.data.cause);
					},
					params : {
						import_projectId :this.project.id,
						field_docType :"csv",
						import_fieldMapping :_3cf
					}
				});
			},
...
Ext
		.extend(
				jx.panel.ImpactPanel,
				Ext.Panel,
				{
					project :null,
					initComponent : function() {
						jx.panel.ImpactPanel.superclass.initComponent
								.call(this);
					},
					fillTable : function(data) {
						var _3d6 = [];
						...
						this.impactSourceWidget = new jx.grid.ImpactGrid( {
							data :_3d6,
							listeners : {
								showItem :this.showItem,
								scope :this
						...
						this.directImpactWidget = new jx.grid.ImpactGrid( {
							data :_3d7,
							listeners : {
								showItem :this.showItem,
								scope :this
						...
						this.indirectImpactWidget = new jx.grid.ImpactGrid( {
							data :_3d8,
							listeners : {
								showItem :this.showItem,
								scope :this
						...
						Ext.DomHelper
								.append(
										this.body,
										{
											html :"<div class=\"j-impact-group-text-header\">Source Item(s)</div>"
										});
						...
						Ext.DomHelper
								.append(
										this.body,
										{
											html :"<div class=\"j-impact-group-text\">Direct Impact</div>"
										});
						...
						Ext.DomHelper
								.append(
										this.body,
										{
											html :"<div class=\"j-impact-group-text\">Indirect Impact</div>"
										});
					...
					loadImpacts : function(_3df) {
						relationshipSvc.getImpactedDocuments(_3df,
								this.fillTable.createDelegate(this));
					},
					beforeDestroy : function() {
						jx.panel.ImpactPanel.superclass.beforeDestroy.apply(
								this, arguments);
				...
				jx.grid.SimpleGrid,
				{
					getListDefinitions : function() {
						return ( [
								...
								{
									field :"documentKey",
									renderer : function(_3e1, node, item) {
					...
					buildImpactStore : function(data) {
						...
						var _3e9 = new jx.data.SimpleListStore( {
							id :"documentId",
							fields :_3e8,
							data :data
						});
					...
					onSelectItem : function(view, _3eb, _3ec, e, _3ee) {
						...
						case "show":
							this
									.fireEvent("showItem",
											_3ec.data.documentId,
											_3ec.data.documentName,
											_3ec.data.projectId);
							break;
						default:
							break;
					...
					render : function() {
						jx.grid.ImpactGrid.superclass.render.apply(this,
								arguments);
						this.loadList();
					},
					destroy : function() {
						jx.grid.ImpactGrid.superclass.destroy.apply(this,
								arguments);
					},
					loadList : function() {
						this.dataStore.load();
...
jx.panel.ProjectReportPanel = function(_3ef) {
	_3ef = Ext.applyIf(_3ef, {
		autoScroll :false,
		bodyStyle :"padding:5px;"
	});
	jx.panel.ProjectReportPanel.superclass.constructor.call(this, _3ef);
};
Ext.extend(jx.panel.ProjectReportPanel, Ext.Panel, {
	data :null,
	refresh : function() {
		this.form.refresh();
	},
	...
	initComponent : function() {
		Ext.apply(this, {
			layout :"border",
			items : [ this.createGrid(), this.createForm() ]
		});
		jx.panel.ProjectReportPanel.superclass.initComponent.call(this);
	},
	createGrid : function() {
		this.grid = new jx.grid.ProjectReportGrid( {
			data :this.data,
			region :"center",
			autoScroll :true,
			bodyStyle :"padding:5px;",
	...
	createForm : function() {
		this.form = new jx.form.ProjectReportForm( {
			data :this.data,
			region :"south",
			split :true,
			autoScroll :true,
...
jx.grid.ProjectReportGrid = function(_3f1) {
	Ext.applyIf(_3f1, {
		fieldDefinitions :this.getListDefinitions(),
		dataStore :jx.data.StoreFactory.buildProjectReportStore()
	});
	jx.grid.ProjectReportGrid.superclass.constructor.call(this, _3f1);
};
Ext
		.extend(
				jx.grid.ProjectReportGrid,
				jx.grid.SimpleGrid,
				{
					data :null,
					refresh : function() {
					...
					submitReport : function() {
						$("reportForm").action = "report/" + reportName + "."
								+ reportDto.format;
					},
					render : function() {
						jx.grid.ProjectReportGrid.superclass.render.apply(this,
								arguments);
						this.refresh();
					},
...
jx.form.ProjectReportForm = function(_3fd) {
	...
	this.allFields = [ {
		xtype :"combo",
		fieldLabel :i18n.g("j.l.reportRelease"),
		hiddenName :"report_release",
		...
		mode :"local",
		triggerAction :"all",
		emptyText :i18n.g("j.l.reportReleaseEmptyText"),
		selectOnFocus :true,
		anchor :"100%",
		hidden :false,
		hideLabel :false,
		...
		xtype :"combo",
		fieldLabel :i18n.g("j.l.reportSet"),
		hiddenName :"report_artifactGroup",
		...
		mode :"local",
		triggerAction :"all",
		emptyText :i18n.g("j.l.reportSetEmptyText"),
		selectOnFocus :true,
		anchor :"100%",
		hidden :false,
		hideLabel :false,
		...
		fieldLabel :i18n.g("j.l.reportStringParam1"),
		name :"report_string1",
		allowBlank :true,
		hidden :false,
		hideLabel :false
	}, {
		fieldLabel :i18n.g("j.l.reportStringParam2"),
		name :"report_string2",
		allowBlank :true,
		hidden :false,
		hideLabel :false
	}, {
		fieldLabel :i18n.g("j.l.reportStringParam3"),
		name :"report_string3",
		allowBlank :true,
		hidden :false,
		hideLabel :false
		...
		xtype :"datefield",
		fieldLabel :i18n.g("j.l.reportDateParam1"),
		name :"report_date1",
		allowBlank :true,
		hidden :true,
		hideLabel :true,
		...
		xtype :"datefield",
		fieldLabel :i18n.g("j.l.reportDateParam2"),
		name :"report_date2",
		allowBlank :true,
		hidden :false,
		hideLabel :false,
		...
		name :"report_project_id",
		allowBlank :true,
		hidden :true,
		hideLabel :true
	} ];
	var _3fe = new jx.data.SimpleListStore( {
		id :"value",
		fields : [ {
			name :"value"
		}, {
	...
	_3fd = Ext.applyIf(_3fd, {
		labelWidth :150,
		defaultType :"textfield",
		labelAlign :"left",
		hidden :false,
		items :this.defaultsFields
	});
	jx.form.ProjectReportForm.superclass.constructor.call(this, _3fd);
};
Ext.extend(jx.form.ProjectReportForm, Ext.form.FormPanel,
		{
			data :null,
			refresh : function() {
				this.releaseStore.load( {
					arg : [ this.data.project.id ]
				});
				this.groupStore.load( {
					arg : [ this.data.project.id ]
				});
			...
			submitReport : function() {
				...
				form.target = "_blank";
				form.action = "report/" + this.report.name + "."
						+ _3ff["report_format"];
				form.submit();
			},
			validate : function() {
				...
				if (_402 != null) {
					for ( var i = 0; i < _402.length; i++) {
						...
						if (f && !f.getValue()) {
							Ext.MessageBox.alert("Warning", String.format(
									"{0} is required", f.fieldLabel));
							return false;
						}
					}
				}
			...
			loadReport : function(_405) {
				...
				this.getForm().setValues( {
					report_format :_406,
					reportId :_405.id,
					report_project_id :this.data.project.id
				});
			},
			...
			removeItem : function(_412, _413, size) {
				if (_412.name != "report_format"
						&& _412.hiddenName != "report_format") {
					this.remove(_412);
				}
			},
			...
			render : function() {
				jx.form.ProjectReportForm.superclass.render.apply(this,
						arguments);
				this.refresh();
			}
		});
jx.panel.ResultPanel = function(_419) {
	_419 = Ext.applyIf(_419, {
		title :"Item Grid"
	});
	jx.panel.ResultPanel.superclass.constructor.call(this, _419);
};
Ext.extend(jx.panel.ResultPanel, Ext.Panel, {
	data :null,
	iconCls :"j-header-search-icon",
	refresh : function() {
		var item = this.data.item;
		this.setTabTitleAndIcon(String.format("{0}:&nbsp;{1}",
				item.titleDisplay, item.name), item.iconCls);
	},
	...
	initComponent : function() {
		Ext.applyIf(this, {
			...
			items : [ {
				...
				height :90,
				border :false,
				xtype :"jx.panel.ResultHeaderPanel",
				resultPanel :this,
				data :this.data
			}, {
				region :"center",
		...
		.extend(
				...
				Ext.Panel,
				{
					...
					refresh : function() {
						...
						var item = this.data.item;
						this.body.update("");
						this.getTpl().append(this.body, {
							name :item.name,
							gridHeader :item.labelDisplay
						});
						this.getTopToolbar().items.itemAt(0).getEl().innerHTML = String
								.format("{0}:&nbsp;{1}", item.titleDisplay,
										item.name);
						if (data.itemType && this.rendered) {
							...
							this.getTopToolbar().showButtons(
									this.data.project.getMask(),
									jx.grid.ModeMap[data.itemType]);
						}
					},
					initComponent : function() {
						var mm = jx.grid.ModeMap;
						...
						Ext.apply(this, {
							tbar : [ "&nbsp;yyy", "->", {
								text :i18n.g("j.b.resultEdit"),
								id :this.editButtonId,
								iconCls :"j-item-edit-icon",
								handler :this.onEdit,
								scope :this,
								mask :wa,
								mode :mm.allButSearch
							}, {
								xtype :"tbseparator",
								mask :wa,
								mode :mm.allButSearch
							}, {
								text :i18n.g("j.b.resultDelete"),
								iconCls :"j-item-delete-icon",
						...
						this.data.on("dataChanged", this.refresh, this);
						jx.panel.ResultHeaderPanel.superclass.initComponent
								.call(this);
					},
					...
					render : function() {
						jx.panel.ResultHeaderPanel.superclass.render.apply(
								this, arguments);
						this.refresh();
					},
					getTpl : function() {
						...
						if (!w.tplCache) {
							w.tplCache = new Ext.XTemplate(
									"<table><tbody>",
									"<tr>",
									"<td nowrap align=\"right\" width=\"10%\"><div class=\"j-set-header-title-left\">{gridHeader}</div></td><td><div class=\"j-set-header-title-right\">{name}</div></td>",
									"</tr>", "</tbody></table>");
						}
						return w.tplCache;
					}
				...
				Ext.Panel,
				{
					...
					initComponent : function() {
						...
						Ext.apply(this, {
							...
							layout :"fit",
							items : {
								xtype :"jx.panel.ProjectCenterPanel",
								id :"p-center-panel"
							},
							tbar :this.getTbar()
						});
						...
						this.getAppContext().on("projectChanged",
								this.updateData, this);
						this.getAppContext().on("nullProject",
								this.disableSearch, this);
						jx.panel.OrgCenterPanel.superclass.initComponent
								.call(this);
					},
					updateData : function(e) {
						this.data.reconfig( {
					...
					showSearch : function() {
						...
						this.searchDialog.show();
						this.searchDialog.alignTo(this.getEl(), "tl-bl",
								[ 0, 0 ], true);
					},
					...
					afterRender : function() {
						jx.panel.OrgCenterPanel.superclass.afterRender
								.call(this);
					},
...
Ext.extend(jx.panel.ItemSeleniumPanel, Ext.Panel, {
	data :null,
	testForm :null,
	org :null,
	refresh : function(_43f) {
		this.runnerStore.load( {
			arg : [ 1022, 3, this.data.getProjectId() ]
		});
		this.targetStore.load( {
			arg : [ 1021, 3, this.data.getProjectId() ]
		});
	},
	initComponent : function() {
		Ext.apply(this, {
			items :this.createForm(),
			tbar : [ "->", {
				text :i18n.g("j.l.seStepTest"),
				iconCls :"j-tag-add-icon",
				handler :this.runStepTest,
				scope :this
			}, {
				text :i18n.g("j.l.seAutoTest"),
				iconCls :"j-tag-add-icon",
				handler :this.runAutoTest,
				scope :this
			} ]
		});
	...
	createForm : function() {
		this.runnerStore = jx.data.StoreFactory
				.buildLookupByTypeCategoryStore();
		this.targetStore = jx.data.StoreFactory
				.buildLookupByTypeCategoryStore();
		this.testForm = new Ext.form.FormPanel( {
			labelWidth :200,
			items : [ {
				html :"<p>" + i18n.g("j.m.seTitle") + "</p>",
				bodyStyle :"border-width: 0px 0px 0px"
			}, {
				xtype :"combo",
				fieldLabel :i18n.g("j.l.seTargetApplicationBaseUrl"),
				...
				xtype :"combo",
				fieldLabel :i18n.g("j.l.seTestRunner"),
				store :this.runnerStore,
				displayField :"name",
				name :"runner",
				valueField :"id",
				mode :"local",
	...
	launchSeleniumTest : function(auto) {
		...
		var _447 = _444 + "testSuite.req?documentId=" + _443
				+ "&scriptBaseURL=" + _444 + "&applicationBaseURL=" + _445;
		var _448 = _444 + "postResult.req";
		var _449 = _446 + "?" + "test=" + escape(_447) + "&resultsUrl="
				+ escape(_448) + "&auto=" + _441;
...
jx.window.TagFormWindow = function(_44b) {
	_44b = Ext.applyIf(_44b, {
		title :i18n.g("j.l.tagAddPanelTitle"),
		autoheight :true,
		width :275,
		modal :false,
		closable :true,
		...
		items :this.getForm(),
		buttons : [ {
			text :i18n.g("j.b.tagSave"),
			handler :this.saveTag,
			scope :this
		}, {
			text :i18n.g("j.b.tagCancel"),
			handler :this.onCancel,
			scope :this
		} ],
		layout :"fit"
...
Ext.extend(jx.window.TagFormWindow, Ext.Window, {
	editTag : function(tag, _44d) {
		this.tag = tag;
		this.project = _44d;
	...
	getForm : function() {
		this.formPanel = new Ext.FormPanel( {
			...
			bodyStyle :"padding:10px",
			items : {
				fieldLabel :i18n.g("j.l.tagNameField"),
				name :"tagName"
			}
		});
	...
	saveTag : function(d) {
		...
		var tag = Ext.apply(tag, {
			scope :3,
			refId :this.project.id
		});
		tagSvc.saveTag(tag, this.saveTagCallback.createDelegate(this, [ tag ],
				0));
	},
	saveTagCallback : function(tag) {
...
jx.window.ProjectAdminWindow = function(_452) {
	_452 = Ext.applyIf(_452, {
		...
		layout :"fit",
		items : {
			xtype :"jx.panel.ProjectAdminPanel",
			data :_452.data
		}
	});
	jx.window.ProjectAdminWindow.superclass.constructor.call(this, _452);
};
Ext.extend(jx.window.ProjectAdminWindow, Ext.Window, {
	onEvent : function(e) {
	},
	beforeDestroy : function() {
		jx.window.ProjectAdminWindow.superclass.beforeDestroy.apply(this,
				arguments);
	}
});
Ext.reg("jx.window.ProjectAdminWindow", jx.window.ProjectAdminWindow);
jx.window.ItemFormWindow = function(_454) {
	_454 = Ext.applyIf(_454, {
		title :i18n.g("j.l.itemFormTitle"),
		width :"800",
		height :500,
		modal :true,
		closable :true,
		...
		closeAfterSave :true,
		buttons : [ {
			text :i18n.g("j.b.itemSaveAndContinue"),
			handler :this.saveAndContinue,
			scope :this
		}, {
			text :i18n.g("j.b.itemSave"),
			handler :this.saveAndClose,
			scope :this
		}, {
			text :i18n.g("j.b.itemCommit"),
			handler :this.commitItem,
			scope :this,
			hidden :true
		}, {
			text :i18n.g("j.b.itemCancel"),
			handler :this.onCancel,
			scope :this
		} ],
		layout :"fit",
		items : {
			...
			items : [ this.createItemForm(), {
				layout :"border",
				items : [ this.createCommentForm(), this.createGroupTree() ]
			} ]
		}
	});
...
Ext
		.extend(
				...
				Ext.Window,
				{
					...
					minorSave :false,
					itemForm :null,
					editItem : function(item, _456, _457) {
						this.project = _456;
						this.showItemPanel();
						this.project = _456;
					...
					initComponent : function() {
						jx.window.ItemFormWindow.superclass.initComponent
								.call(this);
					},
					isFckReady : function() {
					...
					createGroupTree : function(val) {
						var _45a = new jx.tree.ItemTree( {
							region :"west",
							collapsible :true,
							split :true,
							width :300,
							title :i18n.g("j.l.itemSaveFolderText"),
							folderOnly :true,
							rootVisible :true
						});
						this.groupTree = _45a;
					...
					createCommentForm : function() {
						...
						var _45c = new Ext.Panel( {
							title :i18n.g("j.l.itemSaveComment"),
							region :"center",
							items :form,
							autoScroll :true
						});
					...
					render : function(_45f) {
						jx.window.ItemFormWindow.superclass.render.call(this,
								_45f);
					...
					saveItem : function() {
						...
						var path = form.selected ? form.selected.parentPath
								: null;
					...
					commitItem : function() {
						...
						documentManager.saveDocumentDto(item, {
							callback :this.commitItemCallback
									.createDelegate(this)
						});
					},
					...
					getParentId : function() {
						var node = this.groupTree.getSelectionModel()
								.getSelectedNode();
						var _473 = null;
					...
					parseNode : function(node) {
						if (node) {
							...
							var id = _47b.id;
							var _47d = id.charAt(0) == "g" ? null : id
									.substring(2);
					...
					saveItemRelate : function(item, _481) {
						...
						relationshipSvc
								.saveRelationships( {
									associations :_482
								}, this.onSuccessSaveRelationships
										.createDelegate(this));
					},
...
jx.window.ItemAttachmentWindow = function(_484) {
	_484 = Ext.applyIf(_484, {
		title :i18n.g("j.l.fileUploadDialogTitle"),
		width :600,
		height :400,
		modal :true,
		closable :true,
		...
		minimizable :false,
		buttons : [ {
			text :i18n.g("j.b.fileUploadSave"),
			handler :this.onUpload,
			scope :this
		}, {
			text :i18n.g("j.b.fileUploadAttach"),
			handler :this.onAttach,
			scope :this
		}, {
			text :i18n.g("j.b.fileUploadCancel"),
			handler :this.onCancel,
			scope :this
		} ],
		layout :"fit",
		items :this.createTabPanel(_484)
	});
	jx.window.ItemAttachmentWindow.superclass.constructor.call(this, _484);
};
Ext.extend(jx.window.ItemAttachmentWindow, Ext.Window, {
	data :null,
	attachForm :null,
	attachGrid :null,
	noteForm :null,
	...
	saveAttachmentList : function(ids, note) {
		if (ids.length > 0) {
			documentManager.saveDocumentAttachmentList(ids, note, {
				id :this.data.getItemId()
			}, {
				callback :this.updateItemCallback.createDelegate(this),
				exceptionHandler : function() {
					Ext.MessageBox.alert("Error",
							"The item(s) can not be saved");
				}
			});
		}
	},
	...
	createTabPanel : function(_48a) {
		...
		return new Ext.TabPanel( {
			activeItem :0,
			items : [ this.attachForm, {
				title :i18n.g("j.l.fileUploadServerTabTitle"),
				layout :"border",
				defaults : {
					bodyStyle :"padding:10px"
				},
				items : [ this.attachGrid, this.noteForm ],
				listeners : {
					activate : {
						fn :this.clickGridTab,
						scope :this
					}
				}
			} ]
	...
	createFormPanel : function(_48d) {
		return new jx.form.AttachmentUploadForm( {
			title :i18n.g("j.l.fileUploadTabTitle"),
			data :_48d.data,
			showNote :true,
			listeners : {
				afterSaveItemAttachment : {
					fn :this.updateItemCallback,
					scope :this
				},
				activate : {
					fn :this.clickFormTab,
					scope :this
				}
			}
		});
	...
	createGridPanel : function(_48e) {
		return new jx.grid.ServerAttachmentGrid( {
			region :"center",
			autoScroll :true,
			data :_48e.data,
			listeners : {
...
jx.window.ItemUrlWindow = function(_490) {
	_490 = Ext.applyIf(_490, {
		title :i18n.g("j.l.itemUrlWindowTitle"),
		height :150,
		width :400,
		modal :true,
		closable :true,
		...
		autoScroll :true,
		buttons : [ {
			text :i18n.g("j.b.itemUrlSave"),
			handler :this.saveItem,
			scope :this
		}, {
			text :i18n.g("j.b.itemUrlCancel"),
			handler :this.onCancel,
			scope :this
		} ],
		layout :"fit",
...
Ext.extend(jx.window.ItemUrlWindow, Ext.Window, {
	data :null,
	form :null,
	urlItem :null,
	loadUrl : function(_491) {
		this.urlItem = _491;
	...
	saveItem : function() {
		...
		if (!item.url) {
			...
			documentManager.saveDocumentAttachment(item, {
				id :this.data.getItemId()
			},
					{
						callback :this.updateItemCallback.createDelegate(this),
...
jx.window.VersionCompareFormWindow = function(_496) {
	_496 = Ext.applyIf(_496, {
		...
		layout :"fit",
		items :this.createVersionCompareForm(_496)
	});
	jx.window.VersionCompareFormWindow.superclass.constructor.call(this, _496);
};
Ext.extend(jx.window.VersionCompareFormWindow, Ext.Window, {
	fromDoc :null,
	toDoc :null,
	compareItems : function(_497, _498) {
		this.versionForm.compareItems(_497, _498);
	},
	createVersionCompareForm : function(_499) {
		this.versionForm = new jx.form.VersionCompareForm( {
			fromDoc :_499.fromDoc,
			toDoc :_499.toDoc
		});
		return new Ext.Panel( {
			autoScroll :true,
			items :this.versionForm,
			tbar : [ "->", {
				text :"Show Details",
	...
	toggleDetails : function(_49a) {
		...
		_49a.setText(this.versionForm.showDetails ? "Hide Details"
				: "Show Details");
	},
	onSave : function() {
...
Ext.extend(jx.window.SearchWindow, Ext.Window, {
	data :null,
	initComponent : function() {
...
Ext.extend(jx.window.TagListWindow, Ext.Window, {
	data :null,
	refresh : function() {
...
jx.window.ReleaseTreeWindow = function(_4a3) {
	_4a3 = Ext.applyIf(_4a3, {
		title :i18n.g("j.l.releaseTree"),
		width :300,
		height :275,
		modal :false,
		closable :true,
		...
		layout :"fit",
		items : {
			xtype :"jx.panel.ReleaseTreePanel",
			data :_4a3.data
		}
	});
	jx.window.ReleaseTreeWindow.superclass.constructor.call(this, _4a3);
};
Ext.extend(jx.window.ReleaseTreeWindow, Ext.Window, {
	data :null,
	refresh : function() {
		this.items.itemAt(0).refresh();
	},
...
jx.window.ReleaseFormWindow = function(_4a4) {
	_4a4 = Ext.applyIf(_4a4, {
		title :i18n.g("j.b.addRelease"),
		autoheight :true,
		width :400,
		height :200,
		modal :true,
		...
		minimizable :false,
		buttons : [ {
			text :i18n.g("jama.b.save"),
			handler :this.onSave,
			scope :this
		}, {
			text :i18n.g("jama.b.cancel"),
			handler :this.onCancel,
			scope :this
		} ],
		layout :"fit",
...
Ext.extend(jx.window.ReleaseFormWindow, Ext.Window, {
	data :null,
	release :null,
	editRelease : function(_4a5) {
		this.release = _4a5;
		if (_4a5.id) {
			var self = this;
			releaseSvc.getRelease(_4a5.id, {
				callback : function(r) {
					self.release = r;
				},
				async :false
	...
	getForm : function() {
		this.formPanel = new Ext.FormPanel( {
			...
			bodyStyle :"padding:10px",
			items : [ {
				fieldLabel :i18n.g("j.l.releaseName"),
				name :"name",
				allowBlank :false,
				anchor :"100%"
			}, {
				fieldLabel :i18n.g("j.l.releaseDesc"),
				name :"description",
				anchor :"100%"
			}, new Ext.form.DateField( {
				fieldLabel :i18n.g("j.l.releaseDate"),
				name :"releaseDate",
				allowBlank :true,
				format :this.getAppContext().getDayMonthYearFormat()
			}) ]
	...
	onSave : function(_4a8) {
		...
		releaseSvc.saveProjectRelease(this.data.project.id, _4a9,
				this.afterSaveItem.createDelegate(this));
		this.close();
	},
...
jx.window.FilterListWindow = function(_4ab) {
	_4ab = Ext.applyIf(_4ab, {
		width :300,
		height :275,
		title :i18n.g("j.l.filterPanelTitle"),
		modal :false,
		closable :true,
		closeAction :"hide",
		cancelAction :"hide",
...
Ext.extend(jx.window.FilterListWindow, Ext.Window, {
	data :null,
	refresh : function() {
		this.items.itemAt(0).refresh();
	},
...
jx.window.GroupFormWindow = function(_4b3) {
	_4b3 = Ext.applyIf(_4b3, {
		...
		items :this.createGroupForm(_4b3)
	});
	jx.window.GroupFormWindow.superclass.constructor.call(this, _4b3);
};
Ext.extend(jx.window.GroupFormWindow, Ext.Window, {
	groupForm :null,
	loadGroup : function(_4b4, _4b5, org) {
		this.project = _4b5;
		this.groupForm.loadGroup(_4b4, _4b5, org);
	},
	createGroupForm : function(_4b7) {
		this.groupForm = new jx.form.GroupForm( {
			group :_4b7.group,
			org :_4b7.org,
			project :_4b7.project,
			listeners : {
				"afterSaveGroup" : {
					fn :this.onAfterSaveGroup,
					scope :this
				}
			}
		});
...
jx.window.FilterFormWindow = function(_4ba) {
	_4ba = Ext.applyIf(_4ba, {
		...
		layout :"fit",
		items :this.createFilterForm(_4ba)
	});
	jx.window.FilterFormWindow.superclass.constructor.call(this, _4ba);
};
Ext.extend(jx.window.FilterFormWindow, Ext.Window, {
	project :null,
	org :null,
	filter :null,
	sourceEvent :null,
	loadFilter : function(_4bb, _4bc, org, e) {
		this.sourceEvent = e;
		this.filterForm.loadFilter(_4bb, _4bc, org);
	},
	createFilterForm : function(_4bf) {
		this.filterForm = new jx.form.FilterForm( {
			filter :_4bf.filter,
			org :_4bf.org,
			project :_4bf.project,
			listeners : {
				"afterSaveFilter" : {
					fn :this.afterSaveFilter,
					scope :this
				}
			}
		});
	...
	loadFilterResults : function(_4c2) {
		if (_4c2) {
			var data = {
				item :_4c2,
				itemType :"filter",
				project :this.sourceEvent.data.project
			};
			this.getAppContext().fireEvent("showGrid", {
				data :data,
				source :this
...
jx.window.BatchUpdateFormWindow = function(_4c4) {
	_4c4 = Ext.applyIf(_4c4, {
		...
		layout :"fit",
		items :this.createBatchUpdateForm(_4c4)
	});
	jx.window.BatchUpdateFormWindow.superclass.constructor.call(this, _4c4);
};
Ext.extend(jx.window.BatchUpdateFormWindow, Ext.Window, {
	project :null,
	org :null,
	filter :null,
	sourceEvent :null,
	loadFilter : function(_4c5, _4c6, org, e) {
		this.sourceEvent = e;
		this.batchUpdateForm.loadFilter(_4c5, _4c6, org);
	},
	createBatchUpdateForm : function(_4c9) {
		this.batchUpdateForm = new jx.form.BatchUpdateForm( {
			filter :_4c9.filter,
			org :_4c9.org,
			project :_4c9.project,
			listeners : {
				"afterBatchUpdate" : {
					fn :this.afterBatchUpdate,
					scope :this
				}
			}
		});
...
jx.window.SuspectWindow = function(_4ca) {
	_4ca = Ext.applyIf(_4ca, {
		...
		layout :"fit",
		items :this.createSuspectPanel(_4ca)
	});
	jx.window.SuspectWindow.superclass.constructor.call(this, _4ca);
};
Ext.extend(jx.window.SuspectWindow, Ext.Window, {
	onEvent : function(e) {
	...
	createSuspectPanel : function(_4cd) {
		this.suspectPanel = new jx.panel.SuspectPanel( {
			listeners : {
				showItem :this.showItem,
				scope :this
			}
...
jx.window.TraceMatrixWindow = function(_4d1) {
	_4d1 = Ext.applyIf(_4d1, {
		...
		layout :"fit",
		items :this.createPanel(_4d1)
	});
	jx.window.TraceMatrixWindow.superclass.constructor.call(this, _4d1);
};
Ext.extend(jx.window.TraceMatrixWindow, Ext.Window, {
	onEvent : function(e) {
...
Ext.extend(jx.window.WordImportWindow, Ext.Window,
		{
			onEvent : function(e) {
			},
			createPanel : function(_4d8) {
				this.panel = new jx.panel.WordImportPanel( {
					project :_4d8.project,
					autoScroll :true,
					listeners : {
						afterImport :this.afterImport,
						scope :this
...
jx.window.CsvImportWindow = function(_4da) {
	...
	_4da = Ext.applyIf(_4da, {
		title :i18n.g("j.l.setImportCSV"),
		width :600,
		height :400,
		modal :false,
		closable :true,
...
Ext.extend(jx.window.CsvImportWindow, Ext.Window,
		{
			onEvent : function(e) {
			},
			createPanel : function(_4dd) {
				this.panel = new jx.panel.CsvImportPanel( {
					project :_4dd.project,
					autoScroll :true,
					listeners : {
						afterImport :this.afterImport,
						scope :this
...
jx.window.ImpactWindow = function(_4df) {
	_4df = Ext.applyIf(_4df, {
		...
		minimizable :false,
		buttons : [ {
			text :i18n.g("j-b-closeImpact"),
			handler :this.onCancel,
			scope :this
		} ],
		layout :"fit",
		items :this.createImpactPanel(_4df)
	});
	jx.window.ImpactWindow.superclass.constructor.call(this, _4df);
};
Ext.extend(jx.window.ImpactWindow, Ext.Window, {
	onEvent : function(e) {
	...
	createImpactPanel : function(_4e2) {
		this.impactPanel = new jx.panel.ImpactPanel( {
			project :_4e2.project,
			listeners : {
				showItem :this.showItem,
				scope :this
			}
...
jx.window.ProjectReportWindow = function(_4e6) {
	this.data = new jx.ItemData( {
		project :_4e6.project,
		org :_4e6.org
	});
	_4e6 = Ext.applyIf(_4e6, {
		title :i18n.g("j.l.reportTitle"),
		width :600,
		height :500,
		modal :false,
		closable :true,
		...
		minimizable :false,
		layout :"fit",
		items :this.createReportPanel(_4e6),
		buttons : [ {
			text :i18n.g("j.b.reportPreview"),
			handler :this.reportPanel.submitReport,
			scope :this.reportPanel
		}, {
			text :i18n.g("j.b.reportClose"),
			handler :this.onCancel,
			scope :this
		} ]
	});
...
Ext.extend(jx.window.ProjectReportWindow, Ext.Window, {
	data :this.data,
	onEvent : function(e) {
	},
	createReportPanel : function(_4e8) {
		this.reportPanel = new jx.panel.ProjectReportPanel( {
			data :this.data
		});
...
jx.window.ProjectAttachmentWindow = function(_4e9) {
	_4e9 = Ext.applyIf(_4e9, {
		title :i18n.g("j.b.projectFileUploadTitle"),
		width :500,
		height :200,
		modal :true,
		closable :true,
		...
		layout :"fit",
		items : {
			items :this.createFormPanel(_4e9)
		}
	});
	jx.window.ProjectAttachmentWindow.superclass.constructor.call(this, _4e9);
};
Ext.extend(jx.window.ProjectAttachmentWindow, Ext.Window, {
	data :null,
	attachForm :null,
	createFormPanel : function(_4ea) {
		this.attachForm = new jx.form.AttachmentUploadForm( {
			data :_4ea.data
		});
...
jx.window.ItemCopyWindow = function(_4ec) {
	_4ec = Ext.applyIf(_4ec, {
		title :i18n.g("j.b.itemCopyTitle"),
		width :600,
		height :400,
		modal :true,
		closable :true,
		...
		minimizable :false,
		layout :"border",
		items : [ this.createPanel(_4ec), this.createItemTree(_4ec),
				this.createProjectTree(_4ec) ],
		buttons : [ {
			text :i18n.g("j.b.itemCopy"),
			handler :this.onCopyItem,
			scope :this
		}, {
			text :i18n.g("j.b.itemCopyCancel"),
			handler :this.onCancel,
			scope :this
		} ]
	});
				...
				Ext.Window,
				{
					...
					onEvent : function(e) {
						if (e.data.itemType == "multipledoc") {
							...
							if (e.data.item && e.data.item.documentGroup
									&& e.data.item.documentGroup.documentType) {
					...
					load : function(doc, _4ef) {
						...
						this.project = _4ef;
						this.panel.body.update("");
						this.getTpl().append(this.panel.body, {
							docName :doc.name,
							projectName :_4ef.name
						});
						this.projectTree.loadOrganization.defer(100,
								this.projectTree, []);
						if (doc.typeId) {
							...
							this
									.getAppContext()
									.showMessage("Info",
											"No type was found, tree will display all types.");
						}
					},
					multiload : function(arr, _4f1) {
						...
						this.panel.body.update("");
						this.getTpl().append(this.panel.body, {
							docName :"multiple items",
							projectName :_4f1.name
						});
						this.projectTree.loadOrganization.defer(100,
								this.projectTree, []);
						this.tree.loadProject.defer(100, this.tree,
								[ new jx.Project( {
									id :0,
									name :"Select a project"
								}) ]);
					...
					createItemTree : function(_4f3) {
						...
						this.tree = new jx.tree.ItemTree( {
							region :"east",
							title :i18n.g("j.l.itemCopySelectLocation"),
							width :300,
							tbar : [ {
								xtype :"checkbox",
								listeners : {
									check :this.onToggleRefLink,
									scope :this
								}
							}, i18n.g("j.l.itemCopyTraceLinkText") ],
							folderOnly :true,
							root :new Ext.tree.AsyncTreeNode( {
								text :p.name,
								draggable :false,
					...
					createProjectTree : function(_4f5) {
						...
						this.projectTree = new jx.tree.ProjectTree( {
							region :"center",
							title :i18n.g("j.l.itemCopySelectProject"),
							root :new Ext.tree.AsyncTreeNode( {
								text :p.name,
								draggable :false,
								iconCls :"j-organization-icon",
							...
							listeners : {
								click : {
									fn :this.loadItemTree,
									scope :this
								}
							}
						});
						this.projectTree.on("load", this.afterLoadOrganization,
								this);
						return this.projectTree;
					},
					afterLoadOrganization : function() {
						project.getPath(this.project.id, this.reloadPath
								.createDelegate(this));
					},
					reloadPath : function(path) {
						if (!path) {
					...
					loadItemTree : function(node) {
						...
						case "p":
							var _4fd = this.getAppContext().getProject(id,
									false);
							if (this.itemTypeId) {
								this.tree
										.loadProjectType(this.itemTypeId, _4fd);
							} else {
							...
							break;
						case "o":
							this.tree.loadProject(new jx.Project( {
								id :0,
								name :"Select a project"
							}));
							break;
					...
					onCopyItem : function() {
						...
						if (node && !node.isRoot) {
							if (this.isMultipleCopy) {
								documentManager.copyMultipleDocuments(
										this.docArr, node.id, this.refLink,
										this.onSuccessMultipleCopy
												.createDelegate(this));
							} else {
								documentManager
										.copyDocument(this.doc.id, node.id,
												this.refLink,
												this.onSuccessCopy
														.createDelegate(this));
							}
							...
							this
									.getAppContext()
									.showMessage("Info",
											"Please select a project and a set or folder to copy to");
						}
					},
					...
					getTpl : function() {
						...
						if (!w.tplCache) {
							w.tplCache = new Ext.XTemplate(
									"<div class=\"j-item-copy-panel\">",
									"You have selected to copy {docName}.",
									"<br/><br/>",
									"Please select a destination project and indicate if you'd like a trace relationship to be created to the copied item",
									"</div>");
						}
						return w.tplCache;
					}
...
jx.window.ReportWindow = function(_504) {
	_504 = Ext.applyIf(_504, {
		title :i18n.g("j.l.reportAddTitle"),
		width :600,
		height :500,
		modal :true,
		closable :true,
		...
		minimizable :false,
		buttons : [ {
			text :i18n.g("j.b.reportSave"),
			handler :this.onSave,
			scope :this
		}, {
			text :i18n.g("j.b.reportUpload"),
			handler :this.onUpload,
			scope :this
		}, {
			text :i18n.g("j.b.reportFileDelete"),
			handler :this.onDeleteReportFile,
			scope :this
		}, {
			text :i18n.g("j.b.reportCancel"),
			handler :this.onCancel,
			scope :this
		} ],
		layout :"fit",
		items :this.createTabPanel(_504)
	});
	jx.window.ReportWindow.superclass.constructor.call(this, _504);
};
Ext
		.extend(
				jx.window.ReportWindow,
				Ext.Window,
				{
					data :null,
					reportForm :null,
					...
					createTabPanel : function(_506) {
						...
						return new Ext.TabPanel( {
							activeItem :0,
							items : [ {
								title :i18n.g("j.l.reportTabTitle"),
								items :this.reportForm,
								listeners : {
									activate :this.clickReportFormTab,
									scope :this
								}
							}, this.uploadForm ]
						});
					...
					getFormDefinitions : function() {
						...
						return ( [ {
							...
							field :"mainReportFile",
							label :"Report File Name",
							dataType :"lookup",
							idField :"id",
							displayField :"fileName",
							options :this.attachmentList
						}, {
							field :"description",
							label :"Description"
						}, {
							...
							field :"criterions",
							label :"Report Criterions",
							dataType :"multiCheckboxes",
							returnIds :true,
							idField :"name",
							displayField :"description",
							options :this.criterionList
						} ]);
					},
					loadAttachmentList : function() {
						var self = this;
						report.getReportAttachmentList( {
							callback : function(list) {
					...
					createUploadForm : function(_50e) {
						return new Ext.form.FormPanel( {
							title :i18n.g("j.l.reportTabUpload"),
							baseCls :"x-plain",
							labelWidth :100,
							defaultType :"textfield",
							labelAlign :"left",
							...
							baseUrl :this.getAppContext().baseUrl,
							listeners : {
								activate :this.clickUploadFormTab,
								scope :this
							},
							items : [ {
								fieldLabel :i18n.g("j.l.uploadFileName"),
					...
					onUpload : function() {
						var _50f = this.uploadForm.getForm().findField(
								"report_file").getRawValue();
						if (_50f.lastIndexOf(".rptdesign") < 0
								&& _50f.lastIndexOf(".rptlibrary") < 0) {
							Ext.MessageBox.alert("Validation Error",
									"Only BIRT report files can be loaded");
							return;
						}
						this.uploadForm.getForm().submit( {
							waitMsg :i18n.g("j.l.uploadingWaitMessge"),
							url :this.baseUrl + this.uploadUrl,
							reset :false,
							success :this.uploadCallback.createDelegate(this),
						...
						if (file != null) {
							Ext.MessageBox
									.confirm(
											...
											String
													.format(
															"Are you sure you want to delete the report file {0}?",
															file.fileName),
											this.deleteReportFileCallback
													.createDelegate(this,
															[ file ], 0));
						}
					},
						...
						if (_512 == "yes") {
							report
									.deleteReportAttachment(
											file,
											{
												callback :this.loadAttachmentList
														.createDelegate(this),
												errorHandler : function() {
													Ext.MessageBox
															.alert("Warning",
																	"Can't delete the file. Delete the reports associated with the file first.");
												}
											});
						}
					},
					...
					handleFailure : function(form, _514) {
						Ext.MessageBox.alert("Failure", String.format(
								"Report file can not be uploaded. Cause: {0}",
								_514.result.data.cause));
					},
					onSave : function() {
						...
						var self = this;
						validation.validateReport(item, {
						...
						if (!self.isValid) {
							Ext.MessageBox.alert(i18n
									.g("j.m.reportErrorPrefix"), this.errors
									.join("<br/>"));
							return;
						}
						report.saveReport(item, this.onSaveCallback
								.createDelegate(this));
					},
					onSaveCallback : function(item) {
						this.getAppContext().showMessage("Success",
...
Ext.extend(jx.window.ItemPreviewWindow, Ext.Window, {
	data :null,
	simpleForm :null,
	onEvent : function(e) {
	...
	beforeDestroy : function() {
		jx.window.ItemPreviewWindow.superclass.beforeDestroy.apply(this,
				arguments);
	}
});
