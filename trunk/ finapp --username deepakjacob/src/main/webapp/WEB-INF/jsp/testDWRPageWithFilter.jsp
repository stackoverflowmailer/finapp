...
<head>
    ...
    <script type="text/javascript"
            src="<%=request.getContextPath()%>/js/external/ext-extensions/entityReader.js"></script>

    <!-- DWR dependencies -->
    <script type="text/javascript"
            src="<%=request.getContextPath()%>/js/external/ext-extensions/finappJsonGridWithFilter.js"></script>
